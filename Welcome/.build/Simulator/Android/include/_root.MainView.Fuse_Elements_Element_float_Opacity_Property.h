...
struct MainView__Fuse_Elements_Element_float_Opacity_Property : ::g::Uno::UX::Property
{
    uStrong< ::g::Fuse::Elements::Element*> _obj;

    void ctor_1(::g::Fuse::Elements::Element* obj);
    static MainView__Fuse_Elements_Element_float_Opacity_Property* New1(::g::Fuse::Elements::Element* obj);
};
// }
