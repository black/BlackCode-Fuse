// This file was generated based on 'C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Runtime\Implementation\ShaderBackends\OpenGL\$.uno'.
...
struct GLDrawCall
{
    ...
    void Sampler(int index, int target, uint32_t handle, bool supportsMipmap);
    void Sampler1(int index, int target, uint32_t handle, ::g::Uno::Graphics::SamplerState state, bool supportsMipmap);
