...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/WelcomeAnimation/WelcomeAnimation");
    jclass entryPointsClass = env->FindClass("com/WelcomeAnimation/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/WelcomeAnimation/Display");
