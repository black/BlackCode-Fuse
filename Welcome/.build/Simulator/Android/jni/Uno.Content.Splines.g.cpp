...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Content\Splines\$.uno(45)
// -------------------------------------------------------------------------------

// public struct KeyframedSpline<TValue, TData>.Key :45
// {
...
// public Key(double time, TData value) :50
...
// public Key New(double time, TData value) :50
...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Content\Splines\$.uno(43)
// -------------------------------------------------------------------------------

// public abstract class KeyframedSpline<TValue, TData> :43
// {
...
// protected KeyframedSpline() :60
void KeyframedSpline__ctor_1_fn(KeyframedSpline* __this)
{
    __this->ctor_1();
}

// protected KeyframedSpline(Uno.Content.Splines.KeyframedSpline<TValue, TData>.Key[] keys) :64
void KeyframedSpline__ctor_2_fn(KeyframedSpline* __this, uArray* keys1)
{
    __this->ctor_2(keys1);
}

// public int AddKey(double time, TData value) :122
...
// public void ClearKeys() :135
void KeyframedSpline__ClearKeys_fn(KeyframedSpline* __this)
{
    __this->ClearKeys();
}

// public override sealed double get_End() :77
...
// public TData FindValue(double time) :177
...
// public void FindValues(double time, TData& a, TData& b, float& p) :191
...
// public void FindValues(double time, TData& a, TData& b, TData& c, TData& d, float& p) :206
...
// public void SetValue(int index, TData value) :156
...
// public override sealed double get_Start() :72
...
// protected KeyframedSpline() [instance] :60
...
// protected KeyframedSpline(Uno.Content.Splines.KeyframedSpline<TValue, TData>.Key[] keys) [instance] :64
...
// public void ClearKeys() [instance] :135
...
// public int FindLeftIndex(double time) [instance] :80
...
// public int FindNearestIndex(double time) [instance] :102
...
// public double GetTime(int index) [instance] :151
...
// public int get_KeyCount() [instance] :143
...
// public void RemoveKey(int index) [instance] :129
...
// public int SetTime(int index, double time) [instance] :161
...
// public static float Map(double a, double b, double t) [static] :182
...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Content\Splines\$.uno(229)
// --------------------------------------------------------------------------------

// public sealed class LinearSplineFloat :229
// {
...
// public LinearSplineFloat() [instance] :231
void LinearSplineFloat::ctor_3()
{
    ctor_1();
}

// public LinearSplineFloat(Uno.Content.Splines.KeyframedSpline<float, float>.Key[] keys) [instance] :235
void LinearSplineFloat::ctor_4(uArray* keys1)
{
    ctor_2(keys1);
}

// public LinearSplineFloat New() [static] :231
...
// public LinearSplineFloat New(Uno.Content.Splines.KeyframedSpline<float, float>.Key[] keys) [static] :235
...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Content\Splines\$.uno(255)
// --------------------------------------------------------------------------------

// public sealed class LinearSplineFloat2 :255
// {
...
// public LinearSplineFloat2() [instance] :257
void LinearSplineFloat2::ctor_3()
{
    ctor_1();
}

// public LinearSplineFloat2(Uno.Content.Splines.KeyframedSpline<float2, float2>.Key[] keys) [instance] :261
void LinearSplineFloat2::ctor_4(uArray* keys1)
{
    ctor_2(keys1);
}

// public LinearSplineFloat2 New() [static] :257
...
// public LinearSplineFloat2 New(Uno.Content.Splines.KeyframedSpline<float2, float2>.Key[] keys) [static] :261
...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Content\Splines\$.uno(282)
// --------------------------------------------------------------------------------

// public sealed class LinearSplineFloat3 :282
// {
...
// public LinearSplineFloat3() [instance] :284
void LinearSplineFloat3::ctor_3()
{
    ctor_1();
}

// public LinearSplineFloat3(Uno.Content.Splines.KeyframedSpline<float3, float3>.Key[] keys) [instance] :288
void LinearSplineFloat3::ctor_4(uArray* keys1)
{
    ctor_2(keys1);
}

// public LinearSplineFloat3 New() [static] :284
...
// public LinearSplineFloat3 New(Uno.Content.Splines.KeyframedSpline<float3, float3>.Key[] keys) [static] :288
...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Content\Splines\$.uno(309)
// --------------------------------------------------------------------------------

// public sealed class LinearSplineFloat4 :309
// {
...
// public LinearSplineFloat4() [instance] :311
void LinearSplineFloat4::ctor_3()
{
    ctor_1();
}

// public LinearSplineFloat4(Uno.Content.Splines.KeyframedSpline<float4, float4>.Key[] keys) [instance] :315
void LinearSplineFloat4::ctor_4(uArray* keys1)
{
    ctor_2(keys1);
}

// public LinearSplineFloat4 New() [static] :311
...
// public LinearSplineFloat4 New(Uno.Content.Splines.KeyframedSpline<float4, float4>.Key[] keys) [static] :315
...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Content\Splines\$.uno(336)
// --------------------------------------------------------------------------------

// public sealed class LinearSplineFloat4x4 :336
// {
...
// public LinearSplineFloat4x4() [instance] :338
void LinearSplineFloat4x4::ctor_3()
{
    ctor_1();
}

// public LinearSplineFloat4x4(Uno.Content.Splines.KeyframedSpline<float4x4, float4x4>.Key[] keys) [instance] :342
void LinearSplineFloat4x4::ctor_4(uArray* keys1)
{
    ctor_2(keys1);
}

// public LinearSplineFloat4x4 New() [static] :338
...
// public LinearSplineFloat4x4 New(Uno.Content.Splines.KeyframedSpline<float4x4, float4x4>.Key[] keys) [static] :342
...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Content\Splines\$.uno(361)
// --------------------------------------------------------------------------------

// public abstract class Spline<T> :361
// {
...
// protected generated Spline() :361
void Spline__ctor__fn(Spline* __this)
{
    __this->ctor_();
}

// public T get_First() :369
...
// public T Sample(double time) :377
...
// protected generated Spline() [instance] :361
void Spline::ctor_()
{
}
// }
