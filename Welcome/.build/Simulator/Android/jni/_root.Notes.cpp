...
// public partial sealed class Notes :50
// {
// static Notes() :52
static void Notes__cctor_5_fn(uType* __type)
{
}

::g::Fuse::Controls::Panel_type* Notes_typeof()
{
    ...
    options.ObjectSize = sizeof(Notes);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("Notes", options);
    type->SetBase(::g::Icon_typeof());
    type->fp_ctor_ = (void*)Notes__New3_fn;
    type->fp_cctor_ = Notes__cctor_5_fn;
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Notes__New3_fn, 0, true, Notes_typeof(), 0));
    return type;
}

// public Notes() :55
void Notes__ctor_5_fn(Notes* __this)
{
    __this->ctor_5();
}

// internal void InitializeUX() :59
void Notes__InitializeUX1_fn(Notes* __this)
{
    __this->InitializeUX1();
}

// public Notes New() :55
void Notes__New3_fn(Notes** __retval)
{
    *__retval = Notes::New3();
}

// public Notes() [instance] :55
void Notes::ctor_5()
{
    ctor_4();
    InitializeUX1();
...
// internal void InitializeUX() [instance] :59
void Notes::InitializeUX1()
{
    ...
    temp->File(::g::Uno::UX::BundleFileSource::New1(::g::WelcomeAnimation_bundle::notes1db324e5()));
...
// public Notes New() [static] :55
Notes* Notes::New3()
{
    Notes* obj1 = (Notes*)uNew(Notes_typeof());
    obj1->ctor_5();
    return obj1;
}
// }
