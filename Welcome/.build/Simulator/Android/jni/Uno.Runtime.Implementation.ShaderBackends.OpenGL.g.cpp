...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Runtime\Implementation\ShaderBackends\OpenGL\$.uno(8)
// -----------------------------------------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Runtime\Implementation\ShaderBackends\OpenGL\$.uno(70)
// ------------------------------------------------------------------------------------------------------------

// public extern struct GLDrawCall :70
// {
uStructType* GLDrawCall_typeof()
{
    ...
    type->Reflection.SetFunctions(64,
        ...
        new uFunction("Sampler", NULL, (void*)GLDrawCall__Sampler_fn, 0, false, uVoid_typeof(), 4, ::g::Uno::Int_typeof(), ::g::OpenGL::GLTextureTarget_typeof(), ::g::OpenGL::GLTextureHandle_typeof(), ::g::Uno::Bool_typeof()),
        new uFunction("Sampler", NULL, (void*)GLDrawCall__Sampler1_fn, 0, false, uVoid_typeof(), 5, ::g::Uno::Int_typeof(), ::g::OpenGL::GLTextureTarget_typeof(), ::g::OpenGL::GLTextureHandle_typeof(), ::g::Uno::Graphics::SamplerState_typeof(), ::g::Uno::Bool_typeof()),
...
// public GLDrawCall(Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLProgram program) :215
...
// public void Attrib(int index, int componentCount, OpenGL.GLDataType componentType, bool normalized, Uno.Graphics.VertexBuffer buf, int stride, int offset) :270
...
// public void Attrib(int index, Uno.Graphics.VertexAttributeType type, Uno.Graphics.VertexBuffer buf, int stride, int offset) :291
...
// private generated void set_Program(Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLProgram value) :98
...
// public void Sampler(int index, OpenGL.GLTextureTarget target, OpenGL.GLTextureHandle handle, bool supportsMipmap) :300
void GLDrawCall__Sampler_fn(GLDrawCall* __this, int* index, int* target, uint32_t* handle, bool* supportsMipmap)
{
    __this->Sampler(*index, *target, *handle, *supportsMipmap);
}

// public void Sampler(int index, OpenGL.GLTextureTarget target, OpenGL.GLTextureHandle handle, Uno.Graphics.SamplerState state, bool supportsMipmap) :325
void GLDrawCall__Sampler1_fn(GLDrawCall* __this, int* index, int* target, uint32_t* handle, ::g::Uno::Graphics::SamplerState* state, bool* supportsMipmap)
{
    __this->Sampler1(*index, *target, *handle, *state, *supportsMipmap);
}

// public void Sampler(int index, texture2D value) :359
void GLDrawCall__Sampler2_fn(GLDrawCall* __this, int* index, ::g::Uno::Graphics::Texture2D* value)
{
    __this->Sampler2(*index, value);
}

// public void Sampler(int index, texture2D value, Uno.Graphics.SamplerState state) :367
...
// public GLDrawCall(Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLProgram program) [instance] :215
...
// public void Attrib(int index, int componentCount, OpenGL.GLDataType componentType, bool normalized, Uno.Graphics.VertexBuffer buf, int stride, int offset) [instance] :270
...
// public void Attrib(int index, Uno.Graphics.VertexAttributeType type, Uno.Graphics.VertexBuffer buf, int stride, int offset) [instance] :291
...
// public generated int get_BaseVertex() [instance] :205
int GLDrawCall::BaseVertex()
{
    return _BaseVertex;
}

// public generated void set_BaseVertex(int value) [instance] :206
void GLDrawCall::BaseVertex(int value)
{
    _BaseVertex = value;
}

// private void Begin() [instance] :517
...
// public Uno.Graphics.BlendOperand get_BlendDstAlpha() [instance] :139
...
// public void set_BlendDstAlpha(Uno.Graphics.BlendOperand value) [instance] :140
...
// public Uno.Graphics.BlendOperand get_BlendDstRgb() [instance] :133
...
// public void set_BlendDstRgb(Uno.Graphics.BlendOperand value) [instance] :134
...
// public generated bool get_BlendEnabled() [instance] :103
bool GLDrawCall::BlendEnabled()
{
    return _BlendEnabled;
}

// public generated void set_BlendEnabled(bool value) [instance] :104
void GLDrawCall::BlendEnabled(bool value)
{
    _BlendEnabled = value;
}

// public Uno.Graphics.BlendEquation get_BlendEquationAlpha() [instance] :115
...
// public void set_BlendEquationAlpha(Uno.Graphics.BlendEquation value) [instance] :116
...
// public Uno.Graphics.BlendEquation get_BlendEquationRgb() [instance] :109
...
// public void set_BlendEquationRgb(Uno.Graphics.BlendEquation value) [instance] :110
...
// public Uno.Graphics.BlendOperand get_BlendSrcAlpha() [instance] :127
...
// public void set_BlendSrcAlpha(Uno.Graphics.BlendOperand value) [instance] :128
...
// public Uno.Graphics.BlendOperand get_BlendSrcRgb() [instance] :121
...
// public void set_BlendSrcRgb(Uno.Graphics.BlendOperand value) [instance] :122
...
// public Uno.Graphics.PolygonFace get_CullFace() [instance] :157
...
// public void set_CullFace(Uno.Graphics.PolygonFace value) [instance] :158
...
// public Uno.Graphics.CompareFunc get_DepthFunc() [instance] :151
...
// public void set_DepthFunc(Uno.Graphics.CompareFunc value) [instance] :152
...
// public generated bool get_DepthTestEnabled() [instance] :145
bool GLDrawCall::DepthTestEnabled()
{
    return _DepthTestEnabled;
}

// public generated void set_DepthTestEnabled(bool value) [instance] :146
void GLDrawCall::DepthTestEnabled(bool value)
{
    _DepthTestEnabled = value;
}

// public void DisableSampler(int index, OpenGL.GLTextureTarget target) [instance] :352
...
// public void Draw(int count, [Uno.Graphics.IndexType type], [Uno.Graphics.IndexBuffer buf]) [instance] :600
...
// public void DrawArrays(int count) [instance] :584
...
// public void DrawElements(int count, OpenGL.GLIndexType type, Uno.Graphics.IndexBuffer buf) [instance] :591
...
// public generated float get_LineWidth() [instance] :211
float GLDrawCall::LineWidth()
{
    return _LineWidth;
}

// public generated void set_LineWidth(float value) [instance] :212
void GLDrawCall::LineWidth(float value)
{
    _LineWidth = value;
}

// public Uno.Graphics.PolygonWinding get_PolygonWinding() [instance] :163
...
// public void set_PolygonWinding(Uno.Graphics.PolygonWinding value) [instance] :164
...
// public Uno.Graphics.PrimitiveType get_PrimitiveType() [instance] :169
...
// public void set_PrimitiveType(Uno.Graphics.PrimitiveType value) [instance] :170
...
// public generated Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLProgram get_Program() [instance] :97
::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram* GLDrawCall::Program()
{
    return _Program;
}

// private generated void set_Program(Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLProgram value) [instance] :98
void GLDrawCall::Program(::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram* value)
{
    _Program = value;
}

// public void Sampler(int index, OpenGL.GLTextureTarget target, OpenGL.GLTextureHandle handle, bool supportsMipmap) [instance] :300
void GLDrawCall::Sampler(int index, int target, uint32_t handle, bool supportsMipmap)
{
    int location = uPtr(_compiledProgram)->GetLocation(index);
    ::g::OpenGL::GL::ActiveTexture(33984 + GLDrawCall::_currentTextureUnit());
...
// public void Sampler(int index, OpenGL.GLTextureTarget target, OpenGL.GLTextureHandle handle, Uno.Graphics.SamplerState state, bool supportsMipmap) [instance] :325
void GLDrawCall::Sampler1(int index, int target, uint32_t handle, ::g::Uno::Graphics::SamplerState state, bool supportsMipmap)
{
    int location = uPtr(_compiledProgram)->GetLocation(index);
    ::g::OpenGL::GL::ActiveTexture(33984 + GLDrawCall::_currentTextureUnit());
    ::g::OpenGL::GL::BindTexture(target, handle);
...
// public void Uniform(int index, float4x4[] value) [instance] :512
...
// public generated bool get_WriteAlpha() [instance] :193
bool GLDrawCall::WriteAlpha()
{
    return _WriteAlpha;
}

// public generated void set_WriteAlpha(bool value) [instance] :194
void GLDrawCall::WriteAlpha(bool value)
{
    _WriteAlpha = value;
}

// public generated bool get_WriteBlue() [instance] :187
bool GLDrawCall::WriteBlue()
{
    return _WriteBlue;
}

// public generated void set_WriteBlue(bool value) [instance] :188
void GLDrawCall::WriteBlue(bool value)
{
    _WriteBlue = value;
}

// public generated bool get_WriteDepth() [instance] :199
bool GLDrawCall::WriteDepth()
{
    return _WriteDepth;
}

// public generated void set_WriteDepth(bool value) [instance] :200
void GLDrawCall::WriteDepth(bool value)
{
    _WriteDepth = value;
}

// public generated bool get_WriteGreen() [instance] :181
bool GLDrawCall::WriteGreen()
{
    return _WriteGreen;
}

// public generated void set_WriteGreen(bool value) [instance] :182
void GLDrawCall::WriteGreen(bool value)
{
    _WriteGreen = value;
}

// public generated bool get_WriteRed() [instance] :175
bool GLDrawCall::WriteRed()
{
    return _WriteRed;
}

// public generated void set_WriteRed(bool value) [instance] :176
void GLDrawCall::WriteRed(bool value)
{
    _WriteRed = value;
}

// public GLDrawCall New(Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLProgram program) [static] :215
...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Runtime\Implementation\ShaderBackends\OpenGL\$.uno(616)
// -------------------------------------------------------------------------------------------------------------

// public sealed extern class GLException :616
// {
...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Runtime\Implementation\ShaderBackends\OpenGL\$.uno(634)
// -------------------------------------------------------------------------------------------------------------

// public static extern class GLHelpers :634
// {
...
// public static void CheckError() :636
void GLHelpers__CheckError_fn()
{
    GLHelpers::CheckError();
}

// public static void CheckFramebufferStatus() :644
void GLHelpers__CheckFramebufferStatus_fn()
{
    GLHelpers::CheckFramebufferStatus();
}

// public static OpenGL.GLShaderHandle CompileShader(OpenGL.GLShaderType type, string source) :767
void GLHelpers__CompileShader_fn(int* type, uString* source, uint32_t* __retval)
{
    *__retval = GLHelpers::CompileShader(*type, source);
}

// public static OpenGL.GLRenderbufferHandle CreateDepthBuffer(int2 size) :753
void GLHelpers__CreateDepthBuffer_fn(::g::Uno::Int2* size, uint32_t* __retval)
{
    *__retval = GLHelpers::CreateDepthBuffer(*size);
}

// public static Uno.Graphics.RenderTarget CreateRenderTarget(OpenGL.GLTextureTarget colorTarget, OpenGL.GLTextureHandle colorBuffer, int mip, int2 size, bool depth) :718
...
// public static Uno.Graphics.RenderTarget CreateRenderTarget(OpenGL.GLTextureTarget colorTarget, OpenGL.GLTextureHandle colorBuffer, int mip, int2 size, OpenGL.GLRenderbufferHandle depthBuffer, bool ownsDepthBuffer) :723
...
// public static OpenGL.GLProgramHandle LinkProgram(OpenGL.GLShaderHandle vertexShader, OpenGL.GLShaderHandle fragmentShader) :785
...
// public static void TexImage2DFromBuffer(OpenGL.GLTextureTarget target, int w, int h, int mip, Uno.Graphics.Format format, Uno.Buffer data) :652
...
// public static void CheckError() [static] :636
...
// public static void CheckFramebufferStatus() [static] :644
...
// public static OpenGL.GLShaderHandle CompileShader(OpenGL.GLShaderType type, string source) [static] :767
...
// public static OpenGL.GLRenderbufferHandle CreateDepthBuffer(int2 size) [static] :753
...
// public static Uno.Graphics.RenderTarget CreateRenderTarget(OpenGL.GLTextureTarget colorTarget, OpenGL.GLTextureHandle colorBuffer, int mip, int2 size, bool depth) [static] :718
...
// public static Uno.Graphics.RenderTarget CreateRenderTarget(OpenGL.GLTextureTarget colorTarget, OpenGL.GLTextureHandle colorBuffer, int mip, int2 size, OpenGL.GLRenderbufferHandle depthBuffer, bool ownsDepthBuffer) [static] :723
...
// public static OpenGL.GLProgramHandle LinkProgram(OpenGL.GLShaderHandle vertexShader, OpenGL.GLShaderHandle fragmentShader) [static] :785
...
// public static void TexImage2DFromBuffer(OpenGL.GLTextureTarget target, int w, int h, int mip, Uno.Graphics.Format format, Uno.Buffer data) [static] :652
...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Runtime\Implementation\ShaderBackends\OpenGL\$.uno(822)
// -------------------------------------------------------------------------------------------------------------

// public static extern class GLInterop :822
// {
...
// public static OpenGL.GLBlendEquation ToGLBlendEquation(Uno.Graphics.BlendEquation x) :1088
void GLInterop__ToGLBlendEquation_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToGLBlendEquation(*x);
}

// public static OpenGL.GLBlendingFactor ToGLBlendingFactor(Uno.Graphics.BlendOperand x) :1010
void GLInterop__ToGLBlendingFactor_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToGLBlendingFactor(*x);
}

// public static OpenGL.GLBufferUsage ToGLBufferUsage(Uno.Graphics.BufferUsage x) :1124
void GLInterop__ToGLBufferUsage_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToGLBufferUsage(*x);
}

// public static OpenGL.GLCullFaceMode ToGLCullFaceMode(Uno.Graphics.PolygonFace x) :854
void GLInterop__ToGLCullFaceMode_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToGLCullFaceMode(*x);
}

// public static OpenGL.GLDepthFunction ToGLDepthFunction(Uno.Graphics.CompareFunc x) :896
void GLInterop__ToGLDepthFunction_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToGLDepthFunction(*x);
}

// public static OpenGL.GLFrontFaceDirection ToGLFrontFaceDirection(Uno.Graphics.PolygonWinding x) :824
void GLInterop__ToGLFrontFaceDirection_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToGLFrontFaceDirection(*x);
}

// public static OpenGL.GLIndexType ToGLIndexType(Uno.Graphics.IndexType x) :1142
void GLInterop__ToGLIndexType_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToGLIndexType(*x);
}

// public static OpenGL.GLPrimitiveType ToGLPrimitiveType(Uno.Graphics.PrimitiveType x) :962
void GLInterop__ToGLPrimitiveType_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToGLPrimitiveType(*x);
}

// public static void ToGLVertexAttributeType(Uno.Graphics.VertexAttributeType x, int& componentCount, OpenGL.GLDataType& componentType, bool& normalized) :1157
...
// public static Uno.Graphics.BlendEquation ToUnoGraphicsBlendEquation(OpenGL.GLBlendEquation x) :1106
void GLInterop__ToUnoGraphicsBlendEquation_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToUnoGraphicsBlendEquation(*x);
}

// public static Uno.Graphics.BlendOperand ToUnoGraphicsBlendOperand(OpenGL.GLBlendingFactor x) :1049
void GLInterop__ToUnoGraphicsBlendOperand_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToUnoGraphicsBlendOperand(*x);
}

// public static Uno.Graphics.CompareFunc ToUnoGraphicsCompareFunc(OpenGL.GLDepthFunction x) :929
void GLInterop__ToUnoGraphicsCompareFunc_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToUnoGraphicsCompareFunc(*x);
}

// public static Uno.Graphics.PolygonFace ToUnoGraphicsPolygonFace(OpenGL.GLCullFaceMode x) :875
void GLInterop__ToUnoGraphicsPolygonFace_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToUnoGraphicsPolygonFace(*x);
}

// public static Uno.Graphics.PolygonWinding ToUnoGraphicsPolygonWinding(OpenGL.GLFrontFaceDirection x) :839
void GLInterop__ToUnoGraphicsPolygonWinding_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToUnoGraphicsPolygonWinding(*x);
}

// public static Uno.Graphics.PrimitiveType ToUnoGraphicsPrimitiveType(OpenGL.GLPrimitiveType x) :986
void GLInterop__ToUnoGraphicsPrimitiveType_fn(int* x, int* __retval)
{
    *__retval = GLInterop::ToUnoGraphicsPrimitiveType(*x);
}

// public static OpenGL.GLBlendEquation ToGLBlendEquation(Uno.Graphics.BlendEquation x) [static] :1088
...
// public static OpenGL.GLBlendingFactor ToGLBlendingFactor(Uno.Graphics.BlendOperand x) [static] :1010
...
// public static OpenGL.GLBufferUsage ToGLBufferUsage(Uno.Graphics.BufferUsage x) [static] :1124
...
// public static OpenGL.GLCullFaceMode ToGLCullFaceMode(Uno.Graphics.PolygonFace x) [static] :854
...
// public static OpenGL.GLDepthFunction ToGLDepthFunction(Uno.Graphics.CompareFunc x) [static] :896
...
// public static OpenGL.GLFrontFaceDirection ToGLFrontFaceDirection(Uno.Graphics.PolygonWinding x) [static] :824
...
// public static OpenGL.GLIndexType ToGLIndexType(Uno.Graphics.IndexType x) [static] :1142
...
// public static OpenGL.GLPrimitiveType ToGLPrimitiveType(Uno.Graphics.PrimitiveType x) [static] :962
...
// public static void ToGLVertexAttributeType(Uno.Graphics.VertexAttributeType x, int& componentCount, OpenGL.GLDataType& componentType, bool& normalized) [static] :1157
...
// public static Uno.Graphics.BlendEquation ToUnoGraphicsBlendEquation(OpenGL.GLBlendEquation x) [static] :1106
...
// public static Uno.Graphics.BlendOperand ToUnoGraphicsBlendOperand(OpenGL.GLBlendingFactor x) [static] :1049
...
// public static Uno.Graphics.CompareFunc ToUnoGraphicsCompareFunc(OpenGL.GLDepthFunction x) [static] :929
...
// public static Uno.Graphics.PolygonFace ToUnoGraphicsPolygonFace(OpenGL.GLCullFaceMode x) [static] :875
...
// public static Uno.Graphics.PolygonWinding ToUnoGraphicsPolygonWinding(OpenGL.GLFrontFaceDirection x) [static] :839
...
// public static Uno.Graphics.PrimitiveType ToUnoGraphicsPrimitiveType(OpenGL.GLPrimitiveType x) [static] :986
...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Runtime\Implementation\ShaderBackends\OpenGL\$.uno(1296)
// --------------------------------------------------------------------------------------------------------------

// public sealed extern class GLProgram :1296
// {
...
// internal GLProgram(string vsSource, string fsSource, int constCount, int attribCount, string[] constAttribAndUniformNames) :1313
...
// public int get_ConstantCount() :1310
void GLProgram__get_ConstantCount_fn(GLProgram* __this, int* __retval)
{
    *__retval = __this->ConstantCount();
}

// public static Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLProgram Create(string vsSource, string fsSource, int constCount, int attribCount, string[] constAttribAndUniformNames) :1322
...
// public Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLCompiledProgram GetCompiledProgram(string[] constStrings) :1350
...
// private Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLCompiledProgram GetCompiledProgramInternal(string[] constStrings) :1327
...
// internal GLProgram New(string vsSource, string fsSource, int constCount, int attribCount, string[] constAttribAndUniformNames) :1313
...
// internal GLProgram(string vsSource, string fsSource, int constCount, int attribCount, string[] constAttribAndUniformNames) [instance] :1313
...
// public int get_ConstantCount() [instance] :1310
int GLProgram::ConstantCount()
{
    return _constCount;
}

// public Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLCompiledProgram GetCompiledProgram(string[] constStrings) [instance] :1350
...
// private Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLCompiledProgram GetCompiledProgramInternal(string[] constStrings) [instance] :1327
...
// public static Uno.Runtime.Implementation.ShaderBackends.OpenGL.GLProgram Create(string vsSource, string fsSource, int constCount, int attribCount, string[] constAttribAndUniformNames) [static] :1322
...
// internal GLProgram New(string vsSource, string fsSource, int constCount, int attribCount, string[] constAttribAndUniformNames) [static] :1313
