...
struct MainView__Fuse_iOS_StatusBarConfig_Uno_Platform_iOS_StatusBarStyle_Style_Property : ::g::Uno::UX::Property
{
    uStrong< ::g::Fuse::iOS::StatusBarConfig*> _obj;

    void ctor_1(::g::Fuse::iOS::StatusBarConfig* obj);
    static MainView__Fuse_iOS_StatusBarConfig_Uno_Platform_iOS_StatusBarStyle_Style_Property* New1(::g::Fuse::iOS::StatusBarConfig* obj);
};
// }
