...
namespace g{namespace Fuse{namespace Themes{struct GraphicsStyle__Fuse_Controls_ScrollView_bool_KeepFocusInView_Property;}}}
namespace g{namespace Fuse{namespace Themes{struct GraphicsStyle__Fuse_Controls_ScrollView_bool_UserScroll_Property;}}}
namespace g{namespace Fuse{namespace Themes{struct GraphicsStyle__Fuse_Gestures_Scroller_bool_UserScroll_Property;}}}
namespace g{namespace Fuse{namespace Themes{struct GraphicsStyle__Fuse_Triggers_WhileBool_bool_Value_Property;}}}
...
struct GraphicsStyle__Template9 : ::g::Uno::UX::Template
{
    ...
    uStrong< ::g::Fuse::Themes::GraphicsStyle__Fuse_Controls_ScrollView_bool_KeepFocusInView_Property*> self_KeepFocusInView_inst;
    uStrong< ::g::Fuse::Themes::GraphicsStyle__Fuse_Controls_ScrollView_bool_UserScroll_Property*> self_UserScroll_inst;
    uStrong< ::g::Fuse::Themes::GraphicsStyle__Fuse_Gestures_Scroller_bool_UserScroll_Property*> temp_UserScroll_inst;
    uStrong< ::g::Fuse::Themes::GraphicsStyle__Fuse_Triggers_WhileBool_bool_Value_Property*> temp1_Value_inst;
