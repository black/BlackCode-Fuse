            ...
            _activity.runOnUiThread(new Runnable() {
    				...
    				public void run() {
    					...
    					if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.HONEYCOMB) {
    						...
    						task.execute(_url, _method, _uploadHeaders, (Integer)_timeout, data, request, (Boolean)_verifyHost);
    					}
    				}});
        } catch (Exception e) {
            ...
            _activity.runOnUiThread(new Runnable() {
    				...
    				public void run() {
    					...
    					if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.HONEYCOMB) {
    						...
    						task.execute(_url, _method, _uploadHeaders, (Integer)_timeout, dataBuffer, request, (Boolean)_verifyHost);
    					}
    				}});
        } catch (Exception e) {
            this.OnError("Unable to build Async Http Request: "+e.getLocalizedMessage());
