...
uClassType* HttpMessageCache_typeof()
{
    ...
    ::STRINGS[24] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Uno.Net.Http\\0.20.1\\$.uno");
...
uType* InvalidResponseTypeException_typeof()
{
    ...
    ::STRINGS[40] = uString::Const("Response type is invalid.");
    type->SetFields(3);
    return type;
}
...
uType* InvalidStateException_typeof()
{
    ...
    ::STRINGS[41] = uString::Const("The object is in an invalid state.");
    type->SetFields(3);
    return type;
}
...
uType* SchemeParser_typeof()
{
    ...
    ::STRINGS[10] = uString::Const(":");
    ::STRINGS[42] = uString::Const("The scheme isn't specified in uriString.");
    ::STRINGS[43] = uString::Const("The scheme specified in uriString is not correctly formed.");
    ::STRINGS[44] = uString::Const("The length of the scheme specified in uriString exceeds 1023 characters.");
    ::STRINGS[21] = uString::Const("There is an invalid character sequence in uriString.");
    ::TYPES[3] = ::g::Uno::String_typeof();
...
::g::Uno::Net::Http::SchemeParserResult SchemeParser::Parse(uString* uriString, int* idx)
{
    ...
    if (end < 0)
        U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::STRINGS[42/*"The scheme ...*/]));

    if (((*idx + 2) >= uriString->Length()) || (end == *idx))
        U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::STRINGS[43/*"The scheme ...*/]));
...
uType* Uri_typeof()
{
    ...
    ::STRINGS[45] = uString::Const("uriString");
    ::STRINGS[46] = uString::Const("The length of uriString exceeds 65519 characters.");
    ::TYPES[3] = ::g::Uno::String_typeof();
    ::TYPES[26] = ::g::Uno::Net::Http::SchemeParserResult_typeof();
    ::TYPES[19] = ::g::Uno::Int_typeof();
    ::TYPES[9] = ::g::Uno::Net::Http::HostInfo_typeof();
...
void Uri::ctor_(uString* uriString)
{
    if (::g::Uno::String::IsNullOrEmpty(uriString))
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[45/*"uriString"*/]));

    uriString = ::g::Uno::String::Trim(uPtr(uriString));

    if (uriString->Length() > 65519)
        U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::STRINGS[46/*"The length ...*/]));
...
static void UriScheme__cctor__fn(uType* __type)
{
    ...
    ::g::Uno::Collections::List* collection1;
    UriScheme::KnownInternetSchemes_ = (collection2 = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[4/*Uno.Collections.List<string>*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[47/*"http"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[48/*"https"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[49/*"ftp"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[50/*"gopher"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[51/*"nntp"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[52/*"telnet"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[53/*"wais"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[54/*"file"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[55/*"prospero"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[56/*"ws"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection2), ::STRINGS[57/*"wss"*/]), collection2);
    UriScheme::KnownNonInternetSchemes_ = (collection1 = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[4/*Uno.Collections.List<string>*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[58/*"mailto"*/]), ::g::Uno::Collections::List__Add_fn(uPtr(collection1), ::STRINGS[59/*"news"*/]), collection1);
}
...
uType* UriScheme_typeof()
{
    ...
    ::STRINGS[47] = uString::Const("http");
    ::STRINGS[48] = uString::Const("https");
    ::STRINGS[49] = uString::Const("ftp");
    ::STRINGS[50] = uString::Const("gopher");
    ::STRINGS[51] = uString::Const("nntp");
    ::STRINGS[52] = uString::Const("telnet");
    ::STRINGS[53] = uString::Const("wais");
    ::STRINGS[54] = uString::Const("file");
    ::STRINGS[55] = uString::Const("prospero");
    ::STRINGS[56] = uString::Const("ws");
    ::STRINGS[57] = uString::Const("wss");
    ::STRINGS[58] = uString::Const("mailto");
    ::STRINGS[59] = uString::Const("news");
    ::TYPES[4] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[6] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Int_typeof());
    type->SetFields(0,
...
bool UriScheme::IsHttpScheme(uString* scheme)
{
    UriScheme_typeof()->Init();
    uString* s = ::g::Uno::String::ToLower(uPtr(scheme));
    return ::g::Uno::String::op_Equality(s, ::STRINGS[47/*"http"*/]) || ::g::Uno::String::op_Equality(s, ::STRINGS[48/*"https"*/]);
}
...
::g::Uno::Collections::Dictionary* UriScheme::DefaultPorts()
{
    ...
    if (UriScheme::_defaultPorts() == NULL)
    {
        ...
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[47/*"http"*/], uCRef<int>(80));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[48/*"https"*/], uCRef<int>(443));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[49/*"ftp"*/], uCRef<int>(21));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[50/*"gopher"*/], uCRef<int>(70));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[52/*"telnet"*/], uCRef<int>(119));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[53/*"wais"*/], uCRef<int>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[54/*"file"*/], uCRef<int>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[55/*"prospero"*/], uCRef<int>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[58/*"mailto"*/], uCRef<int>(25));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[59/*"news"*/], uCRef<int>(-1));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[56/*"ws"*/], uCRef<int>(80));
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(UriScheme::_defaultPorts()), ::STRINGS[57/*"wss"*/], uCRef<int>(443));
    }
...
uType* UserInfoParser_typeof()
{
    ...
    ::STRINGS[61] = uString::Const("The user name or password specified in uriString is not valid.");
    ::TYPES[5] = ::g::Uno::Bool_typeof();
    ::TYPES[3] = ::g::Uno::String_typeof();
    return type;
}
...
uString* UserInfoParser::Parse(uString* uriString, int endIdx, int* idx)
{
    ...
    int end = ::g::Uno::String::IndexOf1(uPtr(uriString), ::STRINGS[60/*"@"*/], *idx);
    ...
    if (!UserInfoParser::IsValid(userInfo))
        U_THROW(::g::Uno::Net::Http::UriFormatException::New4(::STRINGS[61/*"The user na...*/]));
