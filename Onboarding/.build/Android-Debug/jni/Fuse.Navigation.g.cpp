...
::g::Fuse::Behavior_type* SwipeNavigate_typeof()
{
    ...
    ::STRINGS[3] = uString::Const("SwipeNavigate: failed to find suitable Navigation object");
    ::STRINGS[1] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Navigation\\0.19.3\\$.uno");
...
void SwipeNavigate::OnPointerPressed(uObject* sender, ::g::Fuse::Input::PointerPressedArgs* args)
{
    ...
    if (_currentNavigation == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[3/*"SwipeNaviga...*/], 1, ::STRINGS[1/*"C:\\Program...*/], 1818);
        return;
    }
