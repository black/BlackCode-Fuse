...
JOAEnumerator_type* JOAEnumerator_typeof()
{
    ...
    ::TYPES[21] = ::g::Android::Runtime::ObjectArray_typeof();
    type->SetPrecalc(
        ::TYPES[21/*Android.Runtime.ObjectArray`1*/]->MakeType(type->T(0)));
    type->SetInterfaces(
...
void NativeActivityHelper::Init()
{
    ...
    jclass cls = ::g::Android::Base::JNI::LoadClass(jni, "com.Onboarding.Onboarding");
...
ObjectArray_type* ObjectArray_typeof()
{
    ...
    ::STRINGS[4] = uString::Const(") out of bounds for array of length ");
    ...
    type->SetPrecalc(
        ::TYPES[25/*Uno.Collections.IEnumerator`1*/]->MakeType(type->T(0)),
        ::TYPES[26/*Android.Runtime.JOAEnumerator`1*/]->MakeType(type->T(0)));
    type->SetInterfaces(
...
void ObjectArray::ctor_5(int length)
{
    ...
    ctor_4(::g::Android::Runtime::ObjectArrayAUX::makeArrayJObject(::g::Uno::String::Replace1(uPtr(::g::Uno::String::Substring(uPtr(uPtr(__types[0])->ToString()), 8)), ::STRINGS[1/*"."*/], ::STRINGS[2/*"/"*/]), length), __type, false, false);
}
...
uObject* ObjectArray::Item(int i)
{
    ...
    if ((i >= 0) && (i < len))
    {
        ...
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[3/*"Index ("*/], uBox<int>(::g::Uno::Int_typeof(), i)), ::STRINGS[4/*") out of bo...*/]), uBox<int>(::g::Uno::Int_typeof(), len))));
}
...
RunnableAction_type* RunnableAction_typeof()
{
    ...
    type->interface0.fp__IsSubclassed = (void(*)(uObject*, bool*))::g::Android::Base::Wrappers::JWrapper___IsSubclassed_fn;
    type->interface1.fp_Dispose = (void(*)(uObject*))::g::Android::Base::Wrappers::JWrapper__Uno_IDisposable_Dispose_fn;
    ::STRINGS[5] = uString::Const("com.Bindings.Binding_Android_Runtime_RunnableAction");
    ::STRINGS[6] = uString::Const("<init>");
    ::STRINGS[7] = uString::Const("(J)V");
    ::TYPES[28] = ::g::Uno::Bool_typeof();
    ::TYPES[2] = ::g::Android::Base::Wrappers::JWrapper_typeof();
...
void RunnableAction::ctor_4(uDelegate* actn)
{
    ...
    {
        RunnableAction::_javaClass2() = ::g::Android::Base::JNI::LocalToGlobalRef(::g::Android::Base::JNI::LoadClass3(::STRINGS[5/*"com.Binding...*/], false));
        JniHelper jni;
        BEGIN_REG_MTD(1);
    ...
    jmethodID mtd = ::g::Android::Base::JNI::GetMethodID(tmpCls, ::STRINGS[6/*"<init>"*/], ::STRINGS[7/*"(J)V"*/]);
