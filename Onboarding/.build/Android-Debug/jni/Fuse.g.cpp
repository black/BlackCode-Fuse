...
void DrawContext::Clear(::g::Uno::Float4 color, float depth)
{
    ...
    CheckGLError(::STRINGS[4/*"C:\\Program...*/], 681, ::STRINGS[14/*"Clear"*/]);
}
...
void DrawContext::GLFramebuffer(uint32_t value)
{
    ...
    CheckGLError(::STRINGS[4/*"C:\\Program...*/], 611, ::STRINGS[25/*"set_GLFrame...*/]);
}

// private void GLInconsistent(string msg) [instance] :821
void DrawContext::GLInconsistent(uString* msg)
{
    ::g::Fuse::Diagnostics::Error(::g::Uno::String::op_Addition2(::STRINGS[15/*"Inconsisten...*/], msg), this, ::STRINGS[4/*"C:\\Program...*/], 823, ::STRINGS[16/*"GLInconsist...*/]);
}
...
void DrawContext::GLScissor(::g::Uno::Int4 value)
{
    ...
    CheckGLError(::STRINGS[4/*"C:\\Program...*/], 722, ::STRINGS[28/*"set_GLScissor"*/]);
}
...
void DrawContext::GLViewportPixelSize(::g::Uno::Int2 value)
{
    ...
    CheckGLError(::STRINGS[4/*"C:\\Program...*/], 766, ::STRINGS[30/*"set_GLViewp...*/]);
}
...
void DrawContext::PopRenderTarget()
{
    ...
    CheckGLError(::STRINGS[4/*"C:\\Program...*/], 655, ::STRINGS[17/*"PopRenderTa...*/]);
...
void DrawContext::PushRenderTarget2(::g::Uno::Graphics::RenderTarget* rt, ::g::Uno::Int2 viewportPixelSize, ::g::Uno::Int4 glscissor)
{
    ...
    CheckGLError(::STRINGS[4/*"C:\\Program...*/], 640, ::STRINGS[18/*"PushRenderT...*/]);
    _renderTarget = rt;
...
void DrawContext::ReleaseRootbuffer()
{
    if (uPtr(_glScissors)->Count() > 0)
        ::g::Fuse::Diagnostics::Error(::STRINGS[19/*"Unpopped Sc...*/], this, ::STRINGS[4/*"C:\\Program...*/], 571, ::STRINGS[20/*"ReleaseRoot...*/]);

    uPtr(_glScissors)->Clear();

    if (uPtr(_cullFaces)->Count() > 0)
        ::g::Fuse::Diagnostics::Error(::STRINGS[21/*"Unpopped Cu...*/], this, ::STRINGS[4/*"C:\\Program...*/], 575, ::STRINGS[20/*"ReleaseRoot...*/]);

    uPtr(_cullFaces)->Clear();

    if (uPtr(_viewports)->Count() > 0)
        ::g::Fuse::Diagnostics::Error(::STRINGS[22/*"Unpopped Vi...*/], this, ::STRINGS[4/*"C:\\Program...*/], 579, ::STRINGS[20/*"ReleaseRoot...*/]);

    uPtr(_viewports)->Clear();

    if (uPtr(_renderTargets)->Count() > 0)
        ::g::Fuse::Diagnostics::Error(::STRINGS[23/*"Unpopped Re...*/], this, ::STRINGS[4/*"C:\\Program...*/], 583, ::STRINGS[20/*"ReleaseRoot...*/]);
...
Node_type* Node_typeof()
{
    ...
    ::STRINGS[53] = uString::Const("Should not have styling applied if not rooted");
    ::STRINGS[54] = uString::Const("Too many style properties - not enough backing store bits in Node");
    ::STRINGS[55] = uString::Const("Layout was invalidated while performing layout");
    ::STRINGS[56] = uString::Const("Rooting happening after the mixers update phase");
    ::STRINGS[4] = uString::Const("C:\\ProgramData\\Uno\\Packages\\FuseCore\\0.19.3\\$.uno");
    ::STRINGS[57] = uString::Const("MarkRooted");
    ::STRINGS[58] = uString::Const("Unrooting happening after the mixers update phase");
    ::STRINGS[59] = uString::Const("MarkUnrooted");
    ::STRINGS[60] = uString::Const(" already has a parent");
...
{
    if (!IsRootStage(2))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[53/*"Should not ...*/]));
...
int Node::GetPropertyState(int id)
{
    ...
    if (id < 16)
        ...
        U_THROW(::g::Uno::Exception::New2(::STRINGS[54/*"Too many st...*/]));
}
...
void Node::InvalidateLayout(int reason)
{
    if (Node::_performingLayout())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[55/*"Layout was ...*/]));
...
void Node::MarkRooted()
{
    ...
    if (::g::Fuse::UpdateManager::IsPastStage(1))
        ::g::Fuse::Diagnostics::Error(::STRINGS[56/*"Rooting hap...*/], this, ::STRINGS[4/*"C:\\Program...*/], 4149, ::STRINGS[57/*"MarkRooted"*/]);
...
void Node::MarkUnrooted()
{
    ...
    if (::g::Fuse::UpdateManager::IsPastStage(1))
        ::g::Fuse::Diagnostics::Error(::STRINGS[58/*"Unrooting h...*/], this, ::STRINGS[4/*"C:\\Program...*/], 4206, ::STRINGS[59/*"MarkUnrooted"*/]);
...
void Node::OnAdded(Node* parent)
{
    ...
    {
        if (_pendingRemove == NULL)
            U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::Object::ToString(this), ::STRINGS[60/*" already ha...*/]), (parent != _parent) ? (uString*)::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[61/*" ("*/], ::g::Uno::Object::ToString(uPtr(parent))), ::STRINGS[62/*")"*/]) : ::STRINGS[13/*""*/])));
...
void NodeEvent::Raise(::g::Fuse::NodeEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        ...
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[63/*"Invalid Rai...*/], 1, ::STRINGS[4/*"C:\\Program...*/], 934);
            return;
        }
    }
...
App__TimeListener_type* App__TimeListener_typeof()
{
    ...
    type->interface0.fp__IsSubclassed = (void(*)(uObject*, bool*))::g::Android::Base::Wrappers::JWrapper___IsSubclassed_fn;
    type->interface1.fp_Dispose = (void(*)(uObject*))::g::Android::Base::Wrappers::JWrapper__Uno_IDisposable_Dispose_fn;
    ::STRINGS[66] = uString::Const("com.Bindings.Binding_Fuse_App_TimeListener");
    ::STRINGS[37] = uString::Const("<init>");
    ::STRINGS[38] = uString::Const("(J)V");
    ::TYPES[17] = ::g::Uno::Bool_typeof();
    ::TYPES[71] = ::g::Android::Base::Wrappers::JWrapper_typeof();
...
void App__TimeListener::ctor_4(::g::Fuse::App* app)
{
    ...
    {
        _subclassed = true;
        _javaClassName = ::STRINGS[66/*"com.Binding...*/];
    }
    ...
    {
        App__TimeListener::_javaClass2() = ::g::Android::Base::JNI::LocalToGlobalRef(::g::Android::Base::JNI::LoadClass3(::STRINGS[66/*"com.Binding...*/], false));
        JniHelper jni;
        BEGIN_REG_MTD(1);
...
uClassType* UpdateManager_typeof()
{
    ...
    ::STRINGS[67] = uString::Const("no Action found to remove");
    ::STRINGS[68] = uString::Const("no OnceAction found to remove");
...
void UpdateManager::RemoveAction(uDelegate* pu, int stage)
{
    ...
    if (!UpdateManager::RemoveFrom(uPtr(s)->Listeners, pu))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[67/*"no Action f...*/]));
...
void UpdateManager::RemoveOnceAction(uDelegate* pu, int stage)
{
    ...
    if (!UpdateManager::RemoveFrom(uPtr(s)->Onces, pu))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[68/*"no OnceActi...*/]));
}
