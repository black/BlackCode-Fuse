...
::g::Fuse::Triggers::Actions::TriggerAction_type* RaiseUserEvent_typeof()
{
    ...
    ::STRINGS[4] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.UserEvents\\0.19.3\\$.uno");
...
void RaiseUserEvent__Perform_fn(RaiseUserEvent* __this, ::g::Fuse::Node* target)
{
    ...
    if (__this->_event == NULL)
        ::g::Fuse::Diagnostics::Error(::g::Uno::String::op_Addition2(::STRINGS[3/*"no UserEven...*/], __this->Name()), NULL, ::STRINGS[4/*"C:\\Program...*/], 112, ::STRINGS[5/*"Perform"*/]);
    else
