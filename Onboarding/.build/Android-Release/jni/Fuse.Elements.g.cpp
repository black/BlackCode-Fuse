...
Element_type* Element_typeof()
{
    ...
    type->interface0.fp_Show = (void(*)(uObject*))Element__Fuse_Triggers_Actions_IShow_Show_fn;
    type->interface2.fp_Collapse = (void(*)(uObject*))Element__Fuse_Triggers_Actions_ICollapse_Collapse_fn;
    type->interface1.fp_Hide = (void(*)(uObject*))Element__Fuse_Triggers_Actions_IHide_Hide_fn;
    type->interface4.fp_SetSize = (void(*)(uObject*, ::g::Uno::Float2*))Element__Fuse_Animations_IResize_SetSize_fn;
    type->interface3.fp_get_ActualSize = (void(*)(uObject*, ::g::Uno::Float3*))Element__Fuse_IActualPlacement_get_ActualSize_fn;
    type->interface3.fp_add_Placed = (void(*)(uObject*, uDelegate*))Element__add_Placed_fn;
    type->interface3.fp_remove_Placed = (void(*)(uObject*, uDelegate*))Element__remove_Placed_fn;
    ::STRINGS[3] = uString::Const("Draw called on a non-rooted node");
    ::STRINGS[4] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Elements\\0.19.3\\$.uno");
    ::STRINGS[5] = uString::Const("Draw");
    ...
    type->SetInterfaces(
        ::g::Fuse::Triggers::Actions::IShow_typeof(), offsetof(Element_type, interface0),
        ::g::Fuse::Triggers::Actions::IHide_typeof(), offsetof(Element_type, interface1),
        ::g::Fuse::Triggers::Actions::ICollapse_typeof(), offsetof(Element_type, interface2),
        ::g::Fuse::IActualPlacement_typeof(), offsetof(Element_type, interface3),
        ::g::Fuse::Animations::IResize_typeof(), offsetof(Element_type, interface4));
    type->SetFields(51,
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    if (!__this->IsLocalRooted())
        ::g::Fuse::Diagnostics::Error(::STRINGS[3/*"Draw called...*/], __this, ::STRINGS[4/*"C:\\Program...*/], 620, ::STRINGS[5/*"Draw"*/]);
...
// protected override sealed void PrependImplicitTransform(Fuse.FastMatrix m) :1754
...
{
    ::g::Uno::Float3 off = ::g::Fuse::Elements::ITransformOrigin::GetOffset(uInterface(uPtr(__this->TransformOrigin()), ::TYPES[96/*Fuse.Elements.ITransformOrigin*/]), __this);
...
uType* ElementAtlas_typeof()
{
    ...
    ::STRINGS[6] = uString::Const("element not already inserted anywhere!");
    ::STRINGS[7] = uString::Const("wrong atlas again, dummy!");
    ::STRINGS[8] = uString::Const("Removing from wrong atlas");
    ...
    ::TYPES[69] = ::g::Fuse::Elements::DisplayHelpers_typeof();
    ::TYPES[70] = ::g::Fuse::Elements::TextureAtlas_typeof();
    ::TYPES[71] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Elements::Element_typeof());
    ::TYPES[4] = ::g::Fuse::Node_typeof();
    ::TYPES[3] = ::g::Uno::Float2_typeof();
    ::TYPES[18] = ::g::Fuse::OrthographicFrustum_typeof();
    ::TYPES[23] = ::g::Fuse::IViewport_typeof();
...
void ElementAtlas::FillFramebuffer(::g::Fuse::DrawContext* dc, bool drawAll, ::g::Uno::Rect scissorRectInClipSpace)
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::Element*> > enum2 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret7), ret7); enum2.MoveNext(::TYPES[71/*Uno.Collections.List<Fuse.Elements.Element>.Enumerator*/]); )
    {
        ::g::Fuse::Elements::Element* elm = enum2.Current(::TYPES[71/*Uno.Collections.List<Fuse.Elements.Element>.Enumerator*/]);
...
void ElementAtlas::OnFramebufferCollected(uObject* sender, ::g::Uno::EventArgs* eventArgs)
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Elements::Element*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret8), ret8); enum1.MoveNext(::TYPES[71/*Uno.Collections.List<Fuse.Elements.Element>.Enumerator*/]); )
    {
        ::g::Fuse::Elements::Element* elm = enum1.Current(::TYPES[71/*Uno.Collections.List<Fuse.Elements.Element>.Enumerator*/]);
...
{
    if (uPtr(elm)->ElementBatchEntry() == NULL)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[6/*"element not...*/]));
...
void ElementAtlas::RemoveElement(::g::Fuse::Elements::Element* elm)
{
    ...
    if (uPtr(entry)->_atlas != this)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[8/*"Removing fr...*/]));
...
uType* ElementAtlasFramebuffer_typeof()
{
    ...
    ::STRINGS[9] = uString::Const("Cannot Collect while pinned!");
    ::STRINGS[10] = uString::Const("ElementAtlasFramebuffer already pinned");
    ::STRINGS[11] = uString::Const("ElementAtlasFramebuffer not already pinned");
    ::TYPES[53] = ::g::Uno::Delegate_typeof();
    ::TYPES[57] = ::g::Uno::EventHandler_typeof();
    ::TYPES[14] = uObject_typeof();
    ::TYPES[72] = ::g::Fuse::Elements::ElementAtlasFramebufferPoolEntry_typeof();
    ::TYPES[73] = ::g::Uno::Collections::LinkedListNode_typeof()->MakeType(::g::Fuse::Elements::ElementAtlasFramebufferPoolEntry_typeof());
    ::TYPES[9] = ::g::Uno::Bool_typeof();
    ::TYPES[74] = ::g::Fuse::Elements::ElementAtlasFramebufferPool_typeof();
    type->SetFields(0,
...
void ElementAtlasFramebuffer::Collect()
{
    ...
    if (Pinned())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[9/*"Cannot Coll...*/]));
...
{
    if (!Pinned())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[11/*"ElementAtla...*/]));
...
ElementBatch_type* ElementBatch_typeof()
{
    ...
    ::STRINGS[12] = uString::Const("wrong atlas, stupid!");
    ::STRINGS[13] = uString::Const("element has no caching rect");
    ::STRINGS[14] = uString::Const("wrong batch, stupid!");
...
void ElementBatch::RemoveElement(::g::Fuse::Elements::Element* elm)
{
    ...
    if (uPtr(uPtr(elm)->ElementBatchEntry())->_batch != this)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[14/*"wrong batch...*/]));
...
::g::Uno::Recti ElementBatch::GetCachingRect(::g::Fuse::Elements::Element* elm)
{
    ...
    if (bounds.IsInfinite())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[13/*"element has...*/]));
...
::g::Fuse::Elements::BoxSizing_type* LayoutMasterBoxSizing_typeof()
{
    ...
    ::TYPES[2] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[48] = ::g::Fuse::Elements::StandardBoxSizing_typeof();
    ::TYPES[95] = LayoutMasterBoxSizing__LayoutMasterData_typeof();
    ::TYPES[4] = ::g::Fuse::Node_typeof();
    ::TYPES[14] = uObject_typeof();
    type->SetFields(0,
...
LayoutMasterBoxSizing__LayoutMasterData* LayoutMasterBoxSizing::GetLayoutMasterData(::g::Fuse::Elements::Element* elm)
{
    ...
    if (uPtr(uPtr(elm)->Properties())->TryGet(LayoutMasterBoxSizing::_layoutMasterDataProperty(), &v))
        return uCast<LayoutMasterBoxSizing__LayoutMasterData*>(v, ::TYPES[95/*Fuse.Elements.LayoutMasterBoxSizing.LayoutMasterData*/]);
...
// internal sealed class StandardBoxSizing :107
// {
...
uClassType* TransformOrigins_typeof()
{
    ...
    ::TYPES[96] = ::g::Fuse::Elements::ITransformOrigin_typeof();
    ::TYPES[97] = TransformOrigins__BoxCenter_typeof();
    type->SetFields(0,
...
Viewport_type* Viewport_typeof()
{
    ...
    type->interface5.fp_PointToWorldRay = (void(*)(uObject*, ::g::Uno::Float2*, ::g::Uno::Geometry::Ray*))Viewport__PointToWorldRay_fn;
    type->interface5.fp_get_PointDensity = (void(*)(uObject*, float*))Viewport__get_PointDensity1_fn;
    type->interface5.fp_get_Size = (void(*)(uObject*, ::g::Uno::Float2*))Viewport__get_Size_fn;
    type->interface5.fp_get_ViewProjectionTransform = (void(*)(uObject*, ::g::Uno::Float4x4*))Viewport__get_ViewProjectionTransform_fn;
    type->interface5.fp_get_ViewProjectionTransformInverse = (void(*)(uObject*, ::g::Uno::Float4x4*))Viewport__get_ViewProjectionTransformInverse_fn;
    ...
    ::TYPES[26] = ::g::Uno::Graphics::Framebuffer_typeof();
    ::TYPES[65] = ::g::Fuse::NodeBounds_typeof();
    ::TYPES[98] = ::g::Fuse::FrustumViewport_typeof();
    type->SetInterfaces(
        ::g::Fuse::Triggers::Actions::IShow_typeof(), offsetof(Viewport_type, interface0),
        ::g::Fuse::Triggers::Actions::IHide_typeof(), offsetof(Viewport_type, interface1),
        ::g::Fuse::Triggers::Actions::ICollapse_typeof(), offsetof(Viewport_type, interface2),
        ::g::Fuse::IActualPlacement_typeof(), offsetof(Viewport_type, interface3),
        ::g::Fuse::Animations::IResize_typeof(), offsetof(Viewport_type, interface4),
        ::g::Fuse::IViewport_typeof(), offsetof(Viewport_type, interface5));
    type->SetFields(82,
