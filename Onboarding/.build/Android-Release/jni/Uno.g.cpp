...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::UShort::ToString(__this->X, ::TYPES[35/*ushort*/]), ::STRINGS[7/*", "*/]), ::g::Uno::UShort::ToString(__this->Y, ::TYPES[35/*ushort*/])), void();
}
// }
