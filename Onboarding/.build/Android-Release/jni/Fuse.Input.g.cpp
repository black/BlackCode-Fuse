...
uClassType* Pointer_typeof()
{
    ...
    ::STRINGS[13] = uString::Const("SoftCapture requires softCapturer Node");
...
::g::Fuse::NodeEvent_type* PointerLeft_typeof()
{
    ...
    ::TYPES[65] = ::g::Fuse::Input::PointerLeftHandler_typeof();
    type->SetFields(2);
    return type;
}
...
::g::Fuse::NodeEvent_type* PointerPressed_typeof()
{
    ...
    ::TYPES[67] = ::g::Fuse::Input::PointerPressedHandler_typeof();
    type->SetFields(2);
    return type;
}
...
::g::Fuse::NodeEvent_type* PointerReleased_typeof()
{
    ...
    ::TYPES[68] = ::g::Fuse::Input::PointerReleasedHandler_typeof();
    type->SetFields(2);
    return type;
}
...
::g::Fuse::NodeEvent_type* PointerWheelMoved_typeof()
{
    ...
    ::TYPES[69] = ::g::Fuse::Input::PointerWheelMovedHandler_typeof();
    type->SetFields(2);
    return type;
}
...
uType* SelectionQuery_typeof()
{
    ...
    ::TYPES[50] = ::g::Fuse::HitTestResult_typeof();
    ::TYPES[70] = ::g::Fuse::HitTestCallback_typeof();
    type->SetFields(0,
...
{
    ::g::Fuse::HitTestContext* args = ::g::Fuse::HitTestContext::New1(point, uDelegate::New(::TYPES[70/*Fuse.HitTestCallback*/], (void*)SelectionQuery__Select_fn, this));
...
::g::Fuse::NodeEvent_type* TextEntered_typeof()
{
    ...
    ::TYPES[71] = ::g::Fuse::Input::TextEnteredHandler_typeof();
    type->SetFields(2);
    return type;
}
...
uClassType* TextService_typeof()
{
    ...
    ::TYPES[72] = ::g::Fuse::NodeEvent_typeof()->MakeType(::g::Fuse::Input::TextEnteredHandler_typeof(), ::g::Fuse::Input::TextEnteredArgs_typeof());
    type->SetFields(0,
