...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/Onboarding/Onboarding");
    jclass entryPointsClass = env->FindClass("com/Onboarding/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/Onboarding/Display");
