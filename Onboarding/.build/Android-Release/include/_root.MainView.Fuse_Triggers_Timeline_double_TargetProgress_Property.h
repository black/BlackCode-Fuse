...
struct MainView__Fuse_Triggers_Timeline_double_TargetProgress_Property : ::g::Uno::UX::Property
{
    uStrong< ::g::Fuse::Triggers::Timeline*> _obj;

    void ctor_1(::g::Fuse::Triggers::Timeline* obj);
    static MainView__Fuse_Triggers_Timeline_double_TargetProgress_Property* New1(::g::Fuse::Triggers::Timeline* obj);
};
// }
