public partial class MainView: Fuse.App
{
    ...
    internal void InitializeUX()
    {
        ...
        var temp30 = new Fuse.Drawing.StaticSolidColor(float4(0.9058824f, 0.2980392f, 0.2352941f, 1f));
        var temp31 = new Fuse.Controls.Rectangle();
        var temp32 = new Fuse.Drawing.StaticSolidColor(float4(0.1843137f, 0.2039216f, 0.2313726f, 1f));
        this.Background = float4(0.4666667f, 0.4666667f, 0.4666667f, 1f);
        temp.Children.Add(temp1);
        temp.Children.Add(temp31);
        ...
        temp24.Width = 40f;
        Fuse.Elements.Element.HeightProperty.Set(temp24, 100f, global::Fuse.Elements.SizeUnit.Percent);
        temp24.Alignment = Fuse.Elements.Alignment.TopRight;
        temp24.Padding = float4(8f, 16f, 8f, 16f);
        ...
        temp26.Margin = float4(8f, 72f, 64f, 8f);
        temp26.Children.Add(temp27);
        temp26.Children.Add(temp28);
        temp27.Value = "Technology Trends in 2015";
        temp27.TextWrapping = Fuse.Elements.TextWrapping.Wrap;
        temp27.FontSize = 21f;
        temp27.TextColor = float4(0f, 0f, 0f, 1f);
        temp28.Value = "by Mark";
        temp28.FontSize = 16f;
        temp28.TextColor = float4(1f, 0f, 0f, 1f);
        Fuse.Elements.Element.WidthProperty.Set(temp31, 100f, global::Fuse.Elements.SizeUnit.Percent);
        temp31.Height = 250f;
