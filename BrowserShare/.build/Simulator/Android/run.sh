...
adb devices | tail -n +2 | cut -sf 1 | xargs -I {} adb -s {} uninstall com.BrowserShare

echo ""
echo "## Installing new version of APK"
adb devices | tail -n +2 | cut -sf 1 | xargs -I {} adb -s {} install -r bin/BrowserShare-debug.apk
...
adb devices | tail -n +2 | cut -sf 1 | xargs -I {} adb -s {} shell \
    ...
    com.BrowserShare/com.BrowserShare.BrowserShare
