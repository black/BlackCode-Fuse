...
// public void AddSubscriber() :3882
...
// public void RemoveSubscriber() :3887
...
// public void AddSubscriber() [instance] :3882
...
// public void RemoveSubscriber() [instance] :3887
...
// C:\ProgramData\Uno\Packages\FuseCore\0.19.3\$.uno(5935)
// -------------------------------------------------------

// internal delegate Fuse.Theme NativeWithFallbackTheme.CreateTheme() :5935
...
// C:\ProgramData\Uno\Packages\FuseCore\0.19.3\$.uno(2167)
// -------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\FuseCore\0.19.3\$.uno(2181)
// -------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Entities\0.19.3\Processing\$.uno(17)
// ---------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\FuseCore\0.19.3\$.uno(2805)
// -------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\FuseCore\0.19.3\$.uno(5901)
// -------------------------------------------------------
...
// public generated NativeTheme() [instance] :5901
void NativeTheme::ctor_3()
{
    ctor_1();
}

// public generated NativeTheme New() [static] :5901
...
// public static Fuse.Theme get_Singleton() [static] :5907
...
// C:\ProgramData\Uno\Packages\FuseCore\0.19.3\$.uno(5916)
// -------------------------------------------------------

// public sealed class NativeWithFallbackTheme :5916
// {
...
// public generated NativeWithFallbackTheme() [instance] :5916
void NativeWithFallbackTheme::ctor_()
{
}

// public generated NativeWithFallbackTheme New() [static] :5916
...
// public static Fuse.Theme get_Singleton() [static] :5922
...
// internal static generated Fuse.NativeWithFallbackTheme.CreateTheme get_ThemeFactory() [static] :5936
uDelegate* NativeWithFallbackTheme::ThemeFactory()
{
    return NativeWithFallbackTheme::_ThemeFactory();
}

// internal static generated void set_ThemeFactory(Fuse.NativeWithFallbackTheme.CreateTheme value) [static] :5936
...
// public void add_Added(Uno.EventHandler value) :3986
void Node__add_Added_fn(Node* __this, uDelegate* value)
{
    __this->add_Added(value);
}

// public void remove_Added(Uno.EventHandler value) :3987
...
// public void AddStyleTransform(Fuse.Transform t) :3531
...
// public bool get_IsVisualInvalid() :3844
...
// public virtual Uno.Geometry.Box get_LocalBounds() :3620
...
// public float2 LocalToParent(float2 localPoint) :4252
...
// public void OnIsSelectedChanged(bool isSelected) :3925
...
// public void add_Removed(Uno.EventHandler value) :3994
void Node__add_Removed_fn(Node* __this, uDelegate* value)
{
    __this->add_Removed(value);
}

// public void remove_Removed(Uno.EventHandler value) :3995
...
// public virtual Uno.Geometry.Ray WindowToWorldRay(float2 windowCoord) :3781
...
// public float3 get_WorldPosition() :3615
...
// public void add_Added(Uno.EventHandler value) [instance] :3986
void Node::add_Added(uDelegate* value)
{
    AddEventHandler(Node::_addedHandle(), 6, value);
}

// public void remove_Added(Uno.EventHandler value) [instance] :3987
...
// public void AddStyleTransform(Fuse.Transform t) [instance] :3531
...
// public bool get_IsVisualInvalid() [instance] :3844
...
// public float2 LocalToParent(float2 localPoint) [instance] :4252
...
void Node::MarkRooted()
{
    ...
    if (::g::Fuse::UpdateManager::IsPastStage(1))
        ::g::Fuse::Diagnostics::Error(::STRINGS[58/*"Rooting hap...*/], this, ::STRINGS[4/*"C:\\Program...*/], 4149, ::STRINGS[59/*"MarkRooted"*/]);
...
void Node::MarkUnrooted()
{
    ...
    if (::g::Fuse::UpdateManager::IsPastStage(1))
        ::g::Fuse::Diagnostics::Error(::STRINGS[60/*"Unrooting h...*/], this, ::STRINGS[4/*"C:\\Program...*/], 4206, ::STRINGS[61/*"MarkUnrooted"*/]);
...
// public void OnIsSelectedChanged(bool isSelected) [instance] :3925
...
// public void add_Removed(Uno.EventHandler value) [instance] :3994
void Node::add_Removed(uDelegate* value)
{
    AddEventHandler(Node::_removedHandle(), 7, value);
}

// public void remove_Removed(Uno.EventHandler value) [instance] :3995
...
// public float3 get_WorldPosition() [instance] :3615
...
// public static Fuse.NodeBounds Point(float3 pt) :4305
...
// public Fuse.NodeBounds AddPoint(float2 pt) [instance] :4360
NodeBounds* NodeBounds::AddPoint(::g::Uno::Float2 pt)
{
    return Merge(NodeBounds::Point(::g::Uno::Float3__New4(pt, 0.0f)), NULL);
}

// public Fuse.NodeBounds AddPoint(float3 pt) [instance] :4355
...
// public float3 get_AxisMax() [instance] :4345
::g::Uno::Float3 NodeBounds::AxisMax()
{
    return _box.Maximum;
}

// public float3 get_AxisMin() [instance] :4344
...
// public bool get_IsFlat() [instance] :4352
...
// public static Fuse.NodeBounds Point(float3 pt) [static] :4305
...
// public float2 GetDepthRange(Fuse.IViewport viewport) :4593
...
// public float3 GetWorldPosition(Fuse.IViewport viewport) :4588
...
// public float2 GetDepthRange(Fuse.IViewport viewport) [instance] :4593
...
// public float3 GetWorldPosition(Fuse.IViewport viewport) [instance] :4588
...
// C:\ProgramData\Uno\Packages\FuseCore\0.19.3\$.uno(4633)
// -------------------------------------------------------

// public sealed class PerspectiveFrustum :4633
// {
...
// public float4x4 GetProjectionTransformInverse(Fuse.IViewport viewport) [instance] :4650
...
// public float4x4 GetViewTransform(Fuse.IViewport viewport) [instance] :4645
...
// public float4x4 GetViewTransformInverse(Fuse.IViewport viewport) [instance] :4657
...
// public float3 GetWorldPosition(Fuse.IViewport viewport) [instance] :4662
...
// public generated PerspectiveFrustum New() [static] :4633
...
// public object get_DefaultValue() :6301
...
// public void Serialize(Fuse.Scripting.IEventSerializer serializer) :6298
...
// public object get_DefaultValue() [instance] :6301
...
// public void Serialize(Fuse.Scripting.IEventSerializer serializer) [instance] :6298
...
// public bool Has(Fuse.PropertyHandle handle) :5088
...
// public void RemoveAllFromList(Fuse.PropertyHandle handle, object val) :5136
...
// public object[] ToArray(Fuse.PropertyHandle handle) :5141
...
// public bool Has(Fuse.PropertyHandle handle) [instance] :5088
...
// public void RemoveAllFromList(Fuse.PropertyHandle handle, object val) [instance] :5136
...
// public object[] ToArray(Fuse.PropertyHandle handle) [instance] :5141
...
// C:\ProgramData\Uno\Packages\FuseCore\0.19.3\$.uno(3877)
// -------------------------------------------------------

// public sealed class RequiresRootedException :3877
// {
...
// public float get_DegreesX() [instance] :6159
float Rotation::DegreesX()
{
    return ::g::Uno::Math::RadiansToDegrees1(_euler.X);
}

// public void set_DegreesX(float value) [instance] :6160
...
// public float get_DegreesY() [instance] :6145
float Rotation::DegreesY()
{
    return ::g::Uno::Math::RadiansToDegrees1(_euler.Y);
}

// public void set_DegreesY(float value) [instance] :6146
...
// public float3 get_EulerAngleDegrees() [instance] :6111
::g::Uno::Float3 Rotation::EulerAngleDegrees()
{
    return ::g::Uno::Math::RadiansToDegrees3(_euler);
}

// public void set_EulerAngleDegrees(float3 value) [instance] :6112
...
// public float get_Factor() [instance] :5293
float Scaling::Factor()
{
    return _vector.X;
}

// public void set_Factor(float value) [instance] :5294
...
// public float get_X() [instance] :5320
float Scaling::X()
{
    return Vector().X;
}

// public void set_X(float value) [instance] :5321
void Scaling::X(float value)
{
    Vector(::g::Uno::Float3__New2(value, Vector().Y, Vector().Z));
}

// public float get_Y() [instance] :5326
float Scaling::Y()
{
    return Vector().Y;
}

// public void set_Y(float value) [instance] :5327
void Scaling::Y(float value)
{
    Vector(::g::Uno::Float3__New2(Vector().X, value, Vector().Z));
}

// public float get_Z() [instance] :5332
float Scaling::Z()
{
    return Vector().Z;
}

// public void set_Z(float value) [instance] :5333
...
// public float2 get_Degrees() [instance] :6245
::g::Uno::Float2 Shear::Degrees()
{
    return ::g::Uno::Float2__New2(DegreesX(), DegreesY());
}

// public void set_Degrees(float2 value) [instance] :6246
...
// public float get_DegreesX() [instance] :6217
float Shear::DegreesX()
{
    return _vector.X;
}

// public void set_DegreesX(float value) [instance] :6218
...
// public float get_DegreesY() [instance] :6231
float Shear::DegreesY()
{
    return _vector.Y;
}

// public void set_DegreesY(float value) [instance] :6232
...
// public static void ResetAll(Fuse.Node n) :5419
...
// public static void ResetAll(Fuse.Node n) [static] :5419
...
// public T get_DefaultValue() :5452
...
// public override sealed bool HasValueFor(object owner) :5491
...
// internal override void ResetFor(Fuse.Node n) :5620
...
// public new bool Reset(TOwner owner) :5722
...
// internal override sealed void ResetFor(Fuse.Node n) :5739
...
// public new bool Reset(TOwner owner) [instance] :5722
...
// protected Theme(Fuse.Node rootMediator) :5877
...
// protected Theme(Fuse.Node rootMediator) [instance] :5877
...
// public static float get_FrameIntervalFloat() :6025
...
// public static float get_FrameIntervalFloat() [static] :6025
...
// C:\ProgramData\Uno\Packages\FuseCore\0.19.3\$.uno(5947)
// -------------------------------------------------------

// public sealed class Timer :5947
// {
uType* Timer_typeof()
{
    static uSStrong<uType*> type;
...
// private void Start() [instance] :5963
void Timer::Start()
{
    _startTime = ::g::Uno::Diagnostics::Clock::GetSeconds();
...
// private void Stop() [instance] :5970
void Timer::Stop()
{
    _running = false;
...
// private void Update() [instance] :5976
void Timer::Update()
{
...
// private Timer New(double interval, Uno.Action callback) [static] :5955
...
// public static void Wait(double duration, Uno.Action callback) [static] :5990
...
// public float2 get_XY() [instance] :6491
::g::Uno::Float2 Translation::XY()
{
    return ::g::Uno::Float2__New2(_x, _y);
}

// public void set_XY(float2 value) [instance] :6492
...
::g::Fuse::Behavior_type* UserEvent_typeof()
{
    ...
    ::STRINGS[72] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.UserEvents\\0.19.3\\$.uno");
