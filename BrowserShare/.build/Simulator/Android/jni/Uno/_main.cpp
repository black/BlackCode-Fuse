...
namespace g{namespace Uno{namespace UX{struct Property_type;}} ::g::Uno::UX::Property_type* MainView__Fuse_Elements_Element_Fuse_Elements_Visibility_Visibility_Property_typeof();}
...
namespace g{uClassType* BrowserShare_bundle_typeof();}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::BrowserShare_bundle_typeof,
        ...
        (uType*(*)())&::g::MainView__Fuse_Elements_Element_Fuse_Elements_Visibility_Visibility_Property_typeof,
