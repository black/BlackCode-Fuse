...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/BrowserShare/BrowserShare");
    jclass entryPointsClass = env->FindClass("com/BrowserShare/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/BrowserShare/Display");
