...
// C:\ProgramData\Uno\Packages\Fuse.Entities\0.19.3\Processing\$.uno(27)
// ---------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Entities\0.19.3\Processing\$.uno(107)
// ----------------------------------------------------------------------

// internal sealed class Stroke :107
// {
...
// private void Invalidate() [instance] :173
...
// public float get_Offset() [instance] :124
float Stroke::Offset()
{
    return _offset;
}

// public void set_Offset(float value) [instance] :125
...
// public Fuse.Drawing.Polygon get_Output() [instance] :184
...
// public generated void add_OutputChanged(Uno.Action value) [instance] :179
void Stroke::add_OutputChanged(uDelegate* value)
{
    OutputChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(OutputChanged1, value), ::TYPES[1/*Uno.Action*/]);
}

// public generated void remove_OutputChanged(Uno.Action value) [instance] :179
void Stroke::remove_OutputChanged(uDelegate* value)
{
    OutputChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(OutputChanged1, value), ::TYPES[1/*Uno.Action*/]);
}

// public Fuse.IOutput<Fuse.Drawing.Polygon> get_Source() [instance] :162
uObject* Stroke::Source()
{
    return _source;
}

// public void set_Source(Fuse.IOutput<Fuse.Drawing.Polygon> value) [instance] :163
...
// public Fuse.Drawing.LineCap get_StartCap() [instance] :136
int Stroke::StartCap()
{
    return _startCap;
}

// public void set_StartCap(Fuse.Drawing.LineCap value) [instance] :137
...
// public float get_Width() [instance] :112
float Stroke::Width()
{
    return _width;
}

// public void set_Width(float value) [instance] :113
...
// public generated Stroke New() [static] :107
Stroke* Stroke::New1()
{
