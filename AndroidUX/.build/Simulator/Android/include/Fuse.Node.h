...
struct Node_type : uType
{
    ...
    void(*fp_AdjustMarginBoxPosition)(::g::Fuse::Node*, ::g::Uno::Float2*);
...
struct Node : uObject
{
    ...
    static void AdjustMarginBoxPosition(Node* __this, ::g::Uno::Float2 position);
...
inline void Node::AdjustMarginBoxPosition(::g::Uno::Float2 position) { (((Node_type*)__type)->fp_AdjustMarginBoxPosition)(this, &position); }
...
inline void Node::AdjustMarginBoxPosition(Node* __this, ::g::Uno::Float2 position) { Node__AdjustMarginBoxPosition_fn(__this, &position); }
