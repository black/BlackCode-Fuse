...
struct MainView__Fuse_Effects_Blur_float_Radius_Property : ::g::Uno::UX::Property
{
    uStrong< ::g::Fuse::Effects::Blur*> _obj;

    void ctor_1(::g::Fuse::Effects::Blur* obj);
    static MainView__Fuse_Effects_Blur_float_Radius_Property* New1(::g::Fuse::Effects::Blur* obj);
};
// }
