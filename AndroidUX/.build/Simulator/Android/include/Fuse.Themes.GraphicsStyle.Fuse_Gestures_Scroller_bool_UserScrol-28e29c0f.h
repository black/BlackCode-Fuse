...
struct GraphicsStyle__Fuse_Gestures_Scroller_bool_UserScroll_Property : ::g::Uno::UX::Property
{
    uStrong< ::g::Fuse::Gestures::Scroller*> _obj;

    void ctor_1(::g::Fuse::Gestures::Scroller* obj);
    static GraphicsStyle__Fuse_Gestures_Scroller_bool_UserScroll_Property* New1(::g::Fuse::Gestures::Scroller* obj);
};
// }
