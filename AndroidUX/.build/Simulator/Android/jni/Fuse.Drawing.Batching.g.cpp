...
// C:\ProgramData\Uno\Packages\Fuse.Drawing.Batching\0.18.8\$.uno(11)
// ------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Drawing.Batching\0.18.8\$.uno(136)
// -------------------------------------------------------------------

// public static class BatchHelpers :136
// {
...
// public static Fuse.Drawing.Batching.BatchIndexBuffer CreateBatchIndexBuffer(Uno.Content.Models.IndexArray array) :207
...
// public static Fuse.Drawing.Batching.BatchVertexBuffer CreateBatchVertexBuffer(Uno.Content.Models.VertexAttributeArray array) :178
...
// public static Fuse.Drawing.Batching.Batch CreateSingleBatch(Uno.Content.Models.ModelMesh m) :138
...
// public static Fuse.Drawing.Batching.BatchIndexBuffer CreateBatchIndexBuffer(Uno.Content.Models.IndexArray array) [static] :207
...
// public static Fuse.Drawing.Batching.BatchVertexBuffer CreateBatchVertexBuffer(Uno.Content.Models.VertexAttributeArray array) [static] :178
...
// public static Fuse.Drawing.Batching.Batch CreateSingleBatch(Uno.Content.Models.ModelMesh m) [static] :138
...
// C:\ProgramData\Uno\Packages\Fuse.Drawing.Batching\0.18.8\$.uno(236)
// -------------------------------------------------------------------

// public sealed class BatchIndexBuffer :236
// {
...
// public BatchIndexBuffer(Uno.Graphics.IndexType type, int maxIndices, bool staticBatch) :255
...
// public BatchIndexBuffer New(Uno.Graphics.IndexType type, Uno.Buffer data) :262
...
// public BatchIndexBuffer(Uno.Graphics.IndexType type, Uno.Buffer data) [instance] :262
...
// public Uno.Buffer get_Buffer() [instance] :274
...
// public Uno.Graphics.IndexType get_DataType() [instance] :241
int BatchIndexBuffer::DataType()
{
    return dataType;
}

// public void set_DataType(Uno.Graphics.IndexType value) [instance] :242
...
// public void Flush() [instance] :318
...
// public Uno.Graphics.IndexBuffer get_IndexBuffer() [instance] :304
...
// public void Invalidate() [instance] :327
void BatchIndexBuffer::Invalidate()
{
    isDirty = true;
}

// public int get_Position() [instance] :284
int BatchIndexBuffer::Position()
{
    return _position;
}

// public void set_Position(int value) [instance] :285
void BatchIndexBuffer::Position(int value)
{
    _position = value;
}

// public int get_StrideInBytes() [instance] :249
int BatchIndexBuffer::StrideInBytes()
{
    return ::g::Uno::Graphics::IndexTypeHelpers::GetStrideInBytes(DataType());
}

// public void Write(byte value) [instance] :288
...
// public void Write(ushort value) [instance] :294
...
// public BatchIndexBuffer New(Uno.Graphics.IndexType type, int maxIndices, bool staticBatch) [static] :255
...
// public BatchIndexBuffer New(Uno.Graphics.IndexType type, Uno.Buffer data) [static] :262
...
// C:\ProgramData\Uno\Packages\Fuse.Drawing.Batching\0.18.8\$.uno(344)
// -------------------------------------------------------------------

// public sealed class BatchVertexBuffer :344
// {
...
// public BatchVertexBuffer(Uno.Graphics.VertexAttributeType type, int maxVertices, bool staticBatch) :362
...
// public BatchVertexBuffer New(Uno.Graphics.VertexAttributeType type, Uno.Buffer data) :369
...
// public BatchVertexBuffer(Uno.Graphics.VertexAttributeType type, Uno.Buffer data) [instance] :369
...
// public Uno.Buffer get_Buffer() [instance] :383
...
// public Uno.Graphics.VertexAttributeType get_DataType() [instance] :349
int BatchVertexBuffer::DataType()
{
    return dataType;
}

// public void set_DataType(Uno.Graphics.VertexAttributeType value) [instance] :350
...
// public void Flush() [instance] :530
...
// public void Invalidate() [instance] :542
void BatchVertexBuffer::Invalidate()
{
    isDirty = true;
}

// public int get_Position() [instance] :405
int BatchVertexBuffer::Position()
{
    return _position;
}

// public void set_Position(int value) [instance] :406
void BatchVertexBuffer::Position(int value)
{
    _position = value;
}

// public int get_StrideInBytes() [instance] :357
int BatchVertexBuffer::StrideInBytes()
{
    return ::g::Uno::Graphics::VertexAttributeTypeHelpers::GetStrideInBytes(DataType());
}

// public Uno.Graphics.VertexBuffer get_VertexBuffer() [instance] :393
...
// public void Write(byte value) [instance] :427
...
// public void Write(byte2 value) [instance] :433
...
// public void Write(byte4 value) [instance] :439
...
// public void Write(float2 value) [instance] :409
...
// public void Write(float3 value) [instance] :415
...
// public void Write(float4 value) [instance] :421
...
// public void Write(int value) [instance] :505
...
// public void Write(int2 value) [instance] :511
...
// public void Write(int3 value) [instance] :517
...
// public void Write(int4 value) [instance] :523
...
// public void Write(sbyte value) [instance] :445
...
// public void Write(sbyte2 value) [instance] :451
...
// public void Write(sbyte4 value) [instance] :457
...
// public void Write(short value) [instance] :481
...
// public void Write(short2 value) [instance] :487
...
// public void Write(short4 value) [instance] :493
...
// public void Write(uint value) [instance] :499
...
// public void Write(ushort value) [instance] :463
...
// public void Write(ushort2 value) [instance] :469
...
// public void Write(ushort4 value) [instance] :475
...
// public BatchVertexBuffer New(Uno.Graphics.VertexAttributeType type, int maxVertices, bool staticBatch) [static] :362
...
// public BatchVertexBuffer New(Uno.Graphics.VertexAttributeType type, Uno.Buffer data) [static] :369
...
// C:\ProgramData\Uno\Packages\Fuse.Drawing.Batching\0.18.8\$.uno(558)
// -------------------------------------------------------------------
...
// public Entry New(Uno.Content.Models.ModelMesh m, int instanceId) [static] :562
...
// C:\ProgramData\Uno\Packages\Fuse.Drawing.Batching\0.18.8\$.uno(565)
// -------------------------------------------------------------------

// public sealed class MeshBatcher :565
// {
...
// public void AddMesh(Uno.Content.Models.ModelMesh mesh, int instanceId) :593
...
// public int get_BatchCount() :583
void MeshBatcher__get_BatchCount_fn(MeshBatcher* __this, int* __retval)
{
    *__retval = __this->BatchCount();
}

// public Uno.Collections.IEnumerable<Fuse.Drawing.Batching.Batch> get_Batches() :580
void MeshBatcher__get_Batches_fn(MeshBatcher* __this, uObject** __retval)
{
    *__retval = __this->Batches();
}

// private static Uno.Content.Models.ModelMesh CreateFakeIndexBuffer(Uno.Content.Models.ModelMesh m) :747
...
// private int AddEntry(Fuse.Drawing.Batching.Entry e) [instance] :598
...
// public int AddMesh(Uno.Content.Models.ModelMesh mesh) [instance] :588
...
// public void AddMesh(Uno.Content.Models.ModelMesh mesh, int instanceId) [instance] :593
...
// public int get_BatchCount() [instance] :583
int MeshBatcher::BatchCount()
{
    return uPtr(batches)->Length();
}

// public Uno.Collections.IEnumerable<Fuse.Drawing.Batching.Batch> get_Batches() [instance] :580
...
// public Uno.Collections.IEnumerable<Uno.Content.Models.ModelMesh> get_Entries() [instance] :570
...
// public int get_EntryCount() [instance] :574
int MeshBatcher::EntryCount()
{
    return uPtr(entries)->Count();
}

// public void Flush() [instance] :605
...
// private static Uno.Content.Models.ModelMesh CreateFakeIndexBuffer(Uno.Content.Models.ModelMesh m) [static] :747
...
// private static Uno.Content.Models.ModelMesh Mesh(Fuse.Drawing.Batching.Entry entry) [static] :572
::g::Uno::Content::Models::ModelMesh* MeshBatcher::Mesh(::g::Fuse::Drawing::Batching::Entry* entry)
{
    return uPtr(entry)->Mesh;
}

// public MeshBatcher New() [static] :586
