...
// C:\ProgramData\Uno\Packages\Android\0.19.1\Android\java\net\$.uno(6868)
// -----------------------------------------------------------------------
...
::g::Android::java::lang::Object_type* URL_typeof()
{
    ...
    type->fp_equals1 = (void(*)(::g::Android::java::lang::Object*, ::g::Android::java::lang::Object*, bool*))URL__equals1_fn;
    ...
    type->SetFields(5,
        ...
        ::g::Android::Base::Primitives::jmethodID_typeof(), (uintptr_t)&::g::Android::java::net::URL::equals_32566_ID_, uFieldFlagsStatic,
    ...
    type->Reflection.SetFunctions(7,
        new uFunction("_Init", NULL, (void*)URL___Init2_fn, 0, true, uVoid_typeof(), 0),
        new uFunction("equals_IMPL_32566", NULL, (void*)URL__equals_IMPL_32566_fn, 0, true, ::g::Uno::Bool_typeof(), 3, ::g::Uno::Bool_typeof(), ::g::Android::Base::Primitives::ujobject_typeof(), ::g::Android::Base::Wrappers::IJWrapper_typeof()),
        new uFunction("getContent", NULL, (void*)URL__getContent_fn, 0, false, ::g::Android::java::lang::Object_typeof(), 0),
        new uFunction("getContent_IMPL_32569", NULL, (void*)URL__getContent_IMPL_32569_fn, 0, true, ::g::Android::Base::Wrappers::IJWrapper_typeof(), 2, ::g::Uno::Bool_typeof(), ::g::Android::Base::Primitives::ujobject_typeof()),
        new uFunction("hashCode_IMPL_32568", NULL, (void*)URL__hashCode_IMPL_32568_fn, 0, true, ::g::Uno::Int_typeof(), 2, ::g::Uno::Bool_typeof(), ::g::Android::Base::Primitives::ujobject_typeof()),
        new uFunction(".ctor", NULL, (void*)URL__New6_fn, 0, true, URL_typeof(), 1, ::g::Android::java::lang::String_typeof()),
        new uFunction("toString_IMPL_32575", NULL, (void*)URL__toString_IMPL_32575_fn, 0, true, ::g::Android::Base::Wrappers::IJWrapper_typeof(), 2, ::g::Uno::Bool_typeof(), ::g::Android::Base::Primitives::ujobject_typeof()));
    return type;
}
...
// public override sealed bool equals(Android.java.lang.Object arg0) :6993
void URL__equals1_fn(URL* __this, ::g::Android::java::lang::Object* arg0, bool* __retval)
{
    return *__retval = URL::equals_IMPL_32566(__this->_subclassed, __this->_javaObject, (uObject*)arg0), void();
}

// public static extern bool equals_IMPL_32566(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2) :7138
void URL__equals_IMPL_32566_fn(bool* arg0_, jobject* arg1_, uObject* arg2_, bool* __retval)
{
    *__retval = URL::equals_IMPL_32566(*arg0_, *arg1_, arg2_);
}
...
{
    return *__retval = uCast< ::g::Android::java::lang::String*>(URL::toString_IMPL_32575(__this->_subclassed, __this->_javaObject), ::TYPES[3/*Android.java.lang.String*/]), void();
}
...
jmethodID URL::equals_32566_ID_;
...
{
    return uCast< ::g::Android::java::lang::Object*>(URL::getContent_IMPL_32569(_subclassed, _javaObject), ::TYPES[2/*Android.java.lang.Object*/]);
}
...
// public static extern bool equals_IMPL_32566(bool arg0, Android.Base.Primitives.ujobject arg1, Android.Base.Wrappers.IJWrapper arg2) [static] :7138
bool URL::equals_IMPL_32566(bool arg0_, jobject arg1_, uObject* arg2_)
{
    INIT_JNI;
    CLASS_INIT(URL::_javaClass2(),URL::_Init2());
    jobject _obArg2 = ((!arg2_) ? NULL : ::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface(arg2_, ::g::Android::Base::Wrappers::IJWrapper_typeof())));
    bool result;
    CACHE_METHOD(URL::equals_32566_ID(),URL::_javaClass2(),"equals","(Ljava/lang/Object;)Z",GetMethodID,"Id for fallback method java.net.URL.equals could not be cached",62);
    if (arg0_) {
        result = ((bool)U_JNIVAR->CallNonvirtualBooleanMethod(arg1_, URL::_javaClass2(), URL::equals_32566_ID(), _obArg2));
    }
    else
    {
        result = ((bool)U_JNIVAR->CallBooleanMethod(arg1_, URL::equals_32566_ID(), _obArg2));
    }
    ::g::Android::Base::JNI::CheckException1(U_JNIVAR);
    return result;
}
