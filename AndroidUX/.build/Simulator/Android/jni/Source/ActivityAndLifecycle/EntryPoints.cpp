...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/Android_UX/Android_UX");
    jclass entryPointsClass = env->FindClass("com/Android_UX/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/Android_UX/Display");
