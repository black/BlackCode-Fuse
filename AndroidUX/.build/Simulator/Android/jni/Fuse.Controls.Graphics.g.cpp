...
// C:\ProgramData\Uno\Packages\Fuse.Controls\0.18.8\Graphics\$.uno(740)
// --------------------------------------------------------------------
...
// public generated CircleVisual() :740
void CircleVisual__ctor_4_fn(CircleVisual* __this)
{
    __this->ctor_4();
}

// private Fuse.Controls.Circle get_Circle() :742
void CircleVisual__get_Circle_fn(CircleVisual* __this, ::g::Fuse::Controls::Circle** __retval)
{
    *__retval = __this->Circle();
}

// protected override sealed void DrawFill(Fuse.DrawContext dc, Fuse.Drawing.Brush fill) :744
...
// protected override sealed void DrawStroke(Fuse.DrawContext dc, Fuse.Drawing.Stroke stroke) :757
...
// public generated CircleVisual New() :740
void CircleVisual__New1_fn(CircleVisual** __retval)
{
    *__retval = CircleVisual::New1();
}

// protected override sealed void OnHitTest(Fuse.HitTestContext htc) :770
...
// public generated CircleVisual() [instance] :740
void CircleVisual::ctor_4()
{
    ctor_3();
}

// private Fuse.Controls.Circle get_Circle() [instance] :742
::g::Fuse::Controls::Circle* CircleVisual::Circle()
{
    return uCast< ::g::Fuse::Controls::Circle*>(Shape(), ::TYPES[0/*Fuse.Controls.Circle*/]);
}

// public generated CircleVisual New() [static] :740
...
// C:\ProgramData\Uno\Packages\Fuse.Controls\0.18.8\Graphics\$.uno(6)
// ------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Controls\0.18.8\Graphics\$.uno(63)
// -------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Controls\0.18.8\Graphics\$.uno(438)
// --------------------------------------------------------------------

// public sealed class EllipseVisual :438
// {
...
// public generated EllipseVisual() [instance] :438
...
// C:\ProgramData\Uno\Packages\Fuse.Controls\0.18.8\Graphics\$.uno(271)
// --------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Controls\0.18.8\Graphics\$.uno(183)
// --------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Controls\0.18.8\Graphics\$.uno(802)
// --------------------------------------------------------------------

// public sealed class LinearSliderBehavior :802
// {
// static LinearSliderBehavior() :802
...
// private void OnPointerPressed(object sender, Fuse.Input.PointerPressedArgs c) :841
...
// private void OnPointerReleased(object sender, Fuse.Input.PointerReleasedArgs c) :873
...
// protected override sealed void OnRooted(Fuse.Node parentNode) :806
...
// protected override sealed void OnUnrooted(Fuse.Node parentNode) :817
...
// private double PositionToValue(float2 pos) :897
...
// private void UpdateValue(float2 pos) :892
...
// public generated LinearSliderBehavior() [instance] :802
...
// private void OnLostCapture() [instance] :830
...
// private void OnPointerMoved(object sender, Fuse.Input.PointerMovedArgs c) [instance] :857
...
// private void OnPointerPressed(object sender, Fuse.Input.PointerPressedArgs c) [instance] :841
...
// private void OnPointerReleased(object sender, Fuse.Input.PointerReleasedArgs c) [instance] :873
...
// C:\ProgramData\Uno\Packages\Fuse.Controls\0.18.8\Graphics\$.uno(305)
// --------------------------------------------------------------------
...
// public object GetHitPart(float2 localCoords) :373
...
// protected override sealed void SoftDispose() :378
...
// public object GetHitPart(float2 localCoords) [instance] :373
...
// C:\ProgramData\Uno\Packages\Fuse.Controls\0.18.8\Graphics\$.uno(504)
// --------------------------------------------------------------------

// public sealed class PathVisual :504
// {
::g::Fuse::Controls::Graphics::PathShapeVisual_type* PathVisual_typeof()
{
    ...
    type->interface0.fp_FindObjectByName = (void(*)(uObject*, uString*, uDelegate*, uObject**))::g::Fuse::Node__FindObjectByName_fn;
    ::TYPES[54] = ::g::Fuse::Controls::Path_typeof();
    ::TYPES[55] = ::g::Uno::Rect_typeof();
    ::TYPES[27] = ::g::Fuse::Drawing::PathGeometryRenderer_typeof();
...
// public generated PathVisual() :504
void PathVisual__ctor_5_fn(PathVisual* __this)
{
    __this->ctor_5();
}

// protected override sealed float4x4 AlignMatrix(float4x4 b) :606
...
// public generated PathVisual New() :504
void PathVisual__New1_fn(PathVisual** __retval)
{
    *__retval = PathVisual::New1();
}

// protected override sealed float2 OnArrangeMarginBox(float2 position, float2 fillSize, Fuse.SizeFlags fillSet) :570
...
// private Fuse.Controls.Path get_Path() :506
void PathVisual__get_Path_fn(PathVisual* __this, ::g::Fuse::Controls::Path** __retval)
{
    *__retval = __this->Path();
}

// protected override sealed void UpdatePath(Fuse.Drawing.PathGeometryRenderer renderer) :508
...
// public generated PathVisual() [instance] :504
...
// protected float2 GetNaturalContentSize() [instance] :519
...
// private Fuse.Controls.Path get_Path() [instance] :506
::g::Fuse::Controls::Path* PathVisual::Path()
{
    return uCast< ::g::Fuse::Controls::Path*>(Shape(), ::TYPES[54/*Fuse.Controls.Path*/]);
}

// public generated PathVisual New() [static] :504
...
// C:\ProgramData\Uno\Packages\Fuse.Controls\0.18.8\Graphics\$.uno(688)
// --------------------------------------------------------------------

// public sealed class RectangleVisual :688
// {
...
// public generated RectangleVisual() :688
void RectangleVisual__ctor_4_fn(RectangleVisual* __this)
{
    __this->ctor_4();
}

// protected override sealed void DrawFill(Fuse.DrawContext dc, Fuse.Drawing.Brush fill) :692
...
// public generated RectangleVisual New() :688
void RectangleVisual__New1_fn(RectangleVisual** __retval)
{
    *__retval = RectangleVisual::New1();
}

// protected override sealed void OnHitTest(Fuse.HitTestContext htc) :704
...
// private Fuse.Controls.Rectangle get_Rectangle() :690
...
// public generated RectangleVisual() [instance] :688
void RectangleVisual::ctor_4()
{
    ctor_3();
}

// private Fuse.Controls.Rectangle get_Rectangle() [instance] :690
...
// public generated RectangleVisual New() [static] :688
...
// C:\ProgramData\Uno\Packages\Fuse.Controls\0.18.8\Graphics\$.uno(463)
// --------------------------------------------------------------------

// public sealed class RegularPolygonVisual :463
// {
...
// protected override sealed void UpdatePath(Fuse.Drawing.PathGeometryRenderer renderer) :485
...
// public generated RegularPolygonVisual() [instance] :463
void RegularPolygonVisual::ctor_5()
{
    ctor_4();
}

// private float2 get_Offset() [instance] :472
...
// private float get_Radius() [instance] :482
float RegularPolygonVisual::Radius()
{
    return ::g::Uno::Math::Min1(ActualSize().X, ActualSize().Y) * 0.5f;
}

// private Fuse.Controls.RegularPolygon get_RegularPolygon() [instance] :465
...
// public generated RegularPolygonVisual New() [static] :463
...
// C:\ProgramData\Uno\Packages\Fuse.Controls\0.18.8\Graphics\$.uno(640)
// --------------------------------------------------------------------
...
// protected generated ShapeVisual() :640
void ShapeVisual__ctor_3_fn(ShapeVisual* __this)
{
    __this->ctor_3();
}

// protected override void Attach() :653
...
// protected override sealed void Detach() :658
...
// public override float2 GetMarginSize(float2 availableSize, Fuse.SizeFlags flags) :642
...
// protected override sealed void OnDraw(Fuse.DrawContext dc) :663
...
// protected virtual void PrepareDraw(Fuse.DrawContext dc) :680
...
// protected internal Fuse.Controls.Shape get_Shape() :651
void ShapeVisual__get_Shape_fn(ShapeVisual* __this, ::g::Fuse::Controls::Shape** __retval)
{
    *__retval = __this->Shape();
}

// protected generated ShapeVisual() [instance] :640
void ShapeVisual::ctor_3()
{
    ctor_2();
}

// protected internal Fuse.Controls.Shape get_Shape() [instance] :651
...
// C:\ProgramData\Uno\Packages\Fuse.Controls\0.18.8\Graphics\$.uno(384)
// --------------------------------------------------------------------

// public sealed class StarVisual :384
// {
...
// public generated StarVisual() [instance] :384
void StarVisual::ctor_5()
{
    ctor_4();
}

// private float2 get_Offset() [instance] :396
::g::Uno::Float2 StarVisual::Offset()
{
    return (ActualSize().X > ActualSize().Y) ? ::g::Uno::Float2__New2((ActualSize().X * 0.5f) - (ActualSize().Y * 0.5f), 0.0f) : ::g::Uno::Float2__New2(0.0f, (ActualSize().Y * 0.5f) - (ActualSize().X * 0.5f));
}

// private float get_Radius() [instance] :406
float StarVisual::Radius()
{
    return ::g::Uno::Math::Min1(ActualSize().X, ActualSize().Y) * 0.5f;
}

// private float get_SpokeRadius() [instance] :411
float StarVisual::SpokeRadius()
{
    return Radius() * uPtr(Star())->Ratio();
}

// private Fuse.Controls.Star get_Star() [instance] :386
::g::Fuse::Controls::Star* StarVisual::Star()
{
    return uCast< ::g::Fuse::Controls::Star*>(Shape(), ::TYPES[68/*Fuse.Controls.Star*/]);
}

// public generated StarVisual New() [static] :384
...
// C:\ProgramData\Uno\Packages\Fuse.Controls\0.18.8\Graphics\$.uno(1074)
// ---------------------------------------------------------------------

// public abstract class TextVisual :1074
// {
...
// protected generated TextVisual() :1074
void TextVisual__ctor_3_fn(TextVisual* __this)
{
    __this->ctor_3();
}

// protected override void Attach() :1076
...
// protected override void Detach() :1083
...
// protected override sealed void OnHitTest(Fuse.HitTestContext htc) :1106
...
// private void OnTextLayoutPropertyChanged(object sender, Uno.EventArgs args) :1090
...
// private void OnTextRenderPropertyChanged(object sender, Uno.EventArgs args) :1095
...
// private void OnValueChanged(object sender, Uno.UX.ValueChangedArgs<string> args) :1100
...
// protected generated TextVisual() [instance] :1074
void TextVisual::ctor_3()
{
    ctor_2();
}

// private void OnTextLayoutPropertyChanged(object sender, Uno.EventArgs args) [instance] :1090
...
// private void OnTextRenderPropertyChanged(object sender, Uno.EventArgs args) [instance] :1095
...
// private void OnValueChanged(object sender, Uno.UX.ValueChangedArgs<string> args) [instance] :1100
...
// C:\ProgramData\Uno\Packages\Fuse.Controls\0.18.8\Graphics\$.uno(1121)
// ---------------------------------------------------------------------

// public abstract class Visual :1121
// {
...
// public bool IsPointInside(float2 localPoint) :1151
...
// public override Uno.Rect get_LocalRenderBounds() :1158
...
// protected override float2 OnArrangeMarginBox(float2 position, float2 availableSize, Fuse.SizeFlags availSet) :1127
...
// protected override sealed void PrependImplicitTransform(Fuse.FastMatrix m) :1146
...
// protected generated Visual() [instance] :1121
void Visual::ctor_1()
{
    ctor_();
}

// protected generated float2 get_ActualSize() [instance] :1123
::g::Uno::Float2 Visual::ActualSize()
{
    return _ActualSize;
}

// protected generated void set_ActualSize(float2 value) [instance] :1123
void Visual::ActualSize(::g::Uno::Float2 value)
{
    _ActualSize = value;
}

// public bool IsPointInside(float2 localPoint) [instance] :1151
