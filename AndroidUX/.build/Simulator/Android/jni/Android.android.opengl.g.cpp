...
// C:\ProgramData\Uno\Packages\Android\0.19.1\Android\android\opengl\$.uno(28007)
// ------------------------------------------------------------------------------
...
::g::Android::java::lang::Object_type* GLUtils_typeof()
{
    ...
    type->Reflection.SetFunctions(3,
        new uFunction("_Init", NULL, (void*)GLUtils___Init2_fn, 0, true, uVoid_typeof(), 0),
        new uFunction("texImage2D", NULL, (void*)GLUtils__texImage2D_fn, 0, true, uVoid_typeof(), 4, ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof(), ::g::Android::android::graphics::Bitmap_typeof(), ::g::Uno::Int_typeof()),
        new uFunction("texImage2D_IMPL_13332", NULL, (void*)GLUtils__texImage2D_IMPL_13332_fn, 0, true, uVoid_typeof(), 4, ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof(), ::g::Android::Base::Wrappers::IJWrapper_typeof(), ::g::Uno::Int_typeof()));
    return type;
}
