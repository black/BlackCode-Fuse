...
// C:\ProgramData\Uno\Packages\Fuse.Controls\0.18.8\$.uno(428)
// -----------------------------------------------------------
...
uType* SolidRectangle_typeof()
{
    ...
    ::TYPES[16] = ::g::Fuse_Controls_bundle_typeof();
    ::TYPES[17] = ::g::Fuse_Elements_bundle_typeof();
    type->SetFields(0,
...
void SolidRectangle::DrawElement(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Element* element, ::g::Fuse::Drawing::Brush* brush, float opacity)
{
    ...
    if (uIs(brush, ::TYPES[0/*Fuse.Drawing.ImageFill*/]))
    {
        ...
        ::g::Uno::Graphics::Texture2D* Texture_c993343d_13_6_9 = uPtr(uAs< ::g::Fuse::Drawing::ImageFill*>(brush, ::TYPES[0/*Fuse.Drawing.ImageFill*/]))->GetTexture();
        ::g::Fuse::Drawing::ImageFill__DrawParams DP_c993343d_13_5_12 = uPtr(uAs< ::g::Fuse::Drawing::ImageFill*>(brush, ::TYPES[0/*Fuse.Drawing.ImageFill*/]))->GetDrawParams(dc, element->ActualSize());
        ...
        _draw_c993343d.Const(0, Texture_c993343d_13_6_9 == NULL);
        _draw_c993343d.Use();
        _draw_c993343d.Attrib1(1, 2, DrawElement_VertexData_c993343d_7_2_1, 8, 0);
        _draw_c993343d.Uniform12(2, ::g::Fuse::IViewport::ViewProjectionTransform(uInterface(uPtr(dc->Viewport()), ::TYPES[6/*Fuse.IViewport*/])));
        _draw_c993343d.Uniform2(3, uPtr(element)->ActualSize());
        _draw_c993343d.Uniform2(4, DP_c993343d_13_5_12.Origin);
        _draw_c993343d.Uniform2(5, DP_c993343d_13_5_12.Size);
        _draw_c993343d.Uniform2(6, ::g::Uno::Float2__op_Subtraction2((ind1 = DP_c993343d_13_5_12.UVClip, ::g::Uno::Float2__New2(ind1.Z, ind1.W)), (ind2 = DP_c993343d_13_5_12.UVClip, ::g::Uno::Float2__New2(ind2.X, ind2.Y))));
        _draw_c993343d.Uniform2(7, (ind3 = DP_c993343d_13_5_12.UVClip, ::g::Uno::Float2__New2(ind3.X, ind3.Y)));
        ...
        _draw_c993343d.Uniform12(11, (element != NULL) ? ::g::Uno::Matrix::Mul8(LocalTransform_c993343d_4_8_5, element->WorldTransform()) : LocalTransform_c993343d_4_8_5);
        _draw_c993343d.Sampler2(12, Texture_c993343d_13_6_9);
    ...
    else if (uIs(brush, ::TYPES[10/*Fuse.Drawing.SolidColor*/]))
    {
        ...
        _draw_c930343d.BlendSrcRgb(::g::Fuse::Drawing::BlendModeHelpers::GetSrcRgb(uPtr(uAs< ::g::Fuse::Drawing::SolidColor*>(brush, ::TYPES[10/*Fuse.Drawing.SolidColor*/]))->BlendMode()));
        _draw_c930343d.BlendSrcAlpha(::g::Fuse::Drawing::BlendModeHelpers::GetSrcAlpha(uPtr(uAs< ::g::Fuse::Drawing::SolidColor*>(brush, ::TYPES[10/*Fuse.Drawing.SolidColor*/]))->BlendMode()));
        _draw_c930343d.BlendDstRgb(::g::Fuse::Drawing::BlendModeHelpers::GetDstRgb(uPtr(uAs< ::g::Fuse::Drawing::SolidColor*>(brush, ::TYPES[10/*Fuse.Drawing.SolidColor*/]))->BlendMode()));
        _draw_c930343d.BlendDstAlpha(::g::Fuse::Drawing::BlendModeHelpers::GetDstAlpha(uPtr(uAs< ::g::Fuse::Drawing::SolidColor*>(brush, ::TYPES[10/*Fuse.Drawing.SolidColor*/]))->BlendMode()));
        _draw_c930343d.Use();
        _draw_c930343d.Attrib1(0, 2, DrawElement_VertexData_c930343d_7_2_1, 8, 0);
        _draw_c930343d.Uniform12(1, ::g::Fuse::IViewport::ViewProjectionTransform(uInterface(uPtr(dc->Viewport()), ::TYPES[6/*Fuse.IViewport*/])));
        ...
        _draw_c930343d.Uniform12(3, (element != NULL) ? ::g::Uno::Matrix::Mul8(LocalTransform_c930343d_4_8_2, uPtr(element)->WorldTransform()) : LocalTransform_c930343d_4_8_2);
    ...
    else if (uIs(brush, ::TYPES[13/*Fuse.Drawing.StaticSolidColor*/]))
    {
        ...
        _draw_c930343d.DepthTestEnabled(false);
        _draw_c930343d.CullFace(uPtr(dc)->CullFace());
        _draw_c930343d.BlendSrcRgb(DrawElement_BlendSrcRgb_c8ee343d_11_4_10);
        _draw_c930343d.BlendSrcAlpha(DrawElement_BlendSrcAlpha_c8ee343d_11_6_11);
        _draw_c930343d.BlendDstRgb(DrawElement_BlendDstRgb_c8ee343d_11_5_12);
        _draw_c930343d.BlendDstAlpha(DrawElement_BlendDstAlpha_c8ee343d_11_7_13);
        _draw_c930343d.Use();
        ...
        _draw_c930343d.Uniform12(3, (element != NULL) ? ::g::Uno::Matrix::Mul8(LocalTransform_c8ee343d_4_8_2, uPtr(element)->WorldTransform()) : LocalTransform_c8ee343d_4_8_2);
        _draw_c930343d.DrawArrays(6);
    }
}
...
void SolidRectangle::init_DrawCalls()
{
    ...
    _draw_c993343d = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::Fuse_Controls_bundle::SolidRectangle5953675f());
    _draw_c930343d = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::Fuse_Elements_bundle::ElementDraw14d18f42());
