...
adb devices | tail -n +2 | cut -sf 1 | xargs -I {} adb -s {} uninstall com.Android_UX

echo ""
echo "## Installing new version of APK"
adb devices | tail -n +2 | cut -sf 1 | xargs -I {} adb -s {} install -r bin/Android UX-debug.apk
...
adb devices | tail -n +2 | cut -sf 1 | xargs -I {} adb -s {} shell \
    ...
    com.Android_UX/com.Android_UX.Android_UX
