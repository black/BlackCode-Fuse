...
// C:\ProgramData\Uno\Packages\Fuse.Shapes\0.19.3\$.uno(216)
// ---------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Shapes\0.19.3\$.uno(239)
// ---------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Shapes\0.19.3\$.uno(229)
// ---------------------------------------------------------
...
::g::Fuse::Shapes::Shape_type* Rectangle_typeof()
{
    ...
    type->Reflection.SetFields(1,
        new uField("CornerRadiusProperty", 90));
...
Shape_type* Shape_typeof()
{
    ...
    type->Reflection.SetFields(3,
        new uField("FillProperty", 90),
        new uField("SmoothnessProperty", 91),
        new uField("StrokeProperty", 92));
