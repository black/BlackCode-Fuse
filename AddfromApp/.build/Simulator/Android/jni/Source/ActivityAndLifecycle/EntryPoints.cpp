...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/Add_from_App/Add_from_App");
    jclass entryPointsClass = env->FindClass("com/Add_from_App/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/Add_from_App/Display");
