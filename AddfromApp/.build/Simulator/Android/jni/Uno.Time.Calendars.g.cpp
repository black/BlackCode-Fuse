...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Time\Calendars\$.uno(5)
// -----------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Time\Calendars\$.uno(39)
// ------------------------------------------------------------------------------

// internal sealed class GregorianYearMonthDayCalculator :39
// {
// static GregorianYearMonthDayCalculator() :60
...
// internal GregorianYearMonthDayCalculator() :89
void GregorianYearMonthDayCalculator__ctor_1_fn(GregorianYearMonthDayCalculator* __this)
{
    __this->ctor_1();
}

// protected override sealed int CalculateStartOfYearDays(int year) :116
...
// internal override sealed int GetDaysInMonth(int year, int month) :180
...
// internal override sealed Uno.Time.Instant GetInstant(int year, int monthOfYear, int dayOfMonth) :104
...
// protected override sealed int GetMonthOfYear(Uno.Time.Instant instant, int year) :156
...
// internal override sealed long GetStartOfYearInTicks(int year) :95
...
// protected override sealed long GetTicksFromStartOfYearToStartOfMonth(int year, int month) :185
...
// internal override sealed bool IsLeapYear(int year) :141
...
// internal GregorianYearMonthDayCalculator New() :89
...
// internal GregorianYearMonthDayCalculator() [instance] :89
...
// internal GregorianYearMonthDayCalculator New() [static] :89
...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Time\Calendars\$.uno(263)
// -------------------------------------------------------------------------------

// internal static class TimeOfDayCalculator :263
// {
...
// internal static int GetHourOfDay(Uno.Time.Instant instant) :352
...
// internal static int GetHourOfDayFromTickOfDay(long tickOfDay) :368
...
// internal static int GetMillisecondOfSecond(Uno.Time.Instant instant) :322
...
// internal static int GetMillisecondOfSecondFromTickOfDay(long tickOfDay) :385
...
// internal static int GetMinuteOfHour(Uno.Time.Instant instant) :342
...
// internal static int GetMinuteOfHourFromTickOfDay(long tickOfDay) :373
...
// internal static int GetSecondOfMinute(Uno.Time.Instant instant) :332
...
// internal static int GetSecondOfMinuteFromTickOfDay(long tickOfDay) :379
...
// internal static long GetTickOfDay(Uno.Time.Instant instant) :298
...
// internal static long GetTicks(int hourOfDay, int minuteOfHour) :265
...
// internal static long GetTicks(int hourOfDay, int minuteOfHour, int secondOfMinute) :273
...
// internal static long GetTicks(int hourOfDay, int minuteOfHour, int secondOfMinute, int millisecondOfSecond, int tickOfMillisecond) :283
...
// internal static int GetHourOfDay(Uno.Time.Instant instant) [static] :352
...
// internal static int GetHourOfDayFromTickOfDay(long tickOfDay) [static] :368
int TimeOfDayCalculator::GetHourOfDayFromTickOfDay(int64_t tickOfDay)
{
    return (int)(tickOfDay >> 11) / 17578125;
}

// internal static int GetMillisecondOfSecond(Uno.Time.Instant instant) [static] :322
...
// internal static int GetMillisecondOfSecondFromTickOfDay(long tickOfDay) [static] :385
...
// internal static int GetMinuteOfHour(Uno.Time.Instant instant) [static] :342
...
// internal static int GetMinuteOfHourFromTickOfDay(long tickOfDay) [static] :373
...
// internal static int GetSecondOfMinute(Uno.Time.Instant instant) [static] :332
...
// internal static int GetSecondOfMinuteFromTickOfDay(long tickOfDay) [static] :379
...
// internal static long GetTickOfDay(Uno.Time.Instant instant) [static] :298
...
// internal static long GetTicks(int hourOfDay, int minuteOfHour) [static] :265
...
// internal static long GetTicks(int hourOfDay, int minuteOfHour, int secondOfMinute) [static] :273
...
// internal static long GetTicks(int hourOfDay, int minuteOfHour, int secondOfMinute, int millisecondOfSecond, int tickOfMillisecond) [static] :283
...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Time\Calendars\$.uno(402)
// -------------------------------------------------------------------------------

// internal sealed class WeekYearCalculator :402
// {
...
// internal WeekYearCalculator(Uno.Time.Calendars.YearMonthDayCalculator yearMonthDayCalculator, int minDaysInFirstWeek) :407
...
// internal WeekYearCalculator New(Uno.Time.Calendars.YearMonthDayCalculator yearMonthDayCalculator, int minDaysInFirstWeek) :407
...
// internal WeekYearCalculator(Uno.Time.Calendars.YearMonthDayCalculator yearMonthDayCalculator, int minDaysInFirstWeek) [instance] :407
...
// internal WeekYearCalculator New(Uno.Time.Calendars.YearMonthDayCalculator yearMonthDayCalculator, int minDaysInFirstWeek) [static] :407
...
// C:\ProgramData\Uno\Packages\UnoCore\0.20.1\Source\Uno\Time\Calendars\$.uno(506)
// -------------------------------------------------------------------------------

// internal abstract class YearMonthDayCalculator :506
// {
...
// protected YearMonthDayCalculator(int minYear, int maxYear, int monthsInYear, long averageTicksPerYear, long ticksAtStartOfYear1, Uno.Time.Calendars.Era[] eras) :524
...
// protected int GetDayOfMonth(Uno.Time.Instant instant, int year, int month) :638
...
// internal virtual Uno.Time.Instant GetInstant(int year, int monthOfYear, int dayOfMonth) :665
...
// internal int GetMaxMonth(int year) :543
...
// internal int GetMonthOfYear(Uno.Time.Instant instant) :660
...
// internal virtual long GetStartOfYearInTicks(int year) :626
...
// protected long GetTicksInYear(int year) :786
...
// internal int GetYear(Uno.Time.Instant instant) :703
...
// internal long GetYearMonthDayTicks(int year, int month, int dayOfMonth) :673
...
// internal long GetYearMonthTicks(int year, int month) :679
...
// internal int get_MaxYear() :512
void YearMonthDayCalculator__get_MaxYear_fn(YearMonthDayCalculator* __this, int* __retval)
{
    *__retval = __this->MaxYear();
}

// internal int get_MinYear() :509
void YearMonthDayCalculator__get_MinYear_fn(YearMonthDayCalculator* __this, int* __retval)
{
    *__retval = __this->MinYear();
}

// protected YearMonthDayCalculator(int minYear, int maxYear, int monthsInYear, long averageTicksPerYear, long ticksAtStartOfYear1, Uno.Time.Calendars.Era[] eras) [instance] :524
...
// internal Uno.Time.Calendars.Era[] get_Eras() [instance] :522
uArray* YearMonthDayCalculator::Eras()
{
    return _eras;
}

// internal int GetDayOfMonth(Uno.Time.Instant instant) [instance] :631
...
// protected int GetDayOfMonth(Uno.Time.Instant instant, int year, int month) [instance] :638
...
// internal int GetMaxMonth(int year) [instance] :543
int YearMonthDayCalculator::GetMaxMonth(int year)
{
    return _monthsInYear;
}

// internal int GetMonthOfYear(Uno.Time.Instant instant) [instance] :660
...
// protected long GetTicksInYear(int year) [instance] :786
...
// internal int GetYear(Uno.Time.Instant instant) [instance] :703
...
// internal long GetYearMonthDayTicks(int year, int month, int dayOfMonth) [instance] :673
...
// internal long GetYearMonthTicks(int year, int month) [instance] :679
...
// internal int get_MaxYear() [instance] :512
int YearMonthDayCalculator::MaxYear()
{
    return _maxYear;
}

// internal int get_MinYear() [instance] :509
