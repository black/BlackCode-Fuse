// This file was generated based on 'C:\ProgramData\Uno\Packages\Fuse.Elements\0.19.3\Internal\$.uno'.
...
struct SizingContainer : uObject
{
    ...
    ::g::Uno::Float2 ExpandFillSize(::g::Uno::Float2 size, ::g::Uno::Float2 fillSize, int fillSet);
    float PaddingHeight();
    float PaddingWidth();
