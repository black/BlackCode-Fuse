...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.1.7"), 12124)}, "C:\\Users\\Kuro\\Documents\\Fuse\\Add from App\\Add from App.unoproj")
{
