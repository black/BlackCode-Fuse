...
adb devices | tail -n +2 | cut -sf 1 | xargs -I {} adb -s {} uninstall com.Add_from_App

echo ""
echo "## Installing new version of APK"
adb devices | tail -n +2 | cut -sf 1 | xargs -I {} adb -s {} install -r bin/Add from App-debug.apk
...
adb devices | tail -n +2 | cut -sf 1 | xargs -I {} adb -s {} shell \
    ...
    com.Add_from_App/com.Add_from_App.Add_from_App
