...
adb devices | tail -n +2 | cut -sf 1 | xargs -I {} adb -s {} uninstall com.Android_UI

echo ""
echo "## Installing new version of APK"
adb devices | tail -n +2 | cut -sf 1 | xargs -I {} adb -s {} install -r bin/Android UI-debug.apk
...
adb devices | tail -n +2 | cut -sf 1 | xargs -I {} adb -s {} shell \
    ...
    com.Android_UI/com.Android_UI.Android_UI
