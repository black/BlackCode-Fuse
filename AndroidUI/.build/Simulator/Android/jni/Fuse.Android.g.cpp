...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\$.uno(250)
// ----------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\$.uno(1027)
// -----------------------------------------------------------
...
// public BackgroundRender(Fuse.Android.TextRenderer textRenderer, ulong textureVersion, Android.android.text.StaticLayout layout, float4 renderColor, Uno.Recti pixelBounds) :1036
...
// private void DoneCallback() :1051
void TextRenderer__BackgroundRender__DoneCallback_fn(TextRenderer__BackgroundRender* __this)
{
    __this->DoneCallback();
}

// public BackgroundRender New(Fuse.Android.TextRenderer textRenderer, ulong textureVersion, Android.android.text.StaticLayout layout, float4 renderColor, Uno.Recti pixelBounds) :1036
...
// public void UpdateTextureAsync() :1045
...
// public BackgroundRender(Fuse.Android.TextRenderer textRenderer, ulong textureVersion, Android.android.text.StaticLayout layout, float4 renderColor, Uno.Recti pixelBounds) [instance] :1036
...
// private void DoneCallback() [instance] :1051
...
// public void UpdateTextureAsync() [instance] :1045
...
// public BackgroundRender New(Fuse.Android.TextRenderer textRenderer, ulong textureVersion, Android.android.text.StaticLayout layout, float4 renderColor, Uno.Recti pixelBounds) [static] :1036
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\$.uno(176)
// ----------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\$.uno(1085)
// -----------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\.cache\GeneratedCode\$.uno(37)
// ------------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\.cache\GeneratedCode\$.uno(53)
// ------------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\$.uno(193)
// ----------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\$.uno(195)
// ----------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\$.uno(237)
// ----------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\$.uno(283)
// ----------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\.cache\GeneratedCode\$.uno(5)
// -----------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\$.uno(494)
// ----------------------------------------------------------
...
NativeTemplate_type* NativeTemplate_typeof()
{
    ...
    ::STRINGS[4] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Android\\0.18.8\\$.uno");
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\$.uno(685)
// ----------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\$.uno(639)
// ----------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\.cache\GeneratedCode\$.uno(7)
// -----------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\.cache\GeneratedCode\$.uno(14)
// ------------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\.cache\GeneratedCode\$.uno(30)
// ------------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\$.uno(799)
// ----------------------------------------------------------
...
// private Android.android.text.LayoutDLRAlignment TextAlignmentToAndroidLayoutAlignment(Fuse.Elements.TextAlignment textAlignment) :858
...
void TextControlLayout::Measure(::g::Fuse::Controls::TextControl* Control, float wrapWidth)
{
    ...
    ::g::Android::java::lang::String* text = ::g::Android::java::lang::String::op_Implicit1((ind1 = Control->RenderValue(), (ind1 != NULL) ? ind1 : ::STRINGS[9/*""*/]));
    ...
    if ((Control->TextWrapping() == 0) && (desiredWidth > wrapWidth))
    {
        ...
        Layout(::g::Android::android::text::StaticLayout::New8((uObject*)text, 0, uPtr(uPtr(Control)->RenderValue())->Length(), Paint(), layoutWidth, align, 1.0f, 0.0f, false, ::g::Android::android::text::TextUtilsDLRTruncateAt::END(), width));
    }
    else
        Layout(::g::Android::android::text::StaticLayout::New6((uObject*)text, Paint(), width, align, 1.0f, 0.0f, false));
...
// private Android.android.text.LayoutDLRAlignment TextAlignmentToAndroidLayoutAlignment(Fuse.Elements.TextAlignment textAlignment) [instance] :858
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\$.uno(871)
// ----------------------------------------------------------

// public sealed extern class TextRenderer :871
// {
TextRenderer_type* TextRenderer_typeof()
{
    ...
    type->interface1.fp_SoftDispose = (void(*)(uObject*))TextRenderer__Fuse_Resources_ISoftDisposable_SoftDispose_fn;
...
// public TextRenderer() :877
void TextRenderer__ctor_4_fn(TextRenderer* __this)
{
    __this->ctor_4();
}

// protected override sealed void Attach() :887
...
// protected override sealed void Detach() :895
...
// private void DisposeTexture() :966
...
// public override sealed float2 GetMarginSize(float2 fillSize, Fuse.SizeFlags fillSet) :936
...
// public override sealed Uno.Rect get_LocalRenderBounds() :945
...
// private void OnTextLayoutPropertyChanged(object sender, Uno.EventArgs args) :904
...
// private void OnTextRenderPropertyChanged(object sender, Uno.EventArgs args) :910
...
// private void OnValueChanged(object sender, Uno.UX.ValueChangedArgs<string> args) :915
...
// private void PrepareDraw() :974
void TextRenderer__PrepareDraw_fn(TextRenderer* __this)
{
    __this->PrepareDraw();
}

// private void SetTexture(OpenGL.GLTextureHandle newTexture) :957
void TextRenderer__SetTexture_fn(TextRenderer* __this, uint32_t* newTexture)
{
    __this->SetTexture(*newTexture);
}

// private void UpdateLayout(float wrapWidth) :921
void TextRenderer__UpdateLayout1_fn(TextRenderer* __this, float* wrapWidth)
{
    __this->UpdateLayout1(*wrapWidth);
}

// private OpenGL.GLTextureHandle UpdateTexture(Android.android.text.StaticLayout layout, float4 renderColor, Uno.Recti pixelBounds) :1009
...
// public TextRenderer() [instance] :877
...
// private void DisposeTexture() [instance] :966
...
// private void OnBitmapDraw(Fuse.DrawContext dc) [instance] :1063
...
// private void OnTextLayoutPropertyChanged(object sender, Uno.EventArgs args) [instance] :904
...
// private void OnTextRenderPropertyChanged(object sender, Uno.EventArgs args) [instance] :910
void TextRenderer::OnTextRenderPropertyChanged1(uObject* sender, ::g::Uno::EventArgs* args)
{
    _emitNewTexture = true;
}

// private void OnValueChanged(object sender, Uno.UX.ValueChangedArgs<string> args) [instance] :915
...
// private void PrepareDraw() [instance] :974
...
// private void SetTexture(OpenGL.GLTextureHandle newTexture) [instance] :957
...
// private void UpdateLayout(float wrapWidth) [instance] :921
...
// private OpenGL.GLTextureHandle UpdateTexture(Android.android.text.StaticLayout layout, float4 renderColor, Uno.Recti pixelBounds) [instance] :1009
...
// public TextRenderer New() [static] :877
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\$.uno(286)
// ----------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Android\0.18.8\$.uno(1130)
// -----------------------------------------------------------

// internal static extern class TypefaceCache :1130
// {
// static TypefaceCache() :1130
...
// public static Android.android.graphics.Typeface GetTypeface(Fuse.Font font) :1135
...
// private static Android.android.graphics.Typeface GetTypefaceFromBundleFile(Uno.BundleFile file) :1143
...
// private static Android.android.graphics.Typeface GetTypefaceFromFileSource(Uno.UX.FileSource fileSource) :1157
...
// public static Android.android.graphics.Typeface GetTypeface(Fuse.Font font) [static] :1135
...
// private static Android.android.graphics.Typeface GetTypefaceFromBundleFile(Uno.BundleFile file) [static] :1143
...
// private static Android.android.graphics.Typeface GetTypefaceFromFileSource(Uno.UX.FileSource fileSource) [static] :1157
