...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Time\$.uno(8)
// -------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Time\Utilities\$.uno(52)
// ------------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Time\$.uno(307)
// ---------------------------------------------------------------------
...
// public Uno.Time.ZonedDateTime AtStrictly(Uno.Time.LocalDateTime localDateTime) :335
...
// public static Uno.Time.DateTimeZone ForOffset(Uno.Time.Offset offset) :340
...
// public Uno.Time.ZonedDateTime AtStrictly(Uno.Time.LocalDateTime localDateTime) [instance] :335
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Time\Timezones\$.uno(7)
// -----------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Time\$.uno(381)
// ---------------------------------------------------------------------

// public struct Duration :381
// {
// static Duration() :399
...
uStructType* Duration_typeof()
{
    ...
    type->Reflection.SetFunctions(4,
        ...
        new uFunction("FromHours", NULL, (void*)Duration__FromHours_fn, 0, true, Duration_typeof(), 1, ::g::Uno::Long_typeof()),
...
// internal Duration(long ticks) :411
void Duration__ctor__fn(Duration* __this, int64_t* ticks1)
{
    __this->ctor_(*ticks1);
}

// public override sealed bool Equals(object obj) :525
...
// public override sealed int GetHashCode() :520
...
// internal Duration(long ticks) [instance] :411
void Duration::ctor_(int64_t ticks1)
{
    ticks = ticks1;
}

// public bool Equals(Uno.Time.Duration other) [instance] :534
bool Duration::Equals2(Duration other)
{
    return Ticks() == other.Ticks();
}

// public long get_Ticks() [instance] :418
int64_t Duration::Ticks()
{
    return ticks;
}

// public static Uno.Time.Duration FromHours(long hours) [static] :549
...
// public static Uno.Time.Duration FromMilliseconds(long milliseconds) [static] :564
...
// internal Duration New(long ticks) [static] :411
...
// public static operator *(Uno.Time.Duration left, long right) [static] :460
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Time\Timezones\$.uno(49)
// ------------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Time\Utilities\$.uno(69)
// ------------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Time\$.uno(582)
// ---------------------------------------------------------------------
...
// internal static Uno.Time.Instant FromDuration(Uno.Time.Duration duration) :692
void Instant__FromDuration_fn(::g::Uno::Time::Duration* duration, Instant* __retval)
{
    *__retval = Instant__FromDuration(*duration);
}

// public static Uno.Time.Instant FromMillisecondsSinceUnixEpoch(long milliseconds) :687
...
// internal Uno.Time.Instant Minus(Uno.Time.Offset offset) :623
...
// public static operator +(Uno.Time.Instant left, Uno.Time.Duration right) :640
...
// public Uno.Time.Instant Plus(Uno.Time.Duration duration) :603
...
// public Uno.Time.Instant PlusTicks(long ticksToAdd) :593
...
// internal Uno.Time.Instant Minus(Uno.Time.Offset offset) [instance] :623
Instant Instant::Minus2(::g::Uno::Time::Offset offset)
{
    return Instant__New1(_ticks - offset.Ticks());
}

// public Uno.Time.Instant Plus(Uno.Time.Duration duration) [instance] :603
...
// public Uno.Time.Instant PlusTicks(long ticksToAdd) [instance] :593
...
// public static operator >(Uno.Time.Instant left, Uno.Time.Instant right) [static] :675
bool Instant::op_GreaterThan(Instant left, Instant right)
{
    return left.Ticks() > right.Ticks();
}

// public static operator <(Uno.Time.Instant left, Uno.Time.Instant right) [static] :665
bool Instant::op_LessThan(Instant left, Instant right)
{
    return left.Ticks() < right.Ticks();
}

// internal static Uno.Time.Instant FromDuration(Uno.Time.Duration duration) [static] :692
Instant Instant__FromDuration(::g::Uno::Time::Duration duration)
{
    return uDefault<Instant>().Plus(duration);
}

// public static Uno.Time.Instant FromMillisecondsSinceUnixEpoch(long milliseconds) [static] :687
...
// public static operator +(Uno.Time.Instant left, Uno.Time.Duration right) [static] :640
Instant Instant__op_Addition(Instant left, ::g::Uno::Time::Duration right)
{
    return Instant__New1(left.Ticks() + right.Ticks());
}

// public static operator -(Uno.Time.Instant left, Uno.Time.Duration right) [static] :650
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Time\$.uno(787)
// ---------------------------------------------------------------------

// public sealed class LocalDate :787
// {
...
// public LocalDate(int year, int month, int day) :791
void LocalDate__ctor__fn(LocalDate* __this, int* year, int* month, int* day)
{
    __this->ctor_(*year, *month, *day);
}

// public LocalDate(int year, int month, int day, Uno.Time.CalendarSystem calendar) :796
...
// internal LocalDate(Uno.Time.LocalDateTime localTime) [instance] :811
void LocalDate::ctor_4(::g::Uno::Time::LocalDateTime* localTime)
{
    _localTime = localTime;
}

// public int get_Day() [instance] :822
int LocalDate::Day()
{
    return uPtr(_localTime)->Day();
}

// public int get_Month() [instance] :820
int LocalDate::Month()
{
    return uPtr(_localTime)->Month();
}

// public int get_Year() [instance] :818
int LocalDate::Year()
{
    return uPtr(_localTime)->Year();
}

// public LocalDate New(int year, int month, int day) [static] :791
...
// public static operator ==(Uno.Time.LocalDate lhs, Uno.Time.LocalDate rhs) [static] :951
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Time\$.uno(997)
// ---------------------------------------------------------------------
...
// public LocalDateTime(int year, int month, int day, int hour, int minute, int second) :1026
...
// public LocalDateTime(int year, int month, int day, int hour, int minute, int second, int millisecond) :1038
...
// public LocalDateTime(int year, int month, int day, int hour, int minute, int second, int millisecond, int tickWithinMillisecond, Uno.Time.CalendarSystem calendar) :1053
...
// public LocalDateTime(int year, int month, int day, int hour, int minute, int second, Uno.Time.CalendarSystem calendar) :1031
...
// public LocalDateTime(int year, int month, int day, int hour, int minute, Uno.Time.CalendarSystem calendar) :1019
...
// public LocalDateTime New(int year, int month, int day, int hour, int minute, int second) :1026
...
// public LocalDateTime New(int year, int month, int day, int hour, int minute, int second, int millisecond) :1038
...
// public LocalDateTime New(int year, int month, int day, int hour, int minute, Uno.Time.CalendarSystem calendar) :1019
...
// public LocalDateTime(int year, int month, int day, int hour, int minute, int second) [instance] :1026
...
// public LocalDateTime(int year, int month, int day, int hour, int minute, int second, int millisecond) [instance] :1038
...
// public LocalDateTime(int year, int month, int day, int hour, int minute, int second, int millisecond, int tickWithinMillisecond, Uno.Time.CalendarSystem calendar) [instance] :1053
...
// public LocalDateTime(int year, int month, int day, int hour, int minute, int second, Uno.Time.CalendarSystem calendar) [instance] :1031
...
// public LocalDateTime(int year, int month, int day, int hour, int minute, Uno.Time.CalendarSystem calendar) [instance] :1019
...
// public Uno.Time.ZonedDateTime InUtc() [instance] :1290
...
// public int get_Millisecond() [instance] :1099
...
// public LocalDateTime New(int year, int month, int day, int hour, int minute, int second) [static] :1026
...
// public LocalDateTime New(int year, int month, int day, int hour, int minute, int second, int millisecond) [static] :1038
...
// public LocalDateTime New(int year, int month, int day, int hour, int minute, Uno.Time.CalendarSystem calendar) [static] :1019
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Time\$.uno(1315)
// ----------------------------------------------------------------------

// public struct LocalTime :1315
// {
// static LocalTime() :1321
...
// public LocalTime(int hour, int minute, int second) :1336
void LocalTime__ctor_1_fn(LocalTime* __this, int* hour, int* minute, int* second)
{
    __this->ctor_1(*hour, *minute, *second);
}

// public LocalTime(int hour, int minute, int second, int millisecond) :1346
...
// public override sealed bool Equals(object obj) :1499
...
// public override sealed int GetHashCode() :1493
...
// public LocalTime(int hour, int minute, int second) [instance] :1336
...
// public LocalTime(int hour, int minute, int second, int millisecond) [instance] :1346
...
// public LocalTime New(int hour, int minute, int second) [static] :1336
...
// public LocalTime New(int hour, int minute, int second, int millisecond) [static] :1346
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Time\$.uno(1551)
// ----------------------------------------------------------------------
...
// public static Uno.Time.Offset FromTicks(long ticks) :1692
...
// public static Uno.Time.Offset FromTicks(long ticks) [static] :1692
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Time\$.uno(1717)
// ----------------------------------------------------------------------

// public sealed class OffsetDateTime :1717
// {
...
// public OffsetDateTime(Uno.Time.LocalDateTime localDateTime, Uno.Time.Offset offset) :1722
...
// public int get_Day() :1734
void OffsetDateTime__get_Day_fn(OffsetDateTime* __this, int* __retval)
{
    *__retval = __this->Day();
}

// public override sealed bool Equals(object obj) :1793
...
// public bool Equals(Uno.Time.OffsetDateTime other) :1802
void OffsetDateTime__Equals2_fn(OffsetDateTime* __this, OffsetDateTime* other, bool* __retval)
{
    *__retval = __this->Equals2(other);
}

// public override sealed int GetHashCode() :1785
...
// public Uno.Time.Offset get_Offset() :1772
void OffsetDateTime__get_Offset_fn(OffsetDateTime* __this, ::g::Uno::Time::Offset* __retval)
{
    *__retval = __this->Offset();
}

// public static operator ==(Uno.Time.OffsetDateTime left, Uno.Time.OffsetDateTime right) :1812
...
// public int get_Second() :1758
void OffsetDateTime__get_Second_fn(OffsetDateTime* __this, int* __retval)
{
    *__retval = __this->Second();
}

// public override sealed string ToString() :1807
...
// public int get_Year() :1730
void OffsetDateTime__get_Year_fn(OffsetDateTime* __this, int* __retval)
{
    *__retval = __this->Year();
}

// public OffsetDateTime(Uno.Time.LocalDateTime localDateTime, Uno.Time.Offset offset) [instance] :1722
...
// public int get_Day() [instance] :1734
int OffsetDateTime::Day()
{
    return uPtr(_localDateTime)->Day();
}

// public bool Equals(Uno.Time.OffsetDateTime other) [instance] :1802
...
// public static operator ==(Uno.Time.OffsetDateTime left, Uno.Time.OffsetDateTime right) [static] :1812
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Time\Utilities\$.uno(101)
// -------------------------------------------------------------------------------
...
// internal static void CheckArgumentRange(string paramName, long value, long minInclusive, long maxInclusive) :112
...
// internal static void CheckArgumentRange(string paramName, long value, long minInclusive, long maxInclusive) [static] :112
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Time\$.uno(2180)
// ----------------------------------------------------------------------
...
uType* ZonedDateTime_typeof()
{
    ...
    type->Reflection.SetFunctions(17,
        ...
        new uFunction("Minus", NULL, (void*)ZonedDateTime__Minus_fn, 0, false, ZonedDateTime_typeof(), 1, ::g::Uno::Time::Duration_typeof()),
...
// public ZonedDateTime(Uno.Time.LocalDateTime localDateTime, Uno.Time.DateTimeZone zone) :2206
...
// internal ZonedDateTime(Uno.Time.LocalDateTime localDateTime, Uno.Time.Offset offset, Uno.Time.DateTimeZone zone) :2186
...
// public Uno.Time.ZonedDateTime Minus(Uno.Time.Duration duration) :2355
...
// public ZonedDateTime New(Uno.Time.Instant instant, Uno.Time.DateTimeZone zone, Uno.Time.CalendarSystem calendar) :2197
...
// public ZonedDateTime New(Uno.Time.LocalDateTime localDateTime, Uno.Time.DateTimeZone zone) :2206
...
// internal ZonedDateTime New(Uno.Time.LocalDateTime localDateTime, Uno.Time.Offset offset, Uno.Time.DateTimeZone zone) :2186
...
// public static operator -(Uno.Time.ZonedDateTime zonedDateTime, Uno.Time.Duration duration) :2360
...
// public Uno.Time.Instant ToInstant() :2375
...
// public Uno.Time.ZonedDateTime WithZone(Uno.Time.DateTimeZone targetZone) :2276
...
// public ZonedDateTime(Uno.Time.LocalDateTime localDateTime, Uno.Time.DateTimeZone zone) [instance] :2206
...
// internal ZonedDateTime(Uno.Time.LocalDateTime localDateTime, Uno.Time.Offset offset, Uno.Time.DateTimeZone zone) [instance] :2186
...
// public Uno.Time.ZonedDateTime Minus(Uno.Time.Duration duration) [instance] :2355
...
// public Uno.Time.Instant ToInstant() [instance] :2375
::g::Uno::Time::Instant ZonedDateTime::ToInstant()
{
    return uPtr(_localDateTime)->Instant().Minus2(_offset);
}

// public Uno.Time.ZonedDateTime WithZone(Uno.Time.DateTimeZone targetZone) [instance] :2276
...
// public ZonedDateTime New(Uno.Time.Instant instant, Uno.Time.DateTimeZone zone, Uno.Time.CalendarSystem calendar) [static] :2197
...
// public ZonedDateTime New(Uno.Time.LocalDateTime localDateTime, Uno.Time.DateTimeZone zone) [static] :2206
...
// internal ZonedDateTime New(Uno.Time.LocalDateTime localDateTime, Uno.Time.Offset offset, Uno.Time.DateTimeZone zone) [static] :2186
...
// public static operator -(Uno.Time.ZonedDateTime zonedDateTime, Uno.Time.Duration duration) [static] :2360
