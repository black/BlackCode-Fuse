...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Content\Models\$.uno(9)
// -----------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Content\Models\$.uno(77)
// ------------------------------------------------------------------------------
...
// public Uno.Content.Models.ModelNode get_Root() :90
void Model__get_Root_fn(Model* __this, ::g::Uno::Content::Models::ModelNode** __retval)
{
    *__retval = __this->Root();
}

// public Uno.Content.Models.ModelNode get_Root() [instance] :90
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Content\Models\$.uno(219)
// -------------------------------------------------------------------------------
...
// public ModelDrawable(Uno.Content.Models.ModelMesh mesh, [Uno.Content.Models.ModelMaterial optionalMaterial]) :227
...
// public Uno.Content.Models.ModelMesh get_Mesh() :222
void ModelDrawable__get_Mesh_fn(ModelDrawable* __this, ::g::Uno::Content::Models::ModelMesh** __retval)
{
    *__retval = __this->Mesh();
}

// public ModelDrawable New(Uno.Content.Models.ModelMesh mesh, [Uno.Content.Models.ModelMaterial optionalMaterial]) :227
...
// public ModelDrawable(Uno.Content.Models.ModelMesh mesh, [Uno.Content.Models.ModelMaterial optionalMaterial]) [instance] :227
...
// public Uno.Content.Models.ModelMesh get_Mesh() [instance] :222
::g::Uno::Content::Models::ModelMesh* ModelDrawable::Mesh()
{
    return _mesh;
}

// public ModelDrawable New(Uno.Content.Models.ModelMesh mesh, [Uno.Content.Models.ModelMaterial optionalMaterial]) [static] :227
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Content\Models\$.uno(252)
// -------------------------------------------------------------------------------

// public sealed class ModelMaterial :252
// {
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Content\Models\$.uno(606)
// -------------------------------------------------------------------------------

// public sealed class ModelMesh :606
// {
...
// public ModelMesh(string name, Uno.Graphics.PrimitiveType type, Uno.Collections.Dictionary<string, Uno.Content.Models.VertexAttributeArray> vertexAttributes, [Uno.Content.Models.IndexArray indices]) :633
...
// public int get_IndexCount() :643
void ModelMesh__get_IndexCount_fn(ModelMesh* __this, int* __retval)
{
    *__retval = __this->IndexCount();
}

// public Uno.Content.Models.IndexArray get_Indices() :615
void ModelMesh__get_Indices_fn(ModelMesh* __this, ::g::Uno::Content::Models::IndexArray** __retval)
{
    *__retval = __this->Indices();
}

// public string get_Name() :609
void ModelMesh__get_Name_fn(ModelMesh* __this, uString** __retval)
{
    *__retval = __this->Name();
}

// public ModelMesh New(string name, Uno.Graphics.PrimitiveType type, Uno.Collections.Dictionary<string, Uno.Content.Models.VertexAttributeArray> vertexAttributes, [Uno.Content.Models.IndexArray indices]) :633
...
// public Uno.Content.Models.VertexAttributeArray get_Normals() :679
...
// public Uno.Content.Models.VertexAttributeArray get_Positions() :669
...
// public Uno.Graphics.PrimitiveType get_PrimitiveType() :612
void ModelMesh__get_PrimitiveType_fn(ModelMesh* __this, int* __retval)
{
    *__retval = __this->PrimitiveType();
}

// public Uno.Content.Models.VertexAttributeArray get_TexCoords() :674
...
// public Uno.Content.Models.VertexAttributeArray TryGetVertexAttribute(string name) :626
...
// public Uno.Collections.IEnumerable<Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>> get_VertexAttributes() :619
void ModelMesh__get_VertexAttributes_fn(ModelMesh* __this, uObject** __retval)
{
    *__retval = __this->VertexAttributes();
}

// public int get_VertexCount() :648
void ModelMesh__get_VertexCount_fn(ModelMesh* __this, int* __retval)
{
    *__retval = __this->VertexCount();
}

// public ModelMesh(string name, Uno.Graphics.PrimitiveType type, Uno.Collections.Dictionary<string, Uno.Content.Models.VertexAttributeArray> vertexAttributes, [Uno.Content.Models.IndexArray indices]) [instance] :633
...
// public int get_IndexCount() [instance] :643
int ModelMesh::IndexCount()
{
    return (Indices() != NULL) ? uPtr(Indices())->Count() : -1;
}

// public Uno.Content.Models.IndexArray get_Indices() [instance] :615
::g::Uno::Content::Models::IndexArray* ModelMesh::Indices()
{
    return _indices;
}

// public string get_Name() [instance] :609
uString* ModelMesh::Name()
{
    return _name;
}

// public Uno.Content.Models.VertexAttributeArray get_Normals() [instance] :679
::g::Uno::Content::Models::VertexAttributeArray* ModelMesh::Normals()
{
    return TryGetVertexAttribute(::STRINGS[0/*"Normal"*/]);
}

// public Uno.Content.Models.VertexAttributeArray get_Positions() [instance] :669
::g::Uno::Content::Models::VertexAttributeArray* ModelMesh::Positions()
{
    return TryGetVertexAttribute(::STRINGS[1/*"Position"*/]);
}

// public Uno.Graphics.PrimitiveType get_PrimitiveType() [instance] :612
int ModelMesh::PrimitiveType()
{
    return _primitiveType;
}

// public Uno.Content.Models.VertexAttributeArray get_TexCoords() [instance] :674
::g::Uno::Content::Models::VertexAttributeArray* ModelMesh::TexCoords()
{
    return TryGetVertexAttribute(::STRINGS[2/*"TexCoord"*/]);
}

// public Uno.Content.Models.VertexAttributeArray TryGetVertexAttribute(string name) [instance] :626
...
// public Uno.Collections.IEnumerable<Uno.Collections.KeyValuePair<string, Uno.Content.Models.VertexAttributeArray>> get_VertexAttributes() [instance] :619
uObject* ModelMesh::VertexAttributes()
{
    return (uObject*)_vertexAttributes;
}

// public int get_VertexCount() [instance] :648
...
// public ModelMesh New(string name, Uno.Graphics.PrimitiveType type, Uno.Collections.Dictionary<string, Uno.Content.Models.VertexAttributeArray> vertexAttributes, [Uno.Content.Models.IndexArray indices]) [static] :633
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Content\Models\$.uno(116)
// -------------------------------------------------------------------------------
...
// public Uno.Collections.IEnumerable<Uno.Content.Models.ModelNode> get_Children() :140
void ModelNode__get_Children_fn(ModelNode* __this, uObject** __retval)
{
    *__retval = __this->Children();
}

// public Uno.Collections.IEnumerable<Uno.Content.Models.ModelDrawable> get_Drawables() :125
void ModelNode__get_Drawables_fn(ModelNode* __this, uObject** __retval)
{
    *__retval = __this->Drawables();
}

// public Uno.Collections.IEnumerable<Uno.Content.Models.ModelParameter<float4x4>> get_Transforms() :122
void ModelNode__get_Transforms_fn(ModelNode* __this, uObject** __retval)
{
    *__retval = __this->Transforms();
}

// public Uno.Collections.IEnumerable<Uno.Content.Models.ModelNode> get_Children() [instance] :140
uObject* ModelNode::Children()
{
    return (uObject*)_children;
}

// public Uno.Collections.IEnumerable<Uno.Content.Models.ModelDrawable> get_Drawables() [instance] :125
uObject* ModelNode::Drawables()
{
    return (uObject*)_drawables;
}

// public Uno.Collections.IEnumerable<Uno.Content.Models.ModelParameter<float4x4>> get_Transforms() [instance] :122
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Content\Models\$.uno(740)
// -------------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\UnoCore\0.19.6\Source\Uno\Content\Models\$.uno(1488)
// --------------------------------------------------------------------------------

// public sealed class VertexAttributeArray :1488
// {
...
// public byte4 GetByte4Normalized(int index) :1574
...
// public float4 GetFloat4(int index) :1596
...
// public VertexAttributeArray(float3[] data) [instance] :1524
...
// public VertexAttributeArray(float4[] data) [instance] :1529
...
// public VertexAttributeArray(Uno.Graphics.VertexAttributeType type, Uno.Buffer buffer) [instance] :1508
...
// public Uno.Buffer get_Buffer() [instance] :1500
::g::Uno::Buffer* VertexAttributeArray::Buffer()
{
    return _buffer;
}

// public int get_Count() [instance] :1505
...
// public byte4 GetByte4(int index) [instance] :1585
...
// public byte4 GetByte4Normalized(int index) [instance] :1574
...
// public float4 GetFloat4(int index) [instance] :1596
...
// public Uno.Graphics.VertexAttributeType get_Type() [instance] :1495
int VertexAttributeArray::Type()
{
    return _type;
}

// public VertexAttributeArray New(float2[] data) [static] :1519
...
// public VertexAttributeArray New(float3[] data) [static] :1524
...
// public VertexAttributeArray New(float4[] data) [static] :1529
