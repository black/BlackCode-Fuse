...
::g::Fuse::AppBase_type* MainView_typeof()
{
    ...
    ::TYPES[30] = ::g::Android_UI_bundle_typeof();
    ::TYPES[31] = ::g::Fuse::Animations::Animator_typeof();
    ::TYPES[32] = ::g::Fuse::Navigation::WhileNavigationTrigger_typeof();
    ::TYPES[33] = ::g::Fuse::Effects::Effect_typeof();
    ::TYPES[34] = ::g::Fuse::Effects::Blur_typeof();
    ::TYPES[35] = ::g::Fuse::BasicTheme::BasicTheme_typeof();
    type->SetFields(16,
...
void MainView::InitializeUX()
{
    ...
    ::g::Fuse::Controls::Image* temp26 = ::g::Fuse::Controls::Image::New2();
    ::g::Fuse::Controls::BottomBarBackground* temp27 = ::g::Fuse::Controls::BottomBarBackground::New2();
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Children()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[13/*Fuse.Node*/])), temp27);
    ...
    temp13->Duration(0.2);
    temp14->File(::g::Uno::UX::BundleFileSource::New1(::g::Android_UI_bundle::background1546ad6a4()));
    ...
    temp19->File(::g::Uno::UX::BundleFileSource::New1(::g::Android_UI_bundle::background25449d6a4()));
    ...
    temp26->File(::g::Uno::UX::BundleFileSource::New1(::g::Android_UI_bundle::background35528d6a4()));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp26->Effects()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[33/*Fuse.Effects.Effect*/])), blur);
