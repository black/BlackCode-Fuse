...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/Android_UI/Android_UI");
    jclass entryPointsClass = env->FindClass("com/Android_UI/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/Android_UI/Display");
