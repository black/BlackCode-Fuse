...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION_ENUMERATOR__OUTRACKS__A889F281_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION_ENUMERATOR__OUTRACKS__A889F281_H__
...
struct Dictionary2_KeyCollection_Enumerator__Outracks_Simulator_Bytecode_TypeName__Uno_Type;

struct Dictionary2_KeyCollection_Enumerator__Outracks_Simulator_Bytecode_TypeName__Uno_Type__uType : ::uStructType
{
...
struct Dictionary2_KeyCollection_Enumerator__Outracks_Simulator_Bytecode_TypeName__Uno_Type
{
    ...
    void _ObjInit(::app::Uno::Collections::Dictionary__Outracks_Simulator_Bytecode_TypeName__Uno_Type* source) { Dictionary2_KeyCollection_Enumerator__Outracks_Simulator_Bytecode_TypeName__Uno_Type___ObjInit(this, source); }
    void Dispose() { Dictionary2_KeyCollection_Enumerator__Outracks_Simulator_Bytecode_TypeName__Uno_Type__Dispose(this); }
    ::app::Outracks::Simulator::Bytecode::TypeName* Current() { return Dictionary2_KeyCollection_Enumerator__Outracks_Simulator_Bytecode_TypeName__Uno_Type__get_Current(this); }
    bool MoveNext() { return Dictionary2_KeyCollection_Enumerator__Outracks_Simulator_Bytecode_TypeName__Uno_Type__MoveNext(this); }
};
