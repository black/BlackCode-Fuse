...
struct StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Brush : ::app::Fuse::StyleProperty
{
    ...
    ::app::Fuse::Drawing::Brush* Get(::app::Fuse::Shapes::Shape* owner) { return StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Brush__Get(this, owner); }
    ::app::Fuse::Drawing::Brush* DefaultValue() { return StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Brush__get_DefaultValue(this); }
    bool HasValue(::app::Fuse::Shapes::Shape* owner) { return StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Brush__HasValue(this, owner); }
    bool IsEqual(::app::Fuse::Drawing::Brush* value, ::app::Fuse::Drawing::Brush* oldValue) { return StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Brush__IsEqual(this, value, oldValue); }
    ...
    bool Set(::app::Fuse::Shapes::Shape* owner, ::app::Fuse::Drawing::Brush* value) { return StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Brush__Set(this, owner, value); }
    void SetLocalState(::app::Fuse::Shapes::Shape* owner) { StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Brush__SetLocalState(this, owner); }
    bool SetStyle(::app::Fuse::Shapes::Shape* owner, ::app::Fuse::Drawing::Brush* value) { return StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Brush__SetStyle(this, owner, value); }
};
