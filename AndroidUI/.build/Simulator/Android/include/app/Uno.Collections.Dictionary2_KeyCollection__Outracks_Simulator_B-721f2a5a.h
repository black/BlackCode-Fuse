...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION__OUTRACKS_SIMULATOR_B_721F2A5A_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION__OUTRACKS_SIMULATOR_B_721F2A5A_H__
...
namespace app { namespace Uno { namespace Collections { struct Dictionary2_KeyCollection_Enumerator__Outracks_Simulator_Bytecode_TypeName__Outracks_Simulator_Bytecode_TypeName; } } }

namespace app {
namespace Uno {
namespace Collections {

struct Dictionary2_KeyCollection__Outracks_Simulator_Bytecode_TypeName__Outracks_Simulator_Bytecode_TypeName;

struct Dictionary2_KeyCollection__Outracks_Simulator_Bytecode_TypeName__Outracks_Simulator_Bytecode_TypeName__uType : ::uClassType
{
...
struct Dictionary2_KeyCollection__Outracks_Simulator_Bytecode_TypeName__Outracks_Simulator_Bytecode_TypeName : ::uObject
{
    ...
    ::uObject* GetEnumerator_boxed() { return Dictionary2_KeyCollection__Outracks_Simulator_Bytecode_TypeName__Outracks_Simulator_Bytecode_TypeName__GetEnumerator_boxed(this); }
    void _ObjInit(::app::Uno::Collections::Dictionary__Outracks_Simulator_Bytecode_TypeName__Outracks_Simulator_Bytecode_TypeName* source) { Dictionary2_KeyCollection__Outracks_Simulator_Bytecode_TypeName__Outracks_Simulator_Bytecode_TypeName___ObjInit(this, source); }
    int Count() { return Dictionary2_KeyCollection__Outracks_Simulator_Bytecode_TypeName__Outracks_Simulator_Bytecode_TypeName__get_Count(this); }
    ::app::Uno::Collections::Dictionary2_KeyCollection_Enumerator__Outracks_Simulator_Bytecode_TypeName__Outracks_Simulator_Bytecode_TypeName GetEnumerator();
};
...
inline ::app::Uno::Collections::Dictionary2_KeyCollection_Enumerator__Outracks_Simulator_Bytecode_TypeName__Outracks_Simulator_Bytecode_TypeName Dictionary2_KeyCollection__Outracks_Simulator_Bytecode_TypeName__Outracks_Simulator_Bytecode_TypeName::GetEnumerator() { return Dictionary2_KeyCollection__Outracks_Simulator_Bytecode_TypeName__Outracks_Simulator_Bytecode_TypeName__GetEnumerator(this); }
