...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_NAVIGATION_NAVIGATION_GOTO_MODE_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_NAVIGATION_NAVIGATION_GOTO_MODE_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Navigation_NavigationGotoMode; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Navigation_NavigationGotoMode;

struct DataBinding__Fuse_Navigation_NavigationGotoMode__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Navigation_NavigationGotoMode : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Navigation_NavigationGotoMode*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Navigation_NavigationGotoMode* target, ::uString* key) { DataBinding__Fuse_Navigation_NavigationGotoMode___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Navigation_NavigationGotoMode__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Navigation_NavigationGotoMode* Target() { return DataBinding__Fuse_Navigation_NavigationGotoMode__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Navigation_NavigationGotoMode* args) { DataBinding__Fuse_Navigation_NavigationGotoMode__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Navigation_NavigationGotoMode__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Navigation_NavigationGotoMode* value) { DataBinding__Fuse_Navigation_NavigationGotoMode__set_Target(this, value); }
    void SetValue(int value) { DataBinding__Fuse_Navigation_NavigationGotoMode__SetValue(this, value); }
};
