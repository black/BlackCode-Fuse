...
struct ICollection__Fuse_Node
{
    ...
    static void Clear(::uObject* __this) { ((ICollection__Fuse_Node*)uGetInterfacePtr(__this, ICollection__Fuse_Node__typeof()))->__fp_Clear((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeStruct ? sizeof(::uObject) : 0)); }
