...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_GESTURES_EDGE_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_GESTURES_EDGE_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Gestures_Edge; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Gestures_Edge;

struct DataBinding__Fuse_Gestures_Edge__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Gestures_Edge : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Gestures_Edge*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Gestures_Edge* target, ::uString* key) { DataBinding__Fuse_Gestures_Edge___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Gestures_Edge__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Gestures_Edge* Target() { return DataBinding__Fuse_Gestures_Edge__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Gestures_Edge* args) { DataBinding__Fuse_Gestures_Edge__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Gestures_Edge__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Gestures_Edge* value) { DataBinding__Fuse_Gestures_Edge__set_Target(this, value); }
    void SetValue(int value) { DataBinding__Fuse_Gestures_Edge__SetValue(this, value); }
};
