...
struct List__Fuse_Style : ::uObject
{
    ...
    void _ObjInit_1(int capacity) { List__Fuse_Style___ObjInit_1(this, capacity); }
    void Add(::app::Fuse::Style* item) { List__Fuse_Style__Add(this, item); }
    void AddRange(::uObject* items) { List__Fuse_Style__AddRange(this, items); }
    void BoundsCheck(int index) { List__Fuse_Style__BoundsCheck(this, index); }
    void Clear() { List__Fuse_Style__Clear(this); }
    bool Contains(::app::Fuse::Style* item) { return List__Fuse_Style__Contains(this, item); }
    ...
    int IndexOf(::app::Fuse::Style* item) { return List__Fuse_Style__IndexOf(this, item); }
    void Insert(int index, ::app::Fuse::Style* item) { List__Fuse_Style__Insert(this, index, item); }
    ...
    void Sort(::uDelegate* comparer) { List__Fuse_Style__Sort(this, comparer); }
    ::uArray* ToArray() { return List__Fuse_Style__ToArray(this); }
};
