...
struct IEnumerable__Fuse_Elements_Element
{
    ...
    static ::uObject* GetEnumerator(::uObject* __this) { return ((IEnumerable__Fuse_Elements_Element*)uGetInterfacePtr(__this, IEnumerable__Fuse_Elements_Element__typeof()))->__fp_GetEnumerator((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeStruct ? sizeof(::uObject) : 0)); }
};
