...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_TRIGGERS_ACTIONS_TRIGGER_DIRECTION_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_TRIGGERS_ACTIONS_TRIGGER_DIRECTION_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Triggers_Actions_TriggerDirection; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Triggers_Actions_TriggerDirection;

struct DataBinding__Fuse_Triggers_Actions_TriggerDirection__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Triggers_Actions_TriggerDirection : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Triggers_Actions_TriggerDirection*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Triggers_Actions_TriggerDirection* target, ::uString* key) { DataBinding__Fuse_Triggers_Actions_TriggerDirection___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Triggers_Actions_TriggerDirection__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Triggers_Actions_TriggerDirection* Target() { return DataBinding__Fuse_Triggers_Actions_TriggerDirection__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Triggers_Actions_TriggerDirection* args) { DataBinding__Fuse_Triggers_Actions_TriggerDirection__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Triggers_Actions_TriggerDirection__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Triggers_Actions_TriggerDirection* value) { DataBinding__Fuse_Triggers_Actions_TriggerDirection__set_Target(this, value); }
    void SetValue(int value) { DataBinding__Fuse_Triggers_Actions_TriggerDirection__SetValue(this, value); }
};
