...
#ifndef __APP_FUSE_TRIGGERS_ACTIONS_SET__FUSE_DRAWING_BLEND_MODE_H__
#define __APP_FUSE_TRIGGERS_ACTIONS_SET__FUSE_DRAWING_BLEND_MODE_H__
...
struct Set__Fuse_Drawing_BlendMode;

struct Set__Fuse_Drawing_BlendMode__uType : ::app::Fuse::Triggers::Actions::TriggerAction__uType
{
};
...
struct Set__Fuse_Drawing_BlendMode : ::app::Fuse::Triggers::Actions::TriggerAction
{
    bool _updateRestValue;
    int _increment;
    bool _hasIncrement;
    ::uStrong< ::app::Fuse::Internal::Blender__Fuse_Drawing_BlendMode*> _blender;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Drawing_BlendMode*> _Target;
    int _Value;
    ::uStrong< ::uDelegate*> _Expression;

    void _ObjInit_1(::app::Uno::UX::Property__Fuse_Drawing_BlendMode* target) { Set__Fuse_Drawing_BlendMode___ObjInit_1(this, target); }
    ::uDelegate* Expression() { return Set__Fuse_Drawing_BlendMode__get_Expression(this); }
    int Increment() { return Set__Fuse_Drawing_BlendMode__get_Increment(this); }
    ::app::Uno::UX::Property__Fuse_Drawing_BlendMode* Target() { return Set__Fuse_Drawing_BlendMode__get_Target(this); }
    bool UpdateRestValue() { return Set__Fuse_Drawing_BlendMode__get_UpdateRestValue(this); }
    int Value() { return Set__Fuse_Drawing_BlendMode__get_Value(this); }
    void Expression(::uDelegate* value) { Set__Fuse_Drawing_BlendMode__set_Expression(this, value); }
    void Increment(int value) { Set__Fuse_Drawing_BlendMode__set_Increment(this, value); }
    void Target(::app::Uno::UX::Property__Fuse_Drawing_BlendMode* value) { Set__Fuse_Drawing_BlendMode__set_Target(this, value); }
    void UpdateRestValue(bool value) { Set__Fuse_Drawing_BlendMode__set_UpdateRestValue(this, value); }
    void Value(int value) { Set__Fuse_Drawing_BlendMode__set_Value(this, value); }
    void Update(int value) { Set__Fuse_Drawing_BlendMode__Update(this, value); }
};
