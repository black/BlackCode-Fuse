...
#ifndef __APP_FUSE_ANIMATIONS_MIXER_HANDLE__FUSE_NAVIGATION_SWIPE_DIRECTION_H__
#define __APP_FUSE_ANIMATIONS_MIXER_HANDLE__FUSE_NAVIGATION_SWIPE_DIRECTION_H__

#include <app/Fuse.Animations.IMixerHandle__Fuse_Navigation_SwipeDirection.h>
#include <app/Uno.Object.h>
#include <Uno.h>
namespace app { namespace Fuse { namespace Animations { struct MasterBase__Fuse_Navigation_SwipeDirection; } } }

namespace app {
namespace Fuse {
namespace Animations {

struct MixerHandle__Fuse_Navigation_SwipeDirection;

struct MixerHandle__Fuse_Navigation_SwipeDirection__uType : ::uClassType
{
    ::app::Fuse::Animations::IMixerHandle__Fuse_Navigation_SwipeDirection __interface_0;
};
...
struct MixerHandle__Fuse_Navigation_SwipeDirection : ::uObject
{
    int Value;
    float Strength;
    bool _hasValue;
    ::uStrong< ::app::Fuse::Animations::MasterBase__Fuse_Navigation_SwipeDirection*> Master;
    int _MixOp;
    int _Priority;

    void _ObjInit(::app::Fuse::Animations::MasterBase__Fuse_Navigation_SwipeDirection* master, int mode, int priority) { MixerHandle__Fuse_Navigation_SwipeDirection___ObjInit(this, master, mode, priority); }
    bool HasValue() { return MixerHandle__Fuse_Navigation_SwipeDirection__get_HasValue(this); }
    int MixOp() { return MixerHandle__Fuse_Navigation_SwipeDirection__get_MixOp(this); }
    int Priority() { return MixerHandle__Fuse_Navigation_SwipeDirection__get_Priority(this); }
    int RestValue() { return MixerHandle__Fuse_Navigation_SwipeDirection__get_RestValue(this); }
    void Set(int value, float strength) { MixerHandle__Fuse_Navigation_SwipeDirection__Set(this, value, strength); }
    void MixOp(int value) { MixerHandle__Fuse_Navigation_SwipeDirection__set_MixOp(this, value); }
    void Priority(int value) { MixerHandle__Fuse_Navigation_SwipeDirection__set_Priority(this, value); }
    void Unregister() { MixerHandle__Fuse_Navigation_SwipeDirection__Unregister(this); }
};
