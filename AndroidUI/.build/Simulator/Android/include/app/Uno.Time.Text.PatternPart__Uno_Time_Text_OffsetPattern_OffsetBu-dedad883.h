...
#ifndef __APP_UNO_TIME_TEXT_PATTERN_PART__UNO_TIME_TEXT_OFFSET_PATTERN_OFFSET_BU_DEDAD883_H__
#define __APP_UNO_TIME_TEXT_PATTERN_PART__UNO_TIME_TEXT_OFFSET_PATTERN_OFFSET_BU_DEDAD883_H__
...
struct PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__char__uType : ::uClassType
{
    ...
    int(*__fp_Read)(PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__char*, ::uString*, int, ::app::Uno::Time::Text::OffsetPattern_OffsetBucket*);
...
struct PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__char : ::uObject
{
    ...
    ::uDelegate* Setter() { return PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__char__get_Setter(this); }
    ...
    int Read(::uString* line, int position, ::app::Uno::Time::Text::OffsetPattern_OffsetBucket* value) { return (((PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__char__uType*)this->__obj_type)->__fp_Read)(this, line, position, value); }
    void Set(::app::Uno::Time::Text::OffsetPattern_OffsetBucket* bucket, ::uChar val) { PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__char__Set(this, bucket, val); }
    ...
    void Setter(::uDelegate* value) { PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__char__set_Setter(this, value); }
