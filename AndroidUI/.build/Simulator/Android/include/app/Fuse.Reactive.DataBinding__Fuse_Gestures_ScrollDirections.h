...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_GESTURES_SCROLL_DIRECTIONS_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_GESTURES_SCROLL_DIRECTIONS_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Gestures_ScrollDirections; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Gestures_ScrollDirections;

struct DataBinding__Fuse_Gestures_ScrollDirections__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Gestures_ScrollDirections : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Gestures_ScrollDirections*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Gestures_ScrollDirections* target, ::uString* key) { DataBinding__Fuse_Gestures_ScrollDirections___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Gestures_ScrollDirections__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Gestures_ScrollDirections* Target() { return DataBinding__Fuse_Gestures_ScrollDirections__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Gestures_ScrollDirections* args) { DataBinding__Fuse_Gestures_ScrollDirections__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Gestures_ScrollDirections__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Gestures_ScrollDirections* value) { DataBinding__Fuse_Gestures_ScrollDirections__set_Target(this, value); }
    void SetValue(int value) { DataBinding__Fuse_Gestures_ScrollDirections__SetValue(this, value); }
};
