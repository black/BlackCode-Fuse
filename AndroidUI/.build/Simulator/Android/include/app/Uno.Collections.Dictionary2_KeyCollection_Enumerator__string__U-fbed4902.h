...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION_ENUMERATOR__STRING__U_FBED4902_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION_ENUMERATOR__STRING__U_FBED4902_H__
...
struct Dictionary2_KeyCollection_Enumerator__string__Uno_Data_Json_Value;

struct Dictionary2_KeyCollection_Enumerator__string__Uno_Data_Json_Value__uType : ::uStructType
{
...
struct Dictionary2_KeyCollection_Enumerator__string__Uno_Data_Json_Value
{
    ...
    void _ObjInit(::app::Uno::Collections::Dictionary__string__Uno_Data_Json_Value* source) { Dictionary2_KeyCollection_Enumerator__string__Uno_Data_Json_Value___ObjInit(this, source); }
    void Dispose() { Dictionary2_KeyCollection_Enumerator__string__Uno_Data_Json_Value__Dispose(this); }
    ::uString* Current() { return Dictionary2_KeyCollection_Enumerator__string__Uno_Data_Json_Value__get_Current(this); }
    bool MoveNext() { return Dictionary2_KeyCollection_Enumerator__string__Uno_Data_Json_Value__MoveNext(this); }
};
