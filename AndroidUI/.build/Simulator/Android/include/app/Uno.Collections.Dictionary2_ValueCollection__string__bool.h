...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_VALUE_COLLECTION__STRING__BOOL_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_VALUE_COLLECTION__STRING__BOOL_H__

#include <app/Uno.Object.h>
#include <Uno.h>
namespace app { namespace Uno { namespace Collections { struct Dictionary__string__bool; } } }
namespace app { namespace Uno { namespace Collections { struct Dictionary2_ValueCollection_Enumerator__string__bool; } } }

namespace app {
namespace Uno {
namespace Collections {

struct Dictionary2_ValueCollection__string__bool;

struct Dictionary2_ValueCollection__string__bool__uType : ::uClassType
{
};
...
struct Dictionary2_ValueCollection__string__bool : ::uObject
{
    ::uStrong< ::app::Uno::Collections::Dictionary__string__bool*> _source;

    void _ObjInit(::app::Uno::Collections::Dictionary__string__bool* source) { Dictionary2_ValueCollection__string__bool___ObjInit(this, source); }
    int Count() { return Dictionary2_ValueCollection__string__bool__get_Count(this); }
    ::app::Uno::Collections::Dictionary2_ValueCollection_Enumerator__string__bool GetEnumerator();
};
...
inline ::app::Uno::Collections::Dictionary2_ValueCollection_Enumerator__string__bool Dictionary2_ValueCollection__string__bool::GetEnumerator() { return Dictionary2_ValueCollection__string__bool__GetEnumerator(this); }
