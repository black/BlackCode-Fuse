...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_TRIGGERS_TRIGGER_BYPASS_MODE_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_TRIGGERS_TRIGGER_BYPASS_MODE_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Triggers_TriggerBypassMode; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Triggers_TriggerBypassMode;

struct DataBinding__Fuse_Triggers_TriggerBypassMode__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Triggers_TriggerBypassMode : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Triggers_TriggerBypassMode*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Triggers_TriggerBypassMode* target, ::uString* key) { DataBinding__Fuse_Triggers_TriggerBypassMode___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Triggers_TriggerBypassMode__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Triggers_TriggerBypassMode* Target() { return DataBinding__Fuse_Triggers_TriggerBypassMode__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Triggers_TriggerBypassMode* args) { DataBinding__Fuse_Triggers_TriggerBypassMode__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Triggers_TriggerBypassMode__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Triggers_TriggerBypassMode* value) { DataBinding__Fuse_Triggers_TriggerBypassMode__set_Target(this, value); }
    void SetValue(int value) { DataBinding__Fuse_Triggers_TriggerBypassMode__SetValue(this, value); }
};
