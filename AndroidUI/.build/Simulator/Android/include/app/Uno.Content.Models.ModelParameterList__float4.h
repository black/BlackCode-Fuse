...
#ifndef __APP_UNO_CONTENT_MODELS_MODEL_PARAMETER_LIST__FLOAT4_H__
#define __APP_UNO_CONTENT_MODELS_MODEL_PARAMETER_LIST__FLOAT4_H__
...
struct ModelParameterList__float4;

struct ModelParameterList__float4__uType : ::app::Uno::Content::Models::ModelParameter__uType
{
};
...
struct ModelParameterList__float4 : ::app::Uno::Content::Models::ModelParameter
{
    int _itemType;
    ...
    void _ObjInit_1(int itemType, ::uArray* items) { ModelParameterList__float4___ObjInit_1(this, itemType, items); }
    void UpdateAnimInfo() { ModelParameterList__float4__UpdateAnimInfo(this); }
};
