...
struct StyleProperty__Fuse_Elements_Element__float : ::app::Fuse::StyleProperty
{
    ...
    float DefaultValue() { return StyleProperty__Fuse_Elements_Element__float__get_DefaultValue(this); }
    ...
    void SetLocalState(::app::Fuse::Elements::Element* owner) { StyleProperty__Fuse_Elements_Element__float__SetLocalState(this, owner); }
