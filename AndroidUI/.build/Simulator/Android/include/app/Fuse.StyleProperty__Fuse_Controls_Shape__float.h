...
struct StyleProperty__Fuse_Controls_Shape__float : ::app::Fuse::StyleProperty
{
    ...
    float DefaultValue() { return StyleProperty__Fuse_Controls_Shape__float__get_DefaultValue(this); }
    bool HasValue(::app::Fuse::Controls::Shape* owner) { return StyleProperty__Fuse_Controls_Shape__float__HasValue(this, owner); }
    ...
    void SetLocalState(::app::Fuse::Controls::Shape* owner) { StyleProperty__Fuse_Controls_Shape__float__SetLocalState(this, owner); }
    bool SetStyle(::app::Fuse::Controls::Shape* owner, float value) { return StyleProperty__Fuse_Controls_Shape__float__SetStyle(this, owner, value); }
};
