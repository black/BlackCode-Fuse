...
struct StyleProperty__Fuse_Controls_Image__Fuse_Elements_Alignment : ::app::Fuse::StyleProperty
{
    ...
    int DefaultValue() { return StyleProperty__Fuse_Controls_Image__Fuse_Elements_Alignment__get_DefaultValue(this); }
    bool HasValue(::app::Fuse::Controls::Image* owner) { return StyleProperty__Fuse_Controls_Image__Fuse_Elements_Alignment__HasValue(this, owner); }
    ...
    void SetLocalState(::app::Fuse::Controls::Image* owner) { StyleProperty__Fuse_Controls_Image__Fuse_Elements_Alignment__SetLocalState(this, owner); }
    bool SetStyle(::app::Fuse::Controls::Image* owner, int value) { return StyleProperty__Fuse_Controls_Image__Fuse_Elements_Alignment__SetStyle(this, owner, value); }
};
