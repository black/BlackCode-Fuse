...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_TRIGGERS_STATE_TRANSITION_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_TRIGGERS_STATE_TRANSITION_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Triggers_StateTransition; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Triggers_StateTransition;

struct DataBinding__Fuse_Triggers_StateTransition__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Triggers_StateTransition : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Triggers_StateTransition*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Triggers_StateTransition* target, ::uString* key) { DataBinding__Fuse_Triggers_StateTransition___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Triggers_StateTransition__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Triggers_StateTransition* Target() { return DataBinding__Fuse_Triggers_StateTransition__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Triggers_StateTransition* args) { DataBinding__Fuse_Triggers_StateTransition__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Triggers_StateTransition__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Triggers_StateTransition* value) { DataBinding__Fuse_Triggers_StateTransition__set_Target(this, value); }
    void SetValue(int value) { DataBinding__Fuse_Triggers_StateTransition__SetValue(this, value); }
};
