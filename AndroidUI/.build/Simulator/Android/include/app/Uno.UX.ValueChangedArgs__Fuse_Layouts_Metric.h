...
#ifndef __APP_UNO_U_X_VALUE_CHANGED_ARGS__FUSE_LAYOUTS_METRIC_H__
#define __APP_UNO_U_X_VALUE_CHANGED_ARGS__FUSE_LAYOUTS_METRIC_H__
...
struct ValueChangedArgs__Fuse_Layouts_Metric;

struct ValueChangedArgs__Fuse_Layouts_Metric__uType : ::app::Uno::EventArgs__uType
{
};
...
struct ValueChangedArgs__Fuse_Layouts_Metric : ::app::Uno::EventArgs
{
    int _Value;
    ::uStrong< ::uObject*> _Origin;

    void _ObjInit_1(int value, ::uObject* origin) { ValueChangedArgs__Fuse_Layouts_Metric___ObjInit_1(this, value, origin); }
    ::uObject* Origin() { return ValueChangedArgs__Fuse_Layouts_Metric__get_Origin(this); }
    int Value() { return ValueChangedArgs__Fuse_Layouts_Metric__get_Value(this); }
    void Origin(::uObject* value) { ValueChangedArgs__Fuse_Layouts_Metric__set_Origin(this, value); }
    void Value(int value) { ValueChangedArgs__Fuse_Layouts_Metric__set_Value(this, value); }
};
