...
#ifndef __APP_UNO_U_X_VALUE_CHANGED_ARGS__FUSE_NAVIGATION_SNAP_TO_H__
#define __APP_UNO_U_X_VALUE_CHANGED_ARGS__FUSE_NAVIGATION_SNAP_TO_H__
...
struct ValueChangedArgs__Fuse_Navigation_SnapTo;

struct ValueChangedArgs__Fuse_Navigation_SnapTo__uType : ::app::Uno::EventArgs__uType
{
};
...
struct ValueChangedArgs__Fuse_Navigation_SnapTo : ::app::Uno::EventArgs
{
    int _Value;
    ::uStrong< ::uObject*> _Origin;

    void _ObjInit_1(int value, ::uObject* origin) { ValueChangedArgs__Fuse_Navigation_SnapTo___ObjInit_1(this, value, origin); }
    ::uObject* Origin() { return ValueChangedArgs__Fuse_Navigation_SnapTo__get_Origin(this); }
    int Value() { return ValueChangedArgs__Fuse_Navigation_SnapTo__get_Value(this); }
    void Origin(::uObject* value) { ValueChangedArgs__Fuse_Navigation_SnapTo__set_Origin(this, value); }
    void Value(int value) { ValueChangedArgs__Fuse_Navigation_SnapTo__set_Value(this, value); }
};
