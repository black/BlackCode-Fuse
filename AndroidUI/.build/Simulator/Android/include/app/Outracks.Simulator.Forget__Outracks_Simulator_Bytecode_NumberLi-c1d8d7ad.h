...
#ifndef __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_BYTECODE_NUMBER_LI_C1D8D7AD_H__
#define __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_BYTECODE_NUMBER_LI_C1D8D7AD_H__
...
struct Forget__Outracks_Simulator_Bytecode_NumberLiteral__char;

struct Forget__Outracks_Simulator_Bytecode_NumberLiteral__char__uType : ::uClassType
{
};
...
struct Forget__Outracks_Simulator_Bytecode_NumberLiteral__char : ::uObject
{
    ::uChar _result;

    void _ObjInit(::uChar result) { Forget__Outracks_Simulator_Bytecode_NumberLiteral__char___ObjInit(this, result); }
    ::uChar Execute(::app::Outracks::Simulator::Bytecode::NumberLiteral* _) { return Forget__Outracks_Simulator_Bytecode_NumberLiteral__char__Execute(this, _); }
};
