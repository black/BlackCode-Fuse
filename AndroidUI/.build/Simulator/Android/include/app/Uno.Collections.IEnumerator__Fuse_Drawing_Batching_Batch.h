...
struct IEnumerator__Fuse_Drawing_Batching_Batch
{
    ...
    static ::app::Fuse::Drawing::Batching::Batch* Current(::uObject* __this) { return ((IEnumerator__Fuse_Drawing_Batching_Batch*)uGetInterfacePtr(__this, IEnumerator__Fuse_Drawing_Batching_Batch__typeof()))->__fp_get_Current((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeStruct ? sizeof(::uObject) : 0)); }
};
