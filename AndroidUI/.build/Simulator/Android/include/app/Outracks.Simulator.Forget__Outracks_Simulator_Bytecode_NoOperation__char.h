...
#ifndef __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_BYTECODE_NO_OPERATION__CHAR_H__
#define __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_BYTECODE_NO_OPERATION__CHAR_H__
...
struct Forget__Outracks_Simulator_Bytecode_NoOperation__char;

struct Forget__Outracks_Simulator_Bytecode_NoOperation__char__uType : ::uClassType
{
};
...
struct Forget__Outracks_Simulator_Bytecode_NoOperation__char : ::uObject
{
    ::uChar _result;

    void _ObjInit(::uChar result) { Forget__Outracks_Simulator_Bytecode_NoOperation__char___ObjInit(this, result); }
    ::uChar Execute(::app::Outracks::Simulator::Bytecode::NoOperation* _) { return Forget__Outracks_Simulator_Bytecode_NoOperation__char__Execute(this, _); }
};
