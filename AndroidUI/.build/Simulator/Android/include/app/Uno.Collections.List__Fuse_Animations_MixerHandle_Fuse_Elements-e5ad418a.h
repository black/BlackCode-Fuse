...
#ifndef __APP_UNO_COLLECTIONS_LIST__FUSE_ANIMATIONS_MIXER_HANDLE_FUSE_ELEMENTS_E5AD418A_H__
#define __APP_UNO_COLLECTIONS_LIST__FUSE_ANIMATIONS_MIXER_HANDLE_FUSE_ELEMENTS_E5AD418A_H__
...
namespace app { namespace Uno { namespace Collections { struct List1_Enumerator__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment_; } } }

namespace app {
namespace Uno {
namespace Collections {

struct List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment_;

struct List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment___uType : ::uClassType
{
    ::app::Uno::Collections::IEnumerable__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment_ __interface_0;
};
...
struct List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment_ : ::uObject
{
    ::uStrong< ::uArray*> _data;
    int _used;
    int _version;

    ::uObject* GetEnumerator_boxed() { return List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment___GetEnumerator_boxed(this); }
    void _ObjInit() { List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment____ObjInit(this); }
    void _ObjInit_1(int capacity) { List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment____ObjInit_1(this, capacity); }
    void Add(::app::Fuse::Animations::MixerHandle__Fuse_Elements_Alignment* item) { List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment___Add(this, item); }
    void AddRange(::uObject* items) { List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment___AddRange(this, items); }
    void BoundsCheck(int index) { List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment___BoundsCheck(this, index); }
    void Clear() { List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment___Clear(this); }
    bool Contains(::app::Fuse::Animations::MixerHandle__Fuse_Elements_Alignment* item) { return List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment___Contains(this, item); }
    void EnsureCapacity() { List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment___EnsureCapacity(this); }
    int Count() { return List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment___get_Count(this); }
    ::app::Fuse::Animations::MixerHandle__Fuse_Elements_Alignment* Item(int index) { return List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment___get_Item(this, index); }
    ::app::Uno::Collections::List1_Enumerator__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment_ GetEnumerator();
    int IndexOf(::app::Fuse::Animations::MixerHandle__Fuse_Elements_Alignment* item) { return List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment___IndexOf(this, item); }
    void Insert(int index, ::app::Fuse::Animations::MixerHandle__Fuse_Elements_Alignment* item) { List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment___Insert(this, index, item); }
    bool Remove(::app::Fuse::Animations::MixerHandle__Fuse_Elements_Alignment* item) { return List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment___Remove(this, item); }
    void RemoveAt(int index) { List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment___RemoveAt(this, index); }
    void Item(int index, ::app::Fuse::Animations::MixerHandle__Fuse_Elements_Alignment* value) { List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment___set_Item(this, index, value); }
    void Sort(::uDelegate* comparer) { List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment___Sort(this, comparer); }
    ::uArray* ToArray() { return List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment___ToArray(this); }
};

}}}

#include <app/Uno.Collections.List1_Enumerator__Fuse_Animations_MixerHandle_F-2339eeb1.h>

namespace app {
namespace Uno {
namespace Collections {

inline ::app::Uno::Collections::List1_Enumerator__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment_ List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment_::GetEnumerator() { return List__Fuse_Animations_MixerHandle_Fuse_Elements_Alignment___GetEnumerator(this); }
