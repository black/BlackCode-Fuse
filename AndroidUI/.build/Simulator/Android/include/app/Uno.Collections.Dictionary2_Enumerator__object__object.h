...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_ENUMERATOR__OBJECT__OBJECT_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_ENUMERATOR__OBJECT__OBJECT_H__
...
struct Dictionary2_Enumerator__object__object;

struct Dictionary2_Enumerator__object__object__uType : ::uStructType
{
    ::app::Uno::Collections::IEnumerator__Uno_Collections_KeyValuePair_object_object_ __interface_0;
...
struct Dictionary2_Enumerator__object__object
{
    ...
    ::app::Uno::Collections::KeyValuePair__object__object _current;
    int _iterator;
    int _version;

    void _ObjInit(::app::Uno::Collections::Dictionary__object__object* source) { Dictionary2_Enumerator__object__object___ObjInit(this, source); }
    void Dispose() { Dictionary2_Enumerator__object__object__Dispose(this); }
    ::app::Uno::Collections::KeyValuePair__object__object Current() { return Dictionary2_Enumerator__object__object__get_Current(this); }
    bool MoveNext() { return Dictionary2_Enumerator__object__object__MoveNext(this); }
};
