...
#ifndef __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_BYTECODE_IS_TYPE__CHAR_H__
#define __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_BYTECODE_IS_TYPE__CHAR_H__
...
struct Forget__Outracks_Simulator_Bytecode_IsType__char;

struct Forget__Outracks_Simulator_Bytecode_IsType__char__uType : ::uClassType
{
};
...
struct Forget__Outracks_Simulator_Bytecode_IsType__char : ::uObject
{
    ::uChar _result;

    void _ObjInit(::uChar result) { Forget__Outracks_Simulator_Bytecode_IsType__char___ObjInit(this, result); }
    ::uChar Execute(::app::Outracks::Simulator::Bytecode::IsType* _) { return Forget__Outracks_Simulator_Bytecode_IsType__char__Execute(this, _); }
};
