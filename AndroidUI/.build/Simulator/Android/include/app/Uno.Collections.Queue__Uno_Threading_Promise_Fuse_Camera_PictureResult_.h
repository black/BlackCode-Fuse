...
#include <Uno.h>
namespace app { namespace Uno { namespace Collections { struct Queue1_Enumerator__Uno_Threading_Promise_Fuse_Camera_PictureResult_; } } }
...
struct Queue__Uno_Threading_Promise_Fuse_Camera_PictureResult_ : ::uObject
{
    ...
    void _ObjInit() { Queue__Uno_Threading_Promise_Fuse_Camera_PictureResult____ObjInit(this); }
    void _ObjInit_1(int capacity) { Queue__Uno_Threading_Promise_Fuse_Camera_PictureResult____ObjInit_1(this, capacity); }
    void Clear() { Queue__Uno_Threading_Promise_Fuse_Camera_PictureResult___Clear(this); }
    bool Contains(::app::Uno::Threading::Promise__Fuse_Camera_PictureResult* item) { return Queue__Uno_Threading_Promise_Fuse_Camera_PictureResult___Contains(this, item); }
    ...
    ::app::Uno::Collections::Queue1_Enumerator__Uno_Threading_Promise_Fuse_Camera_PictureResult_ GetEnumerator();
    ::app::Uno::Threading::Promise__Fuse_Camera_PictureResult* Peek() { return Queue__Uno_Threading_Promise_Fuse_Camera_PictureResult___Peek(this); }
};
...
inline ::app::Uno::Collections::Queue1_Enumerator__Uno_Threading_Promise_Fuse_Camera_PictureResult_ Queue__Uno_Threading_Promise_Fuse_Camera_PictureResult_::GetEnumerator() { return Queue__Uno_Threading_Promise_Fuse_Camera_PictureResult___GetEnumerator(this); }
