...
struct StyleProperty__Fuse_Controls_Panel__Fuse_Node : ::app::Fuse::StyleProperty
{
    ...
    ::app::Fuse::Node* DefaultValue() { return StyleProperty__Fuse_Controls_Panel__Fuse_Node__get_DefaultValue(this); }
    bool HasValue(::app::Fuse::Controls::Panel* owner) { return StyleProperty__Fuse_Controls_Panel__Fuse_Node__HasValue(this, owner); }
    ...
    void SetLocalState(::app::Fuse::Controls::Panel* owner) { StyleProperty__Fuse_Controls_Panel__Fuse_Node__SetLocalState(this, owner); }
    bool SetStyle(::app::Fuse::Controls::Panel* owner, ::app::Fuse::Node* value) { return StyleProperty__Fuse_Controls_Panel__Fuse_Node__SetStyle(this, owner, value); }
};
