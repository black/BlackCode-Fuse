...
#ifndef __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_PROTOCOL_ERROR__CHAR_H__
#define __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_PROTOCOL_ERROR__CHAR_H__
...
struct Forget__Outracks_Simulator_Protocol_Error__char;

struct Forget__Outracks_Simulator_Protocol_Error__char__uType : ::uClassType
{
};
...
struct Forget__Outracks_Simulator_Protocol_Error__char : ::uObject
{
    ::uChar _result;

    void _ObjInit(::uChar result) { Forget__Outracks_Simulator_Protocol_Error__char___ObjInit(this, result); }
    ::uChar Execute(::app::Outracks::Simulator::Protocol::Error* _) { return Forget__Outracks_Simulator_Protocol_Error__char__Execute(this, _); }
};
