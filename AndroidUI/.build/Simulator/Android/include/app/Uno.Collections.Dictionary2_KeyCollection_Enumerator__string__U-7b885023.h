...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION_ENUMERATOR__STRING__U_7B885023_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION_ENUMERATOR__STRING__U_7B885023_H__
...
struct Dictionary2_KeyCollection_Enumerator__string__Uno_Collections_List_object_;

struct Dictionary2_KeyCollection_Enumerator__string__Uno_Collections_List_object___uType : ::uStructType
{
...
struct Dictionary2_KeyCollection_Enumerator__string__Uno_Collections_List_object_
{
    ...
    void _ObjInit(::app::Uno::Collections::Dictionary__string__Uno_Collections_List_object_* source) { Dictionary2_KeyCollection_Enumerator__string__Uno_Collections_List_object____ObjInit(this, source); }
    void Dispose() { Dictionary2_KeyCollection_Enumerator__string__Uno_Collections_List_object___Dispose(this); }
    ::uString* Current() { return Dictionary2_KeyCollection_Enumerator__string__Uno_Collections_List_object___get_Current(this); }
    bool MoveNext() { return Dictionary2_KeyCollection_Enumerator__string__Uno_Collections_List_object___MoveNext(this); }
};
