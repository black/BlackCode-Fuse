...
struct StyleProperty__Fuse_Controls_Control__Fuse_Drawing_Brush : ::app::Fuse::StyleProperty
{
    ...
    ::app::Fuse::Drawing::Brush* DefaultValue() { return StyleProperty__Fuse_Controls_Control__Fuse_Drawing_Brush__get_DefaultValue(this); }
    ...
    void SetLocalState(::app::Fuse::Controls::Control* owner) { StyleProperty__Fuse_Controls_Control__Fuse_Drawing_Brush__SetLocalState(this, owner); }
    bool SetStyle(::app::Fuse::Controls::Control* owner, ::app::Fuse::Drawing::Brush* value) { return StyleProperty__Fuse_Controls_Control__Fuse_Drawing_Brush__SetStyle(this, owner, value); }
};
