...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_ANIMATIONS_MIX_OP_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_ANIMATIONS_MIX_OP_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Animations_MixOp; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Animations_MixOp;

struct DataBinding__Fuse_Animations_MixOp__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Animations_MixOp : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Animations_MixOp*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Animations_MixOp* target, ::uString* key) { DataBinding__Fuse_Animations_MixOp___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Animations_MixOp__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Animations_MixOp* Target() { return DataBinding__Fuse_Animations_MixOp__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Animations_MixOp* args) { DataBinding__Fuse_Animations_MixOp__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Animations_MixOp__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Animations_MixOp* value) { DataBinding__Fuse_Animations_MixOp__set_Target(this, value); }
    void SetValue(int value) { DataBinding__Fuse_Animations_MixOp__SetValue(this, value); }
};
