...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_DRAWING_SOLID_COLOR_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_DRAWING_SOLID_COLOR_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Drawing_SolidColor; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Drawing_SolidColor;

struct DataBinding__Fuse_Drawing_SolidColor__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Drawing_SolidColor : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Drawing_SolidColor*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Drawing_SolidColor* target, ::uString* key) { DataBinding__Fuse_Drawing_SolidColor___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Drawing_SolidColor__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Drawing_SolidColor* Target() { return DataBinding__Fuse_Drawing_SolidColor__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Drawing_SolidColor* args) { DataBinding__Fuse_Drawing_SolidColor__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Drawing_SolidColor__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Drawing_SolidColor* value) { DataBinding__Fuse_Drawing_SolidColor__set_Target(this, value); }
    void SetValue(::app::Fuse::Drawing::SolidColor* value) { DataBinding__Fuse_Drawing_SolidColor__SetValue(this, value); }
};
