...
#ifndef __APP_UNO_U_X_VALUE_CHANGED_ARGS__FUSE_LAYOUTS_DOCK_H__
#define __APP_UNO_U_X_VALUE_CHANGED_ARGS__FUSE_LAYOUTS_DOCK_H__
...
struct ValueChangedArgs__Fuse_Layouts_Dock;

struct ValueChangedArgs__Fuse_Layouts_Dock__uType : ::app::Uno::EventArgs__uType
{
};
...
struct ValueChangedArgs__Fuse_Layouts_Dock : ::app::Uno::EventArgs
{
    int _Value;
    ::uStrong< ::uObject*> _Origin;

    void _ObjInit_1(int value, ::uObject* origin) { ValueChangedArgs__Fuse_Layouts_Dock___ObjInit_1(this, value, origin); }
    ::uObject* Origin() { return ValueChangedArgs__Fuse_Layouts_Dock__get_Origin(this); }
    int Value() { return ValueChangedArgs__Fuse_Layouts_Dock__get_Value(this); }
    void Origin(::uObject* value) { ValueChangedArgs__Fuse_Layouts_Dock__set_Origin(this, value); }
    void Value(int value) { ValueChangedArgs__Fuse_Layouts_Dock__set_Value(this, value); }
};
