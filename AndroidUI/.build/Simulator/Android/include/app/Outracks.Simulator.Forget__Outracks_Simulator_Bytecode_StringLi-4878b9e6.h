...
#ifndef __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_BYTECODE_STRING_LI_4878B9E6_H__
#define __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_BYTECODE_STRING_LI_4878B9E6_H__
...
struct Forget__Outracks_Simulator_Bytecode_StringLiteral__char;

struct Forget__Outracks_Simulator_Bytecode_StringLiteral__char__uType : ::uClassType
{
};
...
struct Forget__Outracks_Simulator_Bytecode_StringLiteral__char : ::uObject
{
    ::uChar _result;

    void _ObjInit(::uChar result) { Forget__Outracks_Simulator_Bytecode_StringLiteral__char___ObjInit(this, result); }
    ::uChar Execute(::app::Outracks::Simulator::Bytecode::StringLiteral* _) { return Forget__Outracks_Simulator_Bytecode_StringLiteral__char__Execute(this, _); }
};
