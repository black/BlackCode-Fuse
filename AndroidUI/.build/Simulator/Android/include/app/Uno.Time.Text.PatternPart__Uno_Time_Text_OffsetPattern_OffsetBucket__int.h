...
struct PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int__uType : ::uClassType
{
    ...
    int(*__fp_Read)(PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int*, ::uString*, int, ::app::Uno::Time::Text::OffsetPattern_OffsetBucket*);
...
struct PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int : ::uObject
{
    ...
    int SkipNextPartsCountIfThisNotSpecified() { return PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int__get_SkipNextPartsCountIfThisNotSpecified(this); }
    int Read(::uString* line, int position, ::app::Uno::Time::Text::OffsetPattern_OffsetBucket* value) { return (((PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int__uType*)this->__obj_type)->__fp_Read)(this, line, position, value); }
    void Set(::app::Uno::Time::Text::OffsetPattern_OffsetBucket* bucket, int val) { PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int__Set(this, bucket, val); }
    ...
    void SkipNextPartsCountIfThisNotSpecified(int value) { PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int__set_SkipNextPartsCountIfThisNotSpecified(this, value); }
