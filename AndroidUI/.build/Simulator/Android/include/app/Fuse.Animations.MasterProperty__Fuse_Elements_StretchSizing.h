...
#ifndef __APP_FUSE_ANIMATIONS_MASTER_PROPERTY__FUSE_ELEMENTS_STRETCH_SIZING_H__
#define __APP_FUSE_ANIMATIONS_MASTER_PROPERTY__FUSE_ELEMENTS_STRETCH_SIZING_H__
...
struct MasterProperty__Fuse_Elements_StretchSizing;

struct MasterProperty__Fuse_Elements_StretchSizing__uType : ::app::Fuse::Animations::MasterBase__Fuse_Elements_StretchSizing__uType
{
...
struct MasterProperty__Fuse_Elements_StretchSizing : ::app::Fuse::Animations::MasterBase__Fuse_Elements_StretchSizing
{
    ::uStrong< ::app::Uno::UX::Property__Fuse_Elements_StretchSizing*> Property;

    void _ObjInit_1(::app::Uno::UX::Property__Fuse_Elements_StretchSizing* property, ::app::Fuse::Animations::MixerBase* mixerBase) { MasterProperty__Fuse_Elements_StretchSizing___ObjInit_1(this, property, mixerBase); }
    ::uObject* GetPropertyObject() { return MasterProperty__Fuse_Elements_StretchSizing__GetPropertyObject(this); }
};
