...
struct Change__Fuse_Elements_Visibility : ::app::Fuse::Animations::TrackAnimator
{
    ...
    float DegreesX() { return Change__Fuse_Elements_Visibility__get_DegreesX(this); }
    ::app::Uno::Float2 DegreesXY();
    float DegreesY() { return Change__Fuse_Elements_Visibility__get_DegreesY(this); }
    float DegreesZ() { return Change__Fuse_Elements_Visibility__get_DegreesZ(this); }
    ...
    float X() { return Change__Fuse_Elements_Visibility__get_X(this); }
    ::app::Uno::Float2 XY();
    float Y() { return Change__Fuse_Elements_Visibility__get_Y(this); }
    float Z() { return Change__Fuse_Elements_Visibility__get_Z(this); }
    void DegreesX(float value) { Change__Fuse_Elements_Visibility__set_DegreesX(this, value); }
    void DegreesXY(::app::Uno::Float2 value);
    void DegreesY(float value) { Change__Fuse_Elements_Visibility__set_DegreesY(this, value); }
    void DegreesZ(float value) { Change__Fuse_Elements_Visibility__set_DegreesZ(this, value); }
    ...
    void X(float value) { Change__Fuse_Elements_Visibility__set_X(this, value); }
    void XY(::app::Uno::Float2 value);
    void Y(float value) { Change__Fuse_Elements_Visibility__set_Y(this, value); }
    void Z(float value) { Change__Fuse_Elements_Visibility__set_Z(this, value); }
};
...
inline ::app::Uno::Float2 Change__Fuse_Elements_Visibility::DegreesXY() { return Change__Fuse_Elements_Visibility__get_DegreesXY(this); }
inline ::app::Uno::Float2 Change__Fuse_Elements_Visibility::XY() { return Change__Fuse_Elements_Visibility__get_XY(this); }
inline void Change__Fuse_Elements_Visibility::DegreesXY(::app::Uno::Float2 value) { Change__Fuse_Elements_Visibility__set_DegreesXY(this, value); }
inline void Change__Fuse_Elements_Visibility::XY(::app::Uno::Float2 value) { Change__Fuse_Elements_Visibility__set_XY(this, value); }
