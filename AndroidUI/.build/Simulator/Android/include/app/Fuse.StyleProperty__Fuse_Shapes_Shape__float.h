...
struct StyleProperty__Fuse_Shapes_Shape__float : ::app::Fuse::StyleProperty
{
    ...
    float DefaultValue() { return StyleProperty__Fuse_Shapes_Shape__float__get_DefaultValue(this); }
    bool HasValue(::app::Fuse::Shapes::Shape* owner) { return StyleProperty__Fuse_Shapes_Shape__float__HasValue(this, owner); }
    ...
    void SetLocalState(::app::Fuse::Shapes::Shape* owner) { StyleProperty__Fuse_Shapes_Shape__float__SetLocalState(this, owner); }
    bool SetStyle(::app::Fuse::Shapes::Shape* owner, float value) { return StyleProperty__Fuse_Shapes_Shape__float__SetStyle(this, owner, value); }
};
