...
#ifndef __APP_FUSE_ANIMATIONS_CONTINUOUS_TRACK_CHANGE_STATE__FUSE_LAYOUTS_ORIENTATION_H__
#define __APP_FUSE_ANIMATIONS_CONTINUOUS_TRACK_CHANGE_STATE__FUSE_LAYOUTS_ORIENTATION_H__
...
struct ContinuousTrackChangeState__Fuse_Layouts_Orientation;

struct ContinuousTrackChangeState__Fuse_Layouts_Orientation__uType : ::app::Fuse::Animations::TrackAnimatorState__uType
{
};
...
struct ContinuousTrackChangeState__Fuse_Layouts_Orientation : ::app::Fuse::Animations::TrackAnimatorState
{
    ::uStrong< ::uObject*> mixHandle;
    ::uStrong< ::app::Fuse::Animations::Change__Fuse_Layouts_Orientation*> Animator_1;

    void _ObjInit_2(::app::Fuse::Animations::Change__Fuse_Layouts_Orientation* animator, ::app::Fuse::Animations::CreateStateParams* p) { ContinuousTrackChangeState__Fuse_Layouts_Orientation___ObjInit_2(this, animator, p); }
};
