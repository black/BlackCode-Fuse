...
#ifndef __APP_OUTRACKS_SIMULATOR_RUNTIME_UX_PROPERTY__FUSE_ELEMENTS_CACHING_MODE_H__
#define __APP_OUTRACKS_SIMULATOR_RUNTIME_UX_PROPERTY__FUSE_ELEMENTS_CACHING_MODE_H__
...
struct UxProperty__Fuse_Elements_CachingMode;

struct UxProperty__Fuse_Elements_CachingMode__uType : ::app::Uno::UX::Property__Fuse_Elements_CachingMode__uType
{
};
...
struct UxProperty__Fuse_Elements_CachingMode : ::app::Uno::UX::Property__Fuse_Elements_CachingMode
{
    ...
    void _ObjInit_1(::uDelegate* setter, ::uDelegate* getter, ::uDelegate* adder, ::uDelegate* remover) { UxProperty__Fuse_Elements_CachingMode___ObjInit_1(this, setter, getter, adder, remover); }
};
