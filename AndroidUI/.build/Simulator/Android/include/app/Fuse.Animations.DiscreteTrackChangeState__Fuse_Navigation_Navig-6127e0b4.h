...
#ifndef __APP_FUSE_ANIMATIONS_DISCRETE_TRACK_CHANGE_STATE__FUSE_NAVIGATION_NAVIG_6127E0B4_H__
#define __APP_FUSE_ANIMATIONS_DISCRETE_TRACK_CHANGE_STATE__FUSE_NAVIGATION_NAVIG_6127E0B4_H__
...
struct DiscreteTrackChangeState__Fuse_Navigation_NavigationGotoMode;

struct DiscreteTrackChangeState__Fuse_Navigation_NavigationGotoMode__uType : ::app::Fuse::Animations::TrackAnimatorState__uType
{
};
...
struct DiscreteTrackChangeState__Fuse_Navigation_NavigationGotoMode : ::app::Fuse::Animations::TrackAnimatorState
{
    ::uStrong< ::uObject*> mixHandle;
    ::uStrong< ::app::Fuse::Animations::Change__Fuse_Navigation_NavigationGotoMode*> Animator_1;

    void _ObjInit_2(::app::Fuse::Animations::Change__Fuse_Navigation_NavigationGotoMode* animator, ::app::Fuse::Animations::CreateStateParams* p) { DiscreteTrackChangeState__Fuse_Navigation_NavigationGotoMode___ObjInit_2(this, animator, p); }
};
