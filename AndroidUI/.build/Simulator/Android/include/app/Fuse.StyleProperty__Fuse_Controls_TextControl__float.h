...
struct StyleProperty__Fuse_Controls_TextControl__float : ::app::Fuse::StyleProperty
{
    ...
    void _ObjInit_2(float defaultValue, ::uDelegate* changedCallback, ::uDelegate* setter, ::uDelegate* getter) { StyleProperty__Fuse_Controls_TextControl__float___ObjInit_2(this, defaultValue, changedCallback, setter, getter); }
    float Get(::app::Fuse::Controls::TextControl* owner) { return StyleProperty__Fuse_Controls_TextControl__float__Get(this, owner); }
    float DefaultValue() { return StyleProperty__Fuse_Controls_TextControl__float__get_DefaultValue(this); }
    ...
    void SetLocalState(::app::Fuse::Controls::TextControl* owner) { StyleProperty__Fuse_Controls_TextControl__float__SetLocalState(this, owner); }
