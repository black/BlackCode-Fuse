...
#ifndef __APP_FUSE_ANIMATIONS_CONTINUOUS_TRACK_CHANGE_STATE__FUSE_ELEMENTS_ELEMENT_H__
#define __APP_FUSE_ANIMATIONS_CONTINUOUS_TRACK_CHANGE_STATE__FUSE_ELEMENTS_ELEMENT_H__

#include <app/Fuse.Animations.TrackAnimatorState.h>
#include <Uno.h>
namespace app { namespace Fuse { namespace Animations { struct Change__Fuse_Elements_Element; } } }
...
struct ContinuousTrackChangeState__Fuse_Elements_Element;

struct ContinuousTrackChangeState__Fuse_Elements_Element__uType : ::app::Fuse::Animations::TrackAnimatorState__uType
{
};
...
struct ContinuousTrackChangeState__Fuse_Elements_Element : ::app::Fuse::Animations::TrackAnimatorState
{
    ::uStrong< ::uObject*> mixHandle;
    ::uStrong< ::app::Fuse::Animations::Change__Fuse_Elements_Element*> Animator_1;

    void _ObjInit_2(::app::Fuse::Animations::Change__Fuse_Elements_Element* animator, ::app::Fuse::Animations::CreateStateParams* p) { ContinuousTrackChangeState__Fuse_Elements_Element___ObjInit_2(this, animator, p); }
};
