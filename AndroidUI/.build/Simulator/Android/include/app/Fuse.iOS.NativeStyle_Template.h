...
#ifndef __APP_FUSE_I_O_S_NATIVE_STYLE_TEMPLATE_H__
#define __APP_FUSE_I_O_S_NATIVE_STYLE_TEMPLATE_H__
...
namespace app { namespace Fuse { namespace iOS { struct NativeStyle; } } }
...
{
    ::uStrong< ::app::Fuse::iOS::NativeStyle*> __parent;

    void _ObjInit_1(::app::Fuse::iOS::NativeStyle* parent) { NativeStyle_Template___ObjInit_1(this, parent); }
};
