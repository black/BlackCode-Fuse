...
#ifndef __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_PROTOCOL_REIFY__CHAR_H__
#define __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_PROTOCOL_REIFY__CHAR_H__
...
struct Forget__Outracks_Simulator_Protocol_Reify__char;

struct Forget__Outracks_Simulator_Protocol_Reify__char__uType : ::uClassType
{
};
...
struct Forget__Outracks_Simulator_Protocol_Reify__char : ::uObject
{
    ::uChar _result;

    void _ObjInit(::uChar result) { Forget__Outracks_Simulator_Protocol_Reify__char___ObjInit(this, result); }
    ::uChar Execute(::app::Outracks::Simulator::Protocol::Reify* _) { return Forget__Outracks_Simulator_Protocol_Reify__char__Execute(this, _); }
};
