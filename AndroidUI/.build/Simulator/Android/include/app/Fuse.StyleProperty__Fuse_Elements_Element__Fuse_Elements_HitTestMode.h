...
struct StyleProperty__Fuse_Elements_Element__Fuse_Elements_HitTestMode : ::app::Fuse::StyleProperty
{
    ...
    void _ObjInit_2(int defaultValue, ::uDelegate* changedCallback, ::uDelegate* setter, ::uDelegate* getter) { StyleProperty__Fuse_Elements_Element__Fuse_Elements_HitTestMode___ObjInit_2(this, defaultValue, changedCallback, setter, getter); }
    ...
    int DefaultValue() { return StyleProperty__Fuse_Elements_Element__Fuse_Elements_HitTestMode__get_DefaultValue(this); }
    ...
    void SetLocalState(::app::Fuse::Elements::Element* owner) { StyleProperty__Fuse_Elements_Element__Fuse_Elements_HitTestMode__SetLocalState(this, owner); }
