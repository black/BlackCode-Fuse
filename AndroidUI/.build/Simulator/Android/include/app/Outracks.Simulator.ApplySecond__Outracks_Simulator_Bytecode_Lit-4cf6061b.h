...
#ifndef __APP_OUTRACKS_SIMULATOR_APPLY_SECOND__OUTRACKS_SIMULATOR_BYTECODE_LIT_4CF6061B_H__
#define __APP_OUTRACKS_SIMULATOR_APPLY_SECOND__OUTRACKS_SIMULATOR_BYTECODE_LIT_4CF6061B_H__
...
struct ApplySecond__Outracks_Simulator_Bytecode_Literal__Uno_IO_BinaryWriter;

struct ApplySecond__Outracks_Simulator_Bytecode_Literal__Uno_IO_BinaryWriter__uType : ::uClassType
{
};
...
struct ApplySecond__Outracks_Simulator_Bytecode_Literal__Uno_IO_BinaryWriter : ::uObject
{
    ::uStrong< ::uDelegate*> _action;
    ::uStrong< ::app::Uno::IO::BinaryWriter*> _arg2;

    void _ObjInit(::uDelegate* action, ::app::Uno::IO::BinaryWriter* arg2) { ApplySecond__Outracks_Simulator_Bytecode_Literal__Uno_IO_BinaryWriter___ObjInit(this, action, arg2); }
    void Execute(::app::Outracks::Simulator::Bytecode::Literal* arg1) { ApplySecond__Outracks_Simulator_Bytecode_Literal__Uno_IO_BinaryWriter__Execute(this, arg1); }
};
