...
#ifndef __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_BYTECODE_REMOVE_EV_77FFF473_H__
#define __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_BYTECODE_REMOVE_EV_77FFF473_H__
...
struct Forget__Outracks_Simulator_Bytecode_RemoveEventHandler__char;

struct Forget__Outracks_Simulator_Bytecode_RemoveEventHandler__char__uType : ::uClassType
{
};
...
struct Forget__Outracks_Simulator_Bytecode_RemoveEventHandler__char : ::uObject
{
    ::uChar _result;

    void _ObjInit(::uChar result) { Forget__Outracks_Simulator_Bytecode_RemoveEventHandler__char___ObjInit(this, result); }
    ::uChar Execute(::app::Outracks::Simulator::Bytecode::RemoveEventHandler* _) { return Forget__Outracks_Simulator_Bytecode_RemoveEventHandler__char__Execute(this, _); }
};
