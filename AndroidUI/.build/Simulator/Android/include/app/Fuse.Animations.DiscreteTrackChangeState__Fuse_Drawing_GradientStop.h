...
#ifndef __APP_FUSE_ANIMATIONS_DISCRETE_TRACK_CHANGE_STATE__FUSE_DRAWING_GRADIENT_STOP_H__
#define __APP_FUSE_ANIMATIONS_DISCRETE_TRACK_CHANGE_STATE__FUSE_DRAWING_GRADIENT_STOP_H__
...
struct DiscreteTrackChangeState__Fuse_Drawing_GradientStop;

struct DiscreteTrackChangeState__Fuse_Drawing_GradientStop__uType : ::app::Fuse::Animations::TrackAnimatorState__uType
{
};
...
struct DiscreteTrackChangeState__Fuse_Drawing_GradientStop : ::app::Fuse::Animations::TrackAnimatorState
{
    ::uStrong< ::uObject*> mixHandle;
    ::uStrong< ::app::Fuse::Animations::Change__Fuse_Drawing_GradientStop*> Animator_1;

    void _ObjInit_2(::app::Fuse::Animations::Change__Fuse_Drawing_GradientStop* animator, ::app::Fuse::Animations::CreateStateParams* p) { DiscreteTrackChangeState__Fuse_Drawing_GradientStop___ObjInit_2(this, animator, p); }
};
