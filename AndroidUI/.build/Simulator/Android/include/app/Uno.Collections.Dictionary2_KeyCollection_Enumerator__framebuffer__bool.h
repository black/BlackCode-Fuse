...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION_ENUMERATOR__FRAMEBUFFER__BOOL_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION_ENUMERATOR__FRAMEBUFFER__BOOL_H__
...
struct Dictionary2_KeyCollection_Enumerator__framebuffer__bool;

struct Dictionary2_KeyCollection_Enumerator__framebuffer__bool__uType : ::uStructType
{
...
struct Dictionary2_KeyCollection_Enumerator__framebuffer__bool
{
    ...
    void _ObjInit(::app::Uno::Collections::Dictionary__framebuffer__bool* source) { Dictionary2_KeyCollection_Enumerator__framebuffer__bool___ObjInit(this, source); }
    void Dispose() { Dictionary2_KeyCollection_Enumerator__framebuffer__bool__Dispose(this); }
    ::app::Uno::Graphics::Framebuffer* Current() { return Dictionary2_KeyCollection_Enumerator__framebuffer__bool__get_Current(this); }
    bool MoveNext() { return Dictionary2_KeyCollection_Enumerator__framebuffer__bool__MoveNext(this); }
};
