...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_VALUE_COLLECTION__STRING__STRING_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_VALUE_COLLECTION__STRING__STRING_H__
...
namespace app { namespace Uno { namespace Collections { struct Dictionary2_ValueCollection_Enumerator__string__string; } } }

namespace app {
namespace Uno {
namespace Collections {

struct Dictionary2_ValueCollection__string__string;

struct Dictionary2_ValueCollection__string__string__uType : ::uClassType
{
...
struct Dictionary2_ValueCollection__string__string : ::uObject
{
    ::uStrong< ::app::Uno::Collections::Dictionary__string__string*> _source;

    ::uObject* GetEnumerator_boxed() { return Dictionary2_ValueCollection__string__string__GetEnumerator_boxed(this); }
    void _ObjInit(::app::Uno::Collections::Dictionary__string__string* source) { Dictionary2_ValueCollection__string__string___ObjInit(this, source); }
    int Count() { return Dictionary2_ValueCollection__string__string__get_Count(this); }
    ::app::Uno::Collections::Dictionary2_ValueCollection_Enumerator__string__string GetEnumerator();
};
...
inline ::app::Uno::Collections::Dictionary2_ValueCollection_Enumerator__string__string Dictionary2_ValueCollection__string__string::GetEnumerator() { return Dictionary2_ValueCollection__string__string__GetEnumerator(this); }
