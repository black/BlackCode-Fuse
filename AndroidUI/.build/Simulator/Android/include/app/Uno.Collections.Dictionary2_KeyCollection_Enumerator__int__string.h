...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION_ENUMERATOR__INT__STRING_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION_ENUMERATOR__INT__STRING_H__
...
struct Dictionary2_KeyCollection_Enumerator__int__string;

struct Dictionary2_KeyCollection_Enumerator__int__string__uType : ::uStructType
{
...
struct Dictionary2_KeyCollection_Enumerator__int__string
{
    ...
    void _ObjInit(::app::Uno::Collections::Dictionary__int__string* source) { Dictionary2_KeyCollection_Enumerator__int__string___ObjInit(this, source); }
    void Dispose() { Dictionary2_KeyCollection_Enumerator__int__string__Dispose(this); }
    int Current() { return Dictionary2_KeyCollection_Enumerator__int__string__get_Current(this); }
    bool MoveNext() { return Dictionary2_KeyCollection_Enumerator__int__string__MoveNext(this); }
};
