...
#ifndef __APP_UNO_COLLECTIONS_QUEUE1_ENUMERATOR__UNO_ACTION_STRING__H__
#define __APP_UNO_COLLECTIONS_QUEUE1_ENUMERATOR__UNO_ACTION_STRING__H__
...
struct Queue1_Enumerator__Uno_Action_string_;

struct Queue1_Enumerator__Uno_Action_string___uType : ::uStructType
{
...
struct Queue1_Enumerator__Uno_Action_string_
{
    ::uStrong< ::app::Uno::Collections::Queue__Uno_Action_string_*> _source;
    int _version;
    int _index;
    ::uStrong< ::uDelegate*> _current;

    void _ObjInit(::app::Uno::Collections::Queue__Uno_Action_string_* source) { Queue1_Enumerator__Uno_Action_string____ObjInit(this, source); }
    void Dispose() { Queue1_Enumerator__Uno_Action_string___Dispose(this); }
    bool MoveNext() { return Queue1_Enumerator__Uno_Action_string___MoveNext(this); }
};
