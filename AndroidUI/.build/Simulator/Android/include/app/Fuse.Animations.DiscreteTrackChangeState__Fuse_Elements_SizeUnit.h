...
#ifndef __APP_FUSE_ANIMATIONS_DISCRETE_TRACK_CHANGE_STATE__FUSE_ELEMENTS_SIZE_UNIT_H__
#define __APP_FUSE_ANIMATIONS_DISCRETE_TRACK_CHANGE_STATE__FUSE_ELEMENTS_SIZE_UNIT_H__
...
struct DiscreteTrackChangeState__Fuse_Elements_SizeUnit;

struct DiscreteTrackChangeState__Fuse_Elements_SizeUnit__uType : ::app::Fuse::Animations::TrackAnimatorState__uType
{
};
...
struct DiscreteTrackChangeState__Fuse_Elements_SizeUnit : ::app::Fuse::Animations::TrackAnimatorState
{
    ::uStrong< ::uObject*> mixHandle;
    ::uStrong< ::app::Fuse::Animations::Change__Fuse_Elements_SizeUnit*> Animator_1;

    void _ObjInit_2(::app::Fuse::Animations::Change__Fuse_Elements_SizeUnit* animator, ::app::Fuse::Animations::CreateStateParams* p) { DiscreteTrackChangeState__Fuse_Elements_SizeUnit___ObjInit_2(this, animator, p); }
};
