...
#ifndef __APP_FUSE_ANIMATIONS_DISCRETE_TRACK_CHANGE_STATE__FUSE_ELEMENTS_CACHING_MODE_H__
#define __APP_FUSE_ANIMATIONS_DISCRETE_TRACK_CHANGE_STATE__FUSE_ELEMENTS_CACHING_MODE_H__
...
struct DiscreteTrackChangeState__Fuse_Elements_CachingMode;

struct DiscreteTrackChangeState__Fuse_Elements_CachingMode__uType : ::app::Fuse::Animations::TrackAnimatorState__uType
{
};
...
struct DiscreteTrackChangeState__Fuse_Elements_CachingMode : ::app::Fuse::Animations::TrackAnimatorState
{
    ::uStrong< ::uObject*> mixHandle;
    ::uStrong< ::app::Fuse::Animations::Change__Fuse_Elements_CachingMode*> Animator_1;

    void _ObjInit_2(::app::Fuse::Animations::Change__Fuse_Elements_CachingMode* animator, ::app::Fuse::Animations::CreateStateParams* p) { DiscreteTrackChangeState__Fuse_Elements_CachingMode___ObjInit_2(this, animator, p); }
};
