...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_ELEMENTS_TEXT_WRAPPING_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_ELEMENTS_TEXT_WRAPPING_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Elements_TextWrapping; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Elements_TextWrapping;

struct DataBinding__Fuse_Elements_TextWrapping__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Elements_TextWrapping : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Elements_TextWrapping*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Elements_TextWrapping* target, ::uString* key) { DataBinding__Fuse_Elements_TextWrapping___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Elements_TextWrapping__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Elements_TextWrapping* Target() { return DataBinding__Fuse_Elements_TextWrapping__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Elements_TextWrapping* args) { DataBinding__Fuse_Elements_TextWrapping__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Elements_TextWrapping__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Elements_TextWrapping* value) { DataBinding__Fuse_Elements_TextWrapping__set_Target(this, value); }
    void SetValue(int value) { DataBinding__Fuse_Elements_TextWrapping__SetValue(this, value); }
};
