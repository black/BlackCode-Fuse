...
#ifndef __APP_UNO_COLLECTIONS_LIST__FUSE_ANIMATIONS_MIXER_HANDLE_FUSE_TRIGGERS_24B0B685_H__
#define __APP_UNO_COLLECTIONS_LIST__FUSE_ANIMATIONS_MIXER_HANDLE_FUSE_TRIGGERS_24B0B685_H__
...
namespace app { namespace Uno { namespace Collections { struct List1_Enumerator__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection_; } } }

namespace app {
namespace Uno {
namespace Collections {

struct List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection_;

struct List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection___uType : ::uClassType
{
    ::app::Uno::Collections::IEnumerable__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection_ __interface_0;
};
...
struct List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection_ : ::uObject
{
    ::uStrong< ::uArray*> _data;
    int _used;
    int _version;

    ::uObject* GetEnumerator_boxed() { return List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection___GetEnumerator_boxed(this); }
    void _ObjInit() { List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection____ObjInit(this); }
    void _ObjInit_1(int capacity) { List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection____ObjInit_1(this, capacity); }
    void Add(::app::Fuse::Animations::MixerHandle__Fuse_Triggers_Actions_TriggerDirection* item) { List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection___Add(this, item); }
    void AddRange(::uObject* items) { List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection___AddRange(this, items); }
    void BoundsCheck(int index) { List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection___BoundsCheck(this, index); }
    void Clear() { List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection___Clear(this); }
    bool Contains(::app::Fuse::Animations::MixerHandle__Fuse_Triggers_Actions_TriggerDirection* item) { return List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection___Contains(this, item); }
    void EnsureCapacity() { List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection___EnsureCapacity(this); }
    int Count() { return List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection___get_Count(this); }
    ::app::Fuse::Animations::MixerHandle__Fuse_Triggers_Actions_TriggerDirection* Item(int index) { return List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection___get_Item(this, index); }
    ::app::Uno::Collections::List1_Enumerator__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection_ GetEnumerator();
    int IndexOf(::app::Fuse::Animations::MixerHandle__Fuse_Triggers_Actions_TriggerDirection* item) { return List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection___IndexOf(this, item); }
    void Insert(int index, ::app::Fuse::Animations::MixerHandle__Fuse_Triggers_Actions_TriggerDirection* item) { List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection___Insert(this, index, item); }
    bool Remove(::app::Fuse::Animations::MixerHandle__Fuse_Triggers_Actions_TriggerDirection* item) { return List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection___Remove(this, item); }
    void RemoveAt(int index) { List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection___RemoveAt(this, index); }
    void Item(int index, ::app::Fuse::Animations::MixerHandle__Fuse_Triggers_Actions_TriggerDirection* value) { List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection___set_Item(this, index, value); }
    void Sort(::uDelegate* comparer) { List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection___Sort(this, comparer); }
    ::uArray* ToArray() { return List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection___ToArray(this); }
};

}}}

#include <app/Uno.Collections.List1_Enumerator__Fuse_Animations_MixerHandle_F-fff599d4.h>

namespace app {
namespace Uno {
namespace Collections {

inline ::app::Uno::Collections::List1_Enumerator__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection_ List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection_::GetEnumerator() { return List__Fuse_Animations_MixerHandle_Fuse_Triggers_Actions_TriggerDirection___GetEnumerator(this); }
