...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_NAVIGATION_NAVIGATION_EDGE_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_NAVIGATION_NAVIGATION_EDGE_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Navigation_NavigationEdge; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Navigation_NavigationEdge;

struct DataBinding__Fuse_Navigation_NavigationEdge__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Navigation_NavigationEdge : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Navigation_NavigationEdge*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Navigation_NavigationEdge* target, ::uString* key) { DataBinding__Fuse_Navigation_NavigationEdge___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Navigation_NavigationEdge__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Navigation_NavigationEdge* Target() { return DataBinding__Fuse_Navigation_NavigationEdge__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Navigation_NavigationEdge* args) { DataBinding__Fuse_Navigation_NavigationEdge__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Navigation_NavigationEdge__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Navigation_NavigationEdge* value) { DataBinding__Fuse_Navigation_NavigationEdge__set_Target(this, value); }
    void SetValue(int value) { DataBinding__Fuse_Navigation_NavigationEdge__SetValue(this, value); }
};
