...
struct StyleProperty__Fuse_Controls_StackPanel__float : ::app::Fuse::StyleProperty
{
    ...
    void _ObjInit_2(float defaultValue, ::uDelegate* changedCallback, ::uDelegate* setter, ::uDelegate* getter) { StyleProperty__Fuse_Controls_StackPanel__float___ObjInit_2(this, defaultValue, changedCallback, setter, getter); }
    float Get(::app::Fuse::Controls::StackPanel* owner) { return StyleProperty__Fuse_Controls_StackPanel__float__Get(this, owner); }
    float DefaultValue() { return StyleProperty__Fuse_Controls_StackPanel__float__get_DefaultValue(this); }
    bool HasValue(::app::Fuse::Controls::StackPanel* owner) { return StyleProperty__Fuse_Controls_StackPanel__float__HasValue(this, owner); }
    ...
    void SetLocalState(::app::Fuse::Controls::StackPanel* owner) { StyleProperty__Fuse_Controls_StackPanel__float__SetLocalState(this, owner); }
    bool SetStyle(::app::Fuse::Controls::StackPanel* owner, float value) { return StyleProperty__Fuse_Controls_StackPanel__float__SetStyle(this, owner, value); }
};
