...
#ifndef __APP_FUSE_ANIMATIONS_CHANGE__FUSE_ELEMENTS_STRETCH_MODE_H__
#define __APP_FUSE_ANIMATIONS_CHANGE__FUSE_ELEMENTS_STRETCH_MODE_H__

#include <app/Fuse.Animations.TrackAnimator.h>
#include <Uno.h>
namespace app { namespace Fuse { namespace Animations { struct AnimatorState; } } }
namespace app { namespace Fuse { namespace Animations { struct Converter__Fuse_Elements_StretchMode; } } }
...
struct Change__Fuse_Elements_StretchMode;

struct Change__Fuse_Elements_StretchMode__uType : ::app::Fuse::Animations::TrackAnimator__uType
{
};
...
struct Change__Fuse_Elements_StretchMode : ::app::Fuse::Animations::TrackAnimator
{
    ::uStrong< ::app::Fuse::Animations::Converter__Fuse_Elements_StretchMode*> ContinuousConverter;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Elements_StretchMode*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Elements_StretchMode* target) { Change__Fuse_Elements_StretchMode___ObjInit_2(this, target); }
    float DegreesX() { return Change__Fuse_Elements_StretchMode__get_DegreesX(this); }
    ::app::Uno::Float2 DegreesXY();
    float DegreesY() { return Change__Fuse_Elements_StretchMode__get_DegreesY(this); }
    float DegreesZ() { return Change__Fuse_Elements_StretchMode__get_DegreesZ(this); }
    bool IsContinuous() { return Change__Fuse_Elements_StretchMode__get_IsContinuous(this); }
    ::app::Uno::UX::Property__Fuse_Elements_StretchMode* Target() { return Change__Fuse_Elements_StretchMode__get_Target(this); }
    int Value() { return Change__Fuse_Elements_StretchMode__get_Value(this); }
    float X() { return Change__Fuse_Elements_StretchMode__get_X(this); }
    ::app::Uno::Float2 XY();
    float Y() { return Change__Fuse_Elements_StretchMode__get_Y(this); }
    float Z() { return Change__Fuse_Elements_StretchMode__get_Z(this); }
    void DegreesX(float value) { Change__Fuse_Elements_StretchMode__set_DegreesX(this, value); }
    void DegreesXY(::app::Uno::Float2 value);
    void DegreesY(float value) { Change__Fuse_Elements_StretchMode__set_DegreesY(this, value); }
    void DegreesZ(float value) { Change__Fuse_Elements_StretchMode__set_DegreesZ(this, value); }
    void Target(::app::Uno::UX::Property__Fuse_Elements_StretchMode* value) { Change__Fuse_Elements_StretchMode__set_Target(this, value); }
    void Value(int value) { Change__Fuse_Elements_StretchMode__set_Value(this, value); }
    void X(float value) { Change__Fuse_Elements_StretchMode__set_X(this, value); }
    void XY(::app::Uno::Float2 value);
    void Y(float value) { Change__Fuse_Elements_StretchMode__set_Y(this, value); }
    void Z(float value) { Change__Fuse_Elements_StretchMode__set_Z(this, value); }
};
...
inline ::app::Uno::Float2 Change__Fuse_Elements_StretchMode::DegreesXY() { return Change__Fuse_Elements_StretchMode__get_DegreesXY(this); }
inline ::app::Uno::Float2 Change__Fuse_Elements_StretchMode::XY() { return Change__Fuse_Elements_StretchMode__get_XY(this); }
inline void Change__Fuse_Elements_StretchMode::DegreesXY(::app::Uno::Float2 value) { Change__Fuse_Elements_StretchMode__set_DegreesXY(this, value); }
inline void Change__Fuse_Elements_StretchMode::XY(::app::Uno::Float2 value) { Change__Fuse_Elements_StretchMode__set_XY(this, value); }
