...
{
    ::app::Uno::Collections::IEnumerable__Fuse_Elements_ElementAtlas __interface_0;
};
...
struct List__Fuse_Elements_ElementAtlas : ::uObject
{
    ...
    ::uObject* GetEnumerator_boxed() { return List__Fuse_Elements_ElementAtlas__GetEnumerator_boxed(this); }
    void _ObjInit() { List__Fuse_Elements_ElementAtlas___ObjInit(this); }
    void _ObjInit_1(int capacity) { List__Fuse_Elements_ElementAtlas___ObjInit_1(this, capacity); }
    void Add(::app::Fuse::Elements::ElementAtlas* item) { List__Fuse_Elements_ElementAtlas__Add(this, item); }
    void AddRange(::uObject* items) { List__Fuse_Elements_ElementAtlas__AddRange(this, items); }
    ...
    bool Contains(::app::Fuse::Elements::ElementAtlas* item) { return List__Fuse_Elements_ElementAtlas__Contains(this, item); }
    ...
    ::app::Fuse::Elements::ElementAtlas* Item(int index) { return List__Fuse_Elements_ElementAtlas__get_Item(this, index); }
    ::app::Uno::Collections::List1_Enumerator__Fuse_Elements_ElementAtlas GetEnumerator();
    int IndexOf(::app::Fuse::Elements::ElementAtlas* item) { return List__Fuse_Elements_ElementAtlas__IndexOf(this, item); }
    void Insert(int index, ::app::Fuse::Elements::ElementAtlas* item) { List__Fuse_Elements_ElementAtlas__Insert(this, index, item); }
    ...
    void Item(int index, ::app::Fuse::Elements::ElementAtlas* value) { List__Fuse_Elements_ElementAtlas__set_Item(this, index, value); }
    void Sort(::uDelegate* comparer) { List__Fuse_Elements_ElementAtlas__Sort(this, comparer); }
    ::uArray* ToArray() { return List__Fuse_Elements_ElementAtlas__ToArray(this); }
};
