...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_FONT_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_FONT_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Font; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Font;

struct DataBinding__Fuse_Font__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Font : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Font*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Font* target, ::uString* key) { DataBinding__Fuse_Font___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Font__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Font* Target() { return DataBinding__Fuse_Font__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Font* args) { DataBinding__Fuse_Font__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Font__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Font* value) { DataBinding__Fuse_Font__set_Target(this, value); }
    void SetValue(::app::Fuse::Font* value) { DataBinding__Fuse_Font__SetValue(this, value); }
};
