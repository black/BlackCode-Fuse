...
#ifndef __APP_OUTRACKS_SIMULATOR_APPLY_SECOND__OUTRACKS_SIMULATOR_PROTOCOL_REG_E1EB37DD_H__
#define __APP_OUTRACKS_SIMULATOR_APPLY_SECOND__OUTRACKS_SIMULATOR_PROTOCOL_REG_E1EB37DD_H__

#include <app/Uno.Object.h>
#include <Uno.h>
namespace app { namespace Outracks { namespace Simulator { namespace Protocol { struct RegisterName; } } } }
...
struct ApplySecond__Outracks_Simulator_Protocol_RegisterName__Uno_IO_BinaryWriter;

struct ApplySecond__Outracks_Simulator_Protocol_RegisterName__Uno_IO_BinaryWriter__uType : ::uClassType
{
};
...
struct ApplySecond__Outracks_Simulator_Protocol_RegisterName__Uno_IO_BinaryWriter : ::uObject
{
    ::uStrong< ::uDelegate*> _action;
    ::uStrong< ::app::Uno::IO::BinaryWriter*> _arg2;

    void _ObjInit(::uDelegate* action, ::app::Uno::IO::BinaryWriter* arg2) { ApplySecond__Outracks_Simulator_Protocol_RegisterName__Uno_IO_BinaryWriter___ObjInit(this, action, arg2); }
    void Execute(::app::Outracks::Simulator::Protocol::RegisterName* arg1) { ApplySecond__Outracks_Simulator_Protocol_RegisterName__Uno_IO_BinaryWriter__Execute(this, arg1); }
};
