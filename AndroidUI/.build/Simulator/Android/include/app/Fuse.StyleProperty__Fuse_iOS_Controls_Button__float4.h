...
#ifndef __APP_FUSE_STYLE_PROPERTY__FUSE_I_O_S_CONTROLS_BUTTON__FLOAT4_H__
#define __APP_FUSE_STYLE_PROPERTY__FUSE_I_O_S_CONTROLS_BUTTON__FLOAT4_H__

#include <app/Fuse.StyleProperty.h>
#include <app/Uno.Float4.h>
#include <Uno.h>
namespace app { namespace Fuse { namespace iOS { namespace Controls { struct Button; } } } }
...
struct StyleProperty__Fuse_iOS_Controls_Button__float4;

struct StyleProperty__Fuse_iOS_Controls_Button__float4__uType : ::app::Fuse::StyleProperty__uType
{
};
...
struct StyleProperty__Fuse_iOS_Controls_Button__float4 : ::app::Fuse::StyleProperty
{
    ...
    void _ObjInit_1(::app::Uno::Float4 defaultValue, ::uDelegate* changedCallback) { StyleProperty__Fuse_iOS_Controls_Button__float4___ObjInit_1(this, defaultValue, changedCallback); }
    void _ObjInit_2(::app::Uno::Float4 defaultValue, ::uDelegate* changedCallback, ::uDelegate* setter, ::uDelegate* getter) { StyleProperty__Fuse_iOS_Controls_Button__float4___ObjInit_2(this, defaultValue, changedCallback, setter, getter); }
    ::app::Uno::Float4 Get(::app::Fuse::iOS::Controls::Button* owner) { return StyleProperty__Fuse_iOS_Controls_Button__float4__Get(this, owner); }
    ::app::Uno::Float4 DefaultValue() { return StyleProperty__Fuse_iOS_Controls_Button__float4__get_DefaultValue(this); }
    bool HasValue(::app::Fuse::iOS::Controls::Button* owner) { return StyleProperty__Fuse_iOS_Controls_Button__float4__HasValue(this, owner); }
    bool IsEqual(::app::Uno::Float4 value, ::app::Uno::Float4 oldValue) { return StyleProperty__Fuse_iOS_Controls_Button__float4__IsEqual(this, value, oldValue); }
    void OnChanged(::app::Fuse::iOS::Controls::Button* owner) { StyleProperty__Fuse_iOS_Controls_Button__float4__OnChanged(this, owner); }
    bool Reset(::app::Fuse::iOS::Controls::Button* owner) { return StyleProperty__Fuse_iOS_Controls_Button__float4__Reset(this, owner); }
    bool ResetStyle(::app::Fuse::iOS::Controls::Button* owner) { return StyleProperty__Fuse_iOS_Controls_Button__float4__ResetStyle(this, owner); }
    bool Set(::app::Fuse::iOS::Controls::Button* owner, ::app::Uno::Float4 value) { return StyleProperty__Fuse_iOS_Controls_Button__float4__Set(this, owner, value); }
    void SetLocalState(::app::Fuse::iOS::Controls::Button* owner) { StyleProperty__Fuse_iOS_Controls_Button__float4__SetLocalState(this, owner); }
    bool SetStyle(::app::Fuse::iOS::Controls::Button* owner, ::app::Uno::Float4 value) { return StyleProperty__Fuse_iOS_Controls_Button__float4__SetStyle(this, owner, value); }
};
