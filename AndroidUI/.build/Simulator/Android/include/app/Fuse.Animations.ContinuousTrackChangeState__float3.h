...
#ifndef __APP_FUSE_ANIMATIONS_CONTINUOUS_TRACK_CHANGE_STATE__FLOAT3_H__
#define __APP_FUSE_ANIMATIONS_CONTINUOUS_TRACK_CHANGE_STATE__FLOAT3_H__
...
struct ContinuousTrackChangeState__float3;

struct ContinuousTrackChangeState__float3__uType : ::app::Fuse::Animations::TrackAnimatorState__uType
{
};
...
struct ContinuousTrackChangeState__float3 : ::app::Fuse::Animations::TrackAnimatorState
{
    ::uStrong< ::uObject*> mixHandle;
    ::uStrong< ::app::Fuse::Animations::Change__float3*> Animator_1;

    void _ObjInit_2(::app::Fuse::Animations::Change__float3* animator, ::app::Fuse::Animations::CreateStateParams* p) { ContinuousTrackChangeState__float3___ObjInit_2(this, animator, p); }
};
