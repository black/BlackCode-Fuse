...
struct ICollection__Fuse_Behavior
{
    ...
    static void Clear(::uObject* __this) { ((ICollection__Fuse_Behavior*)uGetInterfacePtr(__this, ICollection__Fuse_Behavior__typeof()))->__fp_Clear((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeStruct ? sizeof(::uObject) : 0)); }
