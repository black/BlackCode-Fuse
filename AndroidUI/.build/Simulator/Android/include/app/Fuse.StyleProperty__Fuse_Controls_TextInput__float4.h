...
struct StyleProperty__Fuse_Controls_TextInput__float4 : ::app::Fuse::StyleProperty
{
    ...
    void _ObjInit_2(::app::Uno::Float4 defaultValue, ::uDelegate* changedCallback, ::uDelegate* setter, ::uDelegate* getter) { StyleProperty__Fuse_Controls_TextInput__float4___ObjInit_2(this, defaultValue, changedCallback, setter, getter); }
    ...
    ::app::Uno::Float4 DefaultValue() { return StyleProperty__Fuse_Controls_TextInput__float4__get_DefaultValue(this); }
    ...
    void SetLocalState(::app::Fuse::Controls::TextInput* owner) { StyleProperty__Fuse_Controls_TextInput__float4__SetLocalState(this, owner); }
    bool SetStyle(::app::Fuse::Controls::TextInput* owner, ::app::Uno::Float4 value) { return StyleProperty__Fuse_Controls_TextInput__float4__SetStyle(this, owner, value); }
};
