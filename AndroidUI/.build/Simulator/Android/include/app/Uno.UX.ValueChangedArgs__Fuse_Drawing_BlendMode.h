...
#ifndef __APP_UNO_U_X_VALUE_CHANGED_ARGS__FUSE_DRAWING_BLEND_MODE_H__
#define __APP_UNO_U_X_VALUE_CHANGED_ARGS__FUSE_DRAWING_BLEND_MODE_H__
...
struct ValueChangedArgs__Fuse_Drawing_BlendMode;

struct ValueChangedArgs__Fuse_Drawing_BlendMode__uType : ::app::Uno::EventArgs__uType
{
};
...
struct ValueChangedArgs__Fuse_Drawing_BlendMode : ::app::Uno::EventArgs
{
    int _Value;
    ::uStrong< ::uObject*> _Origin;

    void _ObjInit_1(int value, ::uObject* origin) { ValueChangedArgs__Fuse_Drawing_BlendMode___ObjInit_1(this, value, origin); }
    ::uObject* Origin() { return ValueChangedArgs__Fuse_Drawing_BlendMode__get_Origin(this); }
    int Value() { return ValueChangedArgs__Fuse_Drawing_BlendMode__get_Value(this); }
    void Origin(::uObject* value) { ValueChangedArgs__Fuse_Drawing_BlendMode__set_Origin(this, value); }
    void Value(int value) { ValueChangedArgs__Fuse_Drawing_BlendMode__set_Value(this, value); }
};
