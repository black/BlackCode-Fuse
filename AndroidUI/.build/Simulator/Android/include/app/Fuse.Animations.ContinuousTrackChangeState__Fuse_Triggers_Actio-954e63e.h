...
#ifndef __APP_FUSE_ANIMATIONS_CONTINUOUS_TRACK_CHANGE_STATE__FUSE_TRIGGERS_ACTIO_954E63E_H__
#define __APP_FUSE_ANIMATIONS_CONTINUOUS_TRACK_CHANGE_STATE__FUSE_TRIGGERS_ACTIO_954E63E_H__
...
struct ContinuousTrackChangeState__Fuse_Triggers_Actions_TriggerDirection;

struct ContinuousTrackChangeState__Fuse_Triggers_Actions_TriggerDirection__uType : ::app::Fuse::Animations::TrackAnimatorState__uType
{
};
...
struct ContinuousTrackChangeState__Fuse_Triggers_Actions_TriggerDirection : ::app::Fuse::Animations::TrackAnimatorState
{
    ::uStrong< ::uObject*> mixHandle;
    ::uStrong< ::app::Fuse::Animations::Change__Fuse_Triggers_Actions_TriggerDirection*> Animator_1;

    void _ObjInit_2(::app::Fuse::Animations::Change__Fuse_Triggers_Actions_TriggerDirection* animator, ::app::Fuse::Animations::CreateStateParams* p) { ContinuousTrackChangeState__Fuse_Triggers_Actions_TriggerDirection___ObjInit_2(this, animator, p); }
};
