...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_VALUE_COLLECTION__FRAMEBUFFER__BOOL_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_VALUE_COLLECTION__FRAMEBUFFER__BOOL_H__

#include <app/Uno.Object.h>
#include <Uno.h>
namespace app { namespace Uno { namespace Collections { struct Dictionary__framebuffer__bool; } } }
namespace app { namespace Uno { namespace Collections { struct Dictionary2_ValueCollection_Enumerator__framebuffer__bool; } } }

namespace app {
namespace Uno {
namespace Collections {

struct Dictionary2_ValueCollection__framebuffer__bool;

struct Dictionary2_ValueCollection__framebuffer__bool__uType : ::uClassType
{
};
...
struct Dictionary2_ValueCollection__framebuffer__bool : ::uObject
{
    ::uStrong< ::app::Uno::Collections::Dictionary__framebuffer__bool*> _source;

    void _ObjInit(::app::Uno::Collections::Dictionary__framebuffer__bool* source) { Dictionary2_ValueCollection__framebuffer__bool___ObjInit(this, source); }
    int Count() { return Dictionary2_ValueCollection__framebuffer__bool__get_Count(this); }
    ::app::Uno::Collections::Dictionary2_ValueCollection_Enumerator__framebuffer__bool GetEnumerator();
};
...
inline ::app::Uno::Collections::Dictionary2_ValueCollection_Enumerator__framebuffer__bool Dictionary2_ValueCollection__framebuffer__bool::GetEnumerator() { return Dictionary2_ValueCollection__framebuffer__bool__GetEnumerator(this); }
