...
#ifndef __APP_FUSE_ANIMATIONS_DISCRETE_TRACK_CHANGE_STATE__FUSE_DRAWING_BRUSH_H__
#define __APP_FUSE_ANIMATIONS_DISCRETE_TRACK_CHANGE_STATE__FUSE_DRAWING_BRUSH_H__
...
struct DiscreteTrackChangeState__Fuse_Drawing_Brush;

struct DiscreteTrackChangeState__Fuse_Drawing_Brush__uType : ::app::Fuse::Animations::TrackAnimatorState__uType
{
};
...
struct DiscreteTrackChangeState__Fuse_Drawing_Brush : ::app::Fuse::Animations::TrackAnimatorState
{
    ::uStrong< ::uObject*> mixHandle;
    ::uStrong< ::app::Fuse::Animations::Change__Fuse_Drawing_Brush*> Animator_1;

    void _ObjInit_2(::app::Fuse::Animations::Change__Fuse_Drawing_Brush* animator, ::app::Fuse::Animations::CreateStateParams* p) { DiscreteTrackChangeState__Fuse_Drawing_Brush___ObjInit_2(this, animator, p); }
};
