...
#ifndef __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_BYTECODE_READ_PROP_A7837FBD_H__
#define __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_BYTECODE_READ_PROP_A7837FBD_H__
...
struct Forget__Outracks_Simulator_Bytecode_ReadProperty__char;

struct Forget__Outracks_Simulator_Bytecode_ReadProperty__char__uType : ::uClassType
{
};
...
struct Forget__Outracks_Simulator_Bytecode_ReadProperty__char : ::uObject
{
    ::uChar _result;

    void _ObjInit(::uChar result) { Forget__Outracks_Simulator_Bytecode_ReadProperty__char___ObjInit(this, result); }
    ::uChar Execute(::app::Outracks::Simulator::Bytecode::ReadProperty* _) { return Forget__Outracks_Simulator_Bytecode_ReadProperty__char__Execute(this, _); }
};
