...
struct ICollection__Fuse_Transform
{
    ...
    static int Count(::uObject* __this) { return ((ICollection__Fuse_Transform*)uGetInterfacePtr(__this, ICollection__Fuse_Transform__typeof()))->__fp_get_Count((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeStruct ? sizeof(::uObject) : 0)); }
