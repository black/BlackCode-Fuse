...
#ifndef __APP_FUSE_ANIMATIONS_DISCRETE_TRACK_CHANGE_STATE__FUSE_NODE_H__
#define __APP_FUSE_ANIMATIONS_DISCRETE_TRACK_CHANGE_STATE__FUSE_NODE_H__
...
struct DiscreteTrackChangeState__Fuse_Node;

struct DiscreteTrackChangeState__Fuse_Node__uType : ::app::Fuse::Animations::TrackAnimatorState__uType
{
};
...
struct DiscreteTrackChangeState__Fuse_Node : ::app::Fuse::Animations::TrackAnimatorState
{
    ::uStrong< ::uObject*> mixHandle;
    ::uStrong< ::app::Fuse::Animations::Change__Fuse_Node*> Animator_1;

    void _ObjInit_2(::app::Fuse::Animations::Change__Fuse_Node* animator, ::app::Fuse::Animations::CreateStateParams* p) { DiscreteTrackChangeState__Fuse_Node___ObjInit_2(this, animator, p); }
};
