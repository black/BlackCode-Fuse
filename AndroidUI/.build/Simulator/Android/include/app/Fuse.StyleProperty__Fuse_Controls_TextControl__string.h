...
struct StyleProperty__Fuse_Controls_TextControl__string : ::app::Fuse::StyleProperty
{
    ...
    ::uString* DefaultValue() { return StyleProperty__Fuse_Controls_TextControl__string__get_DefaultValue(this); }
    bool HasValue(::app::Fuse::Controls::TextControl* owner) { return StyleProperty__Fuse_Controls_TextControl__string__HasValue(this, owner); }
    ...
    bool SetStyle(::app::Fuse::Controls::TextControl* owner, ::uString* value) { return StyleProperty__Fuse_Controls_TextControl__string__SetStyle(this, owner, value); }
};
