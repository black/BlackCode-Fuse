...
struct StyleProperty__Fuse_Controls_Number__string : ::app::Fuse::StyleProperty
{
    ...
    void _ObjInit_2(::uString* defaultValue, ::uDelegate* changedCallback, ::uDelegate* setter, ::uDelegate* getter) { StyleProperty__Fuse_Controls_Number__string___ObjInit_2(this, defaultValue, changedCallback, setter, getter); }
    ::uString* Get(::app::Fuse::Controls::Number* owner) { return StyleProperty__Fuse_Controls_Number__string__Get(this, owner); }
    ::uString* DefaultValue() { return StyleProperty__Fuse_Controls_Number__string__get_DefaultValue(this); }
    bool HasValue(::app::Fuse::Controls::Number* owner) { return StyleProperty__Fuse_Controls_Number__string__HasValue(this, owner); }
    ...
    void SetLocalState(::app::Fuse::Controls::Number* owner) { StyleProperty__Fuse_Controls_Number__string__SetLocalState(this, owner); }
    bool SetStyle(::app::Fuse::Controls::Number* owner, ::uString* value) { return StyleProperty__Fuse_Controls_Number__string__SetStyle(this, owner, value); }
};
