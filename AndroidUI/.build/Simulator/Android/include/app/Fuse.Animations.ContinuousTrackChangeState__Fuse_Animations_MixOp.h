...
#ifndef __APP_FUSE_ANIMATIONS_CONTINUOUS_TRACK_CHANGE_STATE__FUSE_ANIMATIONS_MIX_OP_H__
#define __APP_FUSE_ANIMATIONS_CONTINUOUS_TRACK_CHANGE_STATE__FUSE_ANIMATIONS_MIX_OP_H__
...
struct ContinuousTrackChangeState__Fuse_Animations_MixOp;

struct ContinuousTrackChangeState__Fuse_Animations_MixOp__uType : ::app::Fuse::Animations::TrackAnimatorState__uType
{
};
...
struct ContinuousTrackChangeState__Fuse_Animations_MixOp : ::app::Fuse::Animations::TrackAnimatorState
{
    ::uStrong< ::uObject*> mixHandle;
    ::uStrong< ::app::Fuse::Animations::Change__Fuse_Animations_MixOp*> Animator_1;

    void _ObjInit_2(::app::Fuse::Animations::Change__Fuse_Animations_MixOp* animator, ::app::Fuse::Animations::CreateStateParams* p) { ContinuousTrackChangeState__Fuse_Animations_MixOp___ObjInit_2(this, animator, p); }
};
