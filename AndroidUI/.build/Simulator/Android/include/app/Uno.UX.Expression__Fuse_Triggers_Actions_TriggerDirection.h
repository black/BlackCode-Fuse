...
#ifndef __APP_UNO_U_X_EXPRESSION__FUSE_TRIGGERS_ACTIONS_TRIGGER_DIRECTION_H__
#define __APP_UNO_U_X_EXPRESSION__FUSE_TRIGGERS_ACTIONS_TRIGGER_DIRECTION_H__
