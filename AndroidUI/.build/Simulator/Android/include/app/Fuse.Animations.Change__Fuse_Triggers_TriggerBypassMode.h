...
#ifndef __APP_FUSE_ANIMATIONS_CHANGE__FUSE_TRIGGERS_TRIGGER_BYPASS_MODE_H__
#define __APP_FUSE_ANIMATIONS_CHANGE__FUSE_TRIGGERS_TRIGGER_BYPASS_MODE_H__

#include <app/Fuse.Animations.TrackAnimator.h>
#include <Uno.h>
namespace app { namespace Fuse { namespace Animations { struct AnimatorState; } } }
namespace app { namespace Fuse { namespace Animations { struct Converter__Fuse_Triggers_TriggerBypassMode; } } }
...
struct Change__Fuse_Triggers_TriggerBypassMode;

struct Change__Fuse_Triggers_TriggerBypassMode__uType : ::app::Fuse::Animations::TrackAnimator__uType
{
};
...
struct Change__Fuse_Triggers_TriggerBypassMode : ::app::Fuse::Animations::TrackAnimator
{
    ::uStrong< ::app::Fuse::Animations::Converter__Fuse_Triggers_TriggerBypassMode*> ContinuousConverter;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Triggers_TriggerBypassMode*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Triggers_TriggerBypassMode* target) { Change__Fuse_Triggers_TriggerBypassMode___ObjInit_2(this, target); }
    float DegreesX() { return Change__Fuse_Triggers_TriggerBypassMode__get_DegreesX(this); }
    ::app::Uno::Float2 DegreesXY();
    float DegreesY() { return Change__Fuse_Triggers_TriggerBypassMode__get_DegreesY(this); }
    float DegreesZ() { return Change__Fuse_Triggers_TriggerBypassMode__get_DegreesZ(this); }
    bool IsContinuous() { return Change__Fuse_Triggers_TriggerBypassMode__get_IsContinuous(this); }
    ::app::Uno::UX::Property__Fuse_Triggers_TriggerBypassMode* Target() { return Change__Fuse_Triggers_TriggerBypassMode__get_Target(this); }
    int Value() { return Change__Fuse_Triggers_TriggerBypassMode__get_Value(this); }
    float X() { return Change__Fuse_Triggers_TriggerBypassMode__get_X(this); }
    ::app::Uno::Float2 XY();
    float Y() { return Change__Fuse_Triggers_TriggerBypassMode__get_Y(this); }
    float Z() { return Change__Fuse_Triggers_TriggerBypassMode__get_Z(this); }
    void DegreesX(float value) { Change__Fuse_Triggers_TriggerBypassMode__set_DegreesX(this, value); }
    void DegreesXY(::app::Uno::Float2 value);
    void DegreesY(float value) { Change__Fuse_Triggers_TriggerBypassMode__set_DegreesY(this, value); }
    void DegreesZ(float value) { Change__Fuse_Triggers_TriggerBypassMode__set_DegreesZ(this, value); }
    void Target(::app::Uno::UX::Property__Fuse_Triggers_TriggerBypassMode* value) { Change__Fuse_Triggers_TriggerBypassMode__set_Target(this, value); }
    void Value(int value) { Change__Fuse_Triggers_TriggerBypassMode__set_Value(this, value); }
    void X(float value) { Change__Fuse_Triggers_TriggerBypassMode__set_X(this, value); }
    void XY(::app::Uno::Float2 value);
    void Y(float value) { Change__Fuse_Triggers_TriggerBypassMode__set_Y(this, value); }
    void Z(float value) { Change__Fuse_Triggers_TriggerBypassMode__set_Z(this, value); }
};
...
inline ::app::Uno::Float2 Change__Fuse_Triggers_TriggerBypassMode::DegreesXY() { return Change__Fuse_Triggers_TriggerBypassMode__get_DegreesXY(this); }
inline ::app::Uno::Float2 Change__Fuse_Triggers_TriggerBypassMode::XY() { return Change__Fuse_Triggers_TriggerBypassMode__get_XY(this); }
inline void Change__Fuse_Triggers_TriggerBypassMode::DegreesXY(::app::Uno::Float2 value) { Change__Fuse_Triggers_TriggerBypassMode__set_DegreesXY(this, value); }
inline void Change__Fuse_Triggers_TriggerBypassMode::XY(::app::Uno::Float2 value) { Change__Fuse_Triggers_TriggerBypassMode__set_XY(this, value); }
