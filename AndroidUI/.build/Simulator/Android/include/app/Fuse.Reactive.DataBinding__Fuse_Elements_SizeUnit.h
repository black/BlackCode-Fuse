...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_ELEMENTS_SIZE_UNIT_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_ELEMENTS_SIZE_UNIT_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Elements_SizeUnit; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Elements_SizeUnit;

struct DataBinding__Fuse_Elements_SizeUnit__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Elements_SizeUnit : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Elements_SizeUnit*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Elements_SizeUnit* target, ::uString* key) { DataBinding__Fuse_Elements_SizeUnit___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Elements_SizeUnit__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Elements_SizeUnit* Target() { return DataBinding__Fuse_Elements_SizeUnit__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Elements_SizeUnit* args) { DataBinding__Fuse_Elements_SizeUnit__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Elements_SizeUnit__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Elements_SizeUnit* value) { DataBinding__Fuse_Elements_SizeUnit__set_Target(this, value); }
    void SetValue(int value) { DataBinding__Fuse_Elements_SizeUnit__SetValue(this, value); }
};
