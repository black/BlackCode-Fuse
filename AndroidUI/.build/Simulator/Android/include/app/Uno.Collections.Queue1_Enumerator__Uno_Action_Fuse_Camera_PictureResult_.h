...
#ifndef __APP_UNO_COLLECTIONS_QUEUE1_ENUMERATOR__UNO_ACTION_FUSE_CAMERA_PICTURE_RESULT__H__
#define __APP_UNO_COLLECTIONS_QUEUE1_ENUMERATOR__UNO_ACTION_FUSE_CAMERA_PICTURE_RESULT__H__
...
struct Queue1_Enumerator__Uno_Action_Fuse_Camera_PictureResult_;

struct Queue1_Enumerator__Uno_Action_Fuse_Camera_PictureResult___uType : ::uStructType
{
...
struct Queue1_Enumerator__Uno_Action_Fuse_Camera_PictureResult_
{
    ::uStrong< ::app::Uno::Collections::Queue__Uno_Action_Fuse_Camera_PictureResult_*> _source;
    int _version;
    int _index;
    ::uStrong< ::uDelegate*> _current;

    void _ObjInit(::app::Uno::Collections::Queue__Uno_Action_Fuse_Camera_PictureResult_* source) { Queue1_Enumerator__Uno_Action_Fuse_Camera_PictureResult____ObjInit(this, source); }
    void Dispose() { Queue1_Enumerator__Uno_Action_Fuse_Camera_PictureResult___Dispose(this); }
    bool MoveNext() { return Queue1_Enumerator__Uno_Action_Fuse_Camera_PictureResult___MoveNext(this); }
};
