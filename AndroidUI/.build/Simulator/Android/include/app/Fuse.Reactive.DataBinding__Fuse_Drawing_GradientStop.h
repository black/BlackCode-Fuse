...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_DRAWING_GRADIENT_STOP_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_DRAWING_GRADIENT_STOP_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Drawing_GradientStop; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Drawing_GradientStop;

struct DataBinding__Fuse_Drawing_GradientStop__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Drawing_GradientStop : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Drawing_GradientStop*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Drawing_GradientStop* target, ::uString* key) { DataBinding__Fuse_Drawing_GradientStop___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Drawing_GradientStop__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Drawing_GradientStop* Target() { return DataBinding__Fuse_Drawing_GradientStop__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Drawing_GradientStop* args) { DataBinding__Fuse_Drawing_GradientStop__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Drawing_GradientStop__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Drawing_GradientStop* value) { DataBinding__Fuse_Drawing_GradientStop__set_Target(this, value); }
    void SetValue(::app::Fuse::Drawing::GradientStop* value) { DataBinding__Fuse_Drawing_GradientStop__SetValue(this, value); }
};
