...
struct StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Stroke : ::app::Fuse::StyleProperty
{
    ...
    ::app::Fuse::Drawing::Stroke* Get(::app::Fuse::Shapes::Shape* owner) { return StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Stroke__Get(this, owner); }
    ::app::Fuse::Drawing::Stroke* DefaultValue() { return StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Stroke__get_DefaultValue(this); }
    bool HasValue(::app::Fuse::Shapes::Shape* owner) { return StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Stroke__HasValue(this, owner); }
    bool IsEqual(::app::Fuse::Drawing::Stroke* value, ::app::Fuse::Drawing::Stroke* oldValue) { return StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Stroke__IsEqual(this, value, oldValue); }
    ...
    bool Set(::app::Fuse::Shapes::Shape* owner, ::app::Fuse::Drawing::Stroke* value) { return StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Stroke__Set(this, owner, value); }
    void SetLocalState(::app::Fuse::Shapes::Shape* owner) { StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Stroke__SetLocalState(this, owner); }
    bool SetStyle(::app::Fuse::Shapes::Shape* owner, ::app::Fuse::Drawing::Stroke* value) { return StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Stroke__SetStyle(this, owner, value); }
};
