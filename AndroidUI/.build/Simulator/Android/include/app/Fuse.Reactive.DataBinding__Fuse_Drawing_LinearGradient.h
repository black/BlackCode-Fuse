...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_DRAWING_LINEAR_GRADIENT_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_DRAWING_LINEAR_GRADIENT_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Drawing_LinearGradient; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Drawing_LinearGradient;

struct DataBinding__Fuse_Drawing_LinearGradient__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Drawing_LinearGradient : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Drawing_LinearGradient*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Drawing_LinearGradient* target, ::uString* key) { DataBinding__Fuse_Drawing_LinearGradient___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Drawing_LinearGradient__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Drawing_LinearGradient* Target() { return DataBinding__Fuse_Drawing_LinearGradient__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Drawing_LinearGradient* args) { DataBinding__Fuse_Drawing_LinearGradient__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Drawing_LinearGradient__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Drawing_LinearGradient* value) { DataBinding__Fuse_Drawing_LinearGradient__set_Target(this, value); }
    void SetValue(::app::Fuse::Drawing::LinearGradient* value) { DataBinding__Fuse_Drawing_LinearGradient__SetValue(this, value); }
};
