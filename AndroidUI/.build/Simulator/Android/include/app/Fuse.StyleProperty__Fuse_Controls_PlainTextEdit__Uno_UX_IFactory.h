...
struct StyleProperty__Fuse_Controls_PlainTextEdit__Uno_UX_IFactory : ::app::Fuse::StyleProperty
{
    ...
    void _ObjInit_2(::uObject* defaultValue, ::uDelegate* changedCallback, ::uDelegate* setter, ::uDelegate* getter) { StyleProperty__Fuse_Controls_PlainTextEdit__Uno_UX_IFactory___ObjInit_2(this, defaultValue, changedCallback, setter, getter); }
    ...
    ::uObject* DefaultValue() { return StyleProperty__Fuse_Controls_PlainTextEdit__Uno_UX_IFactory__get_DefaultValue(this); }
    ...
    void SetLocalState(::app::Fuse::Controls::PlainTextEdit* owner) { StyleProperty__Fuse_Controls_PlainTextEdit__Uno_UX_IFactory__SetLocalState(this, owner); }
