...
#ifndef __APP_FUSE_ANIMATIONS_CONTINUOUS_TRACK_CHANGE_STATE__FUSE_FONT_H__
#define __APP_FUSE_ANIMATIONS_CONTINUOUS_TRACK_CHANGE_STATE__FUSE_FONT_H__
...
struct ContinuousTrackChangeState__Fuse_Font;

struct ContinuousTrackChangeState__Fuse_Font__uType : ::app::Fuse::Animations::TrackAnimatorState__uType
{
};
...
struct ContinuousTrackChangeState__Fuse_Font : ::app::Fuse::Animations::TrackAnimatorState
{
    ::uStrong< ::uObject*> mixHandle;
    ::uStrong< ::app::Fuse::Animations::Change__Fuse_Font*> Animator_1;

    void _ObjInit_2(::app::Fuse::Animations::Change__Fuse_Font* animator, ::app::Fuse::Animations::CreateStateParams* p) { ContinuousTrackChangeState__Fuse_Font___ObjInit_2(this, animator, p); }
};
