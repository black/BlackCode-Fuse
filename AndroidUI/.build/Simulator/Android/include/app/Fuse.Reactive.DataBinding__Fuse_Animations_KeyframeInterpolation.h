...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_ANIMATIONS_KEYFRAME_INTERPOLATION_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_ANIMATIONS_KEYFRAME_INTERPOLATION_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Animations_KeyframeInterpolation; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Animations_KeyframeInterpolation;

struct DataBinding__Fuse_Animations_KeyframeInterpolation__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Animations_KeyframeInterpolation : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Animations_KeyframeInterpolation*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Animations_KeyframeInterpolation* target, ::uString* key) { DataBinding__Fuse_Animations_KeyframeInterpolation___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Animations_KeyframeInterpolation__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Animations_KeyframeInterpolation* Target() { return DataBinding__Fuse_Animations_KeyframeInterpolation__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Animations_KeyframeInterpolation* args) { DataBinding__Fuse_Animations_KeyframeInterpolation__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Animations_KeyframeInterpolation__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Animations_KeyframeInterpolation* value) { DataBinding__Fuse_Animations_KeyframeInterpolation__set_Target(this, value); }
    void SetValue(int value) { DataBinding__Fuse_Animations_KeyframeInterpolation__SetValue(this, value); }
};
