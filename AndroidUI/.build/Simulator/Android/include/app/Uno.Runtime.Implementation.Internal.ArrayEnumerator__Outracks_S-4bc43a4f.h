...
#ifndef __APP_UNO_RUNTIME_IMPLEMENTATION_INTERNAL_ARRAY_ENUMERATOR__OUTRACKS_S_4BC43A4F_H__
#define __APP_UNO_RUNTIME_IMPLEMENTATION_INTERNAL_ARRAY_ENUMERATOR__OUTRACKS_S_4BC43A4F_H__
...
struct ArrayEnumerator__Outracks_Simulator_Bytecode_Expression;

struct ArrayEnumerator__Outracks_Simulator_Bytecode_Expression__uType : ::uClassType
{
    ::app::Uno::Collections::IEnumerator__Outracks_Simulator_Bytecode_Expression __interface_0;
...
struct ArrayEnumerator__Outracks_Simulator_Bytecode_Expression : ::uObject
{
    ::uStrong< ::uArray*> _source;
    int _iterator;
    ::uStrong< ::app::Outracks::Simulator::Bytecode::Expression*> _current;

    void _ObjInit(::uArray* source) { ArrayEnumerator__Outracks_Simulator_Bytecode_Expression___ObjInit(this, source); }
    void Dispose() { ArrayEnumerator__Outracks_Simulator_Bytecode_Expression__Dispose(this); }
    ::app::Outracks::Simulator::Bytecode::Expression* Current() { return ArrayEnumerator__Outracks_Simulator_Bytecode_Expression__get_Current(this); }
    bool MoveNext() { return ArrayEnumerator__Outracks_Simulator_Bytecode_Expression__MoveNext(this); }
    void Reset() { ArrayEnumerator__Outracks_Simulator_Bytecode_Expression__Reset(this); }
};
