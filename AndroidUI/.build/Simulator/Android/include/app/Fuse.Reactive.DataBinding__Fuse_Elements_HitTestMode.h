...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_ELEMENTS_HIT_TEST_MODE_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_ELEMENTS_HIT_TEST_MODE_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Elements_HitTestMode; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Elements_HitTestMode;

struct DataBinding__Fuse_Elements_HitTestMode__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Elements_HitTestMode : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Elements_HitTestMode*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Elements_HitTestMode* target, ::uString* key) { DataBinding__Fuse_Elements_HitTestMode___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Elements_HitTestMode__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Elements_HitTestMode* Target() { return DataBinding__Fuse_Elements_HitTestMode__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Elements_HitTestMode* args) { DataBinding__Fuse_Elements_HitTestMode__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Elements_HitTestMode__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Elements_HitTestMode* value) { DataBinding__Fuse_Elements_HitTestMode__set_Target(this, value); }
    void SetValue(int value) { DataBinding__Fuse_Elements_HitTestMode__SetValue(this, value); }
};
