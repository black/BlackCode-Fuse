...
#ifndef __APP_OUTRACKS_SIMULATOR_RUNTIME_UX_PROPERTY__FUSE_TRIGGERS_ACTIONS_TR_D90C514D_H__
#define __APP_OUTRACKS_SIMULATOR_RUNTIME_UX_PROPERTY__FUSE_TRIGGERS_ACTIONS_TR_D90C514D_H__
...
struct UxProperty__Fuse_Triggers_Actions_TriggerDirection;

struct UxProperty__Fuse_Triggers_Actions_TriggerDirection__uType : ::app::Uno::UX::Property__Fuse_Triggers_Actions_TriggerDirection__uType
{
};
...
struct UxProperty__Fuse_Triggers_Actions_TriggerDirection : ::app::Uno::UX::Property__Fuse_Triggers_Actions_TriggerDirection
{
    ...
    void _ObjInit_1(::uDelegate* setter, ::uDelegate* getter, ::uDelegate* adder, ::uDelegate* remover) { UxProperty__Fuse_Triggers_Actions_TriggerDirection___ObjInit_1(this, setter, getter, adder, remover); }
};
