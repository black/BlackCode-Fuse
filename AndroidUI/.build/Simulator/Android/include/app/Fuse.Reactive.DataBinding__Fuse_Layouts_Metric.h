...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_LAYOUTS_METRIC_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_LAYOUTS_METRIC_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Layouts_Metric; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Layouts_Metric;

struct DataBinding__Fuse_Layouts_Metric__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Layouts_Metric : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Layouts_Metric*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Layouts_Metric* target, ::uString* key) { DataBinding__Fuse_Layouts_Metric___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Layouts_Metric__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Layouts_Metric* Target() { return DataBinding__Fuse_Layouts_Metric__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Layouts_Metric* args) { DataBinding__Fuse_Layouts_Metric__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Layouts_Metric__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Layouts_Metric* value) { DataBinding__Fuse_Layouts_Metric__set_Target(this, value); }
    void SetValue(int value) { DataBinding__Fuse_Layouts_Metric__SetValue(this, value); }
};
