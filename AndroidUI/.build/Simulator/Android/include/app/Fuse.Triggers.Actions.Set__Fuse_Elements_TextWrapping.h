...
#ifndef __APP_FUSE_TRIGGERS_ACTIONS_SET__FUSE_ELEMENTS_TEXT_WRAPPING_H__
#define __APP_FUSE_TRIGGERS_ACTIONS_SET__FUSE_ELEMENTS_TEXT_WRAPPING_H__
...
struct Set__Fuse_Elements_TextWrapping;

struct Set__Fuse_Elements_TextWrapping__uType : ::app::Fuse::Triggers::Actions::TriggerAction__uType
{
};
...
struct Set__Fuse_Elements_TextWrapping : ::app::Fuse::Triggers::Actions::TriggerAction
{
    bool _updateRestValue;
    int _increment;
    bool _hasIncrement;
    ::uStrong< ::app::Fuse::Internal::Blender__Fuse_Elements_TextWrapping*> _blender;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Elements_TextWrapping*> _Target;
    int _Value;
    ::uStrong< ::uDelegate*> _Expression;

    void _ObjInit_1(::app::Uno::UX::Property__Fuse_Elements_TextWrapping* target) { Set__Fuse_Elements_TextWrapping___ObjInit_1(this, target); }
    ::uDelegate* Expression() { return Set__Fuse_Elements_TextWrapping__get_Expression(this); }
    int Increment() { return Set__Fuse_Elements_TextWrapping__get_Increment(this); }
    ::app::Uno::UX::Property__Fuse_Elements_TextWrapping* Target() { return Set__Fuse_Elements_TextWrapping__get_Target(this); }
    bool UpdateRestValue() { return Set__Fuse_Elements_TextWrapping__get_UpdateRestValue(this); }
    int Value() { return Set__Fuse_Elements_TextWrapping__get_Value(this); }
    void Expression(::uDelegate* value) { Set__Fuse_Elements_TextWrapping__set_Expression(this, value); }
    void Increment(int value) { Set__Fuse_Elements_TextWrapping__set_Increment(this, value); }
    void Target(::app::Uno::UX::Property__Fuse_Elements_TextWrapping* value) { Set__Fuse_Elements_TextWrapping__set_Target(this, value); }
    void UpdateRestValue(bool value) { Set__Fuse_Elements_TextWrapping__set_UpdateRestValue(this, value); }
    void Value(int value) { Set__Fuse_Elements_TextWrapping__set_Value(this, value); }
    void Update(int value) { Set__Fuse_Elements_TextWrapping__Update(this, value); }
};
