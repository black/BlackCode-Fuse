...
#ifndef __APP_FUSE_ANIMATIONS_MIXER_HANDLE__FUSE_TRIGGERS_TRIGGER_BYPASS_MODE_H__
#define __APP_FUSE_ANIMATIONS_MIXER_HANDLE__FUSE_TRIGGERS_TRIGGER_BYPASS_MODE_H__

#include <app/Fuse.Animations.IMixerHandle__Fuse_Triggers_TriggerBypassMode.h>
#include <app/Uno.Object.h>
#include <Uno.h>
namespace app { namespace Fuse { namespace Animations { struct MasterBase__Fuse_Triggers_TriggerBypassMode; } } }

namespace app {
namespace Fuse {
namespace Animations {

struct MixerHandle__Fuse_Triggers_TriggerBypassMode;

struct MixerHandle__Fuse_Triggers_TriggerBypassMode__uType : ::uClassType
{
    ::app::Fuse::Animations::IMixerHandle__Fuse_Triggers_TriggerBypassMode __interface_0;
};
...
struct MixerHandle__Fuse_Triggers_TriggerBypassMode : ::uObject
{
    int Value;
    float Strength;
    bool _hasValue;
    ::uStrong< ::app::Fuse::Animations::MasterBase__Fuse_Triggers_TriggerBypassMode*> Master;
    int _MixOp;
    int _Priority;

    void _ObjInit(::app::Fuse::Animations::MasterBase__Fuse_Triggers_TriggerBypassMode* master, int mode, int priority) { MixerHandle__Fuse_Triggers_TriggerBypassMode___ObjInit(this, master, mode, priority); }
    bool HasValue() { return MixerHandle__Fuse_Triggers_TriggerBypassMode__get_HasValue(this); }
    int MixOp() { return MixerHandle__Fuse_Triggers_TriggerBypassMode__get_MixOp(this); }
    int Priority() { return MixerHandle__Fuse_Triggers_TriggerBypassMode__get_Priority(this); }
    int RestValue() { return MixerHandle__Fuse_Triggers_TriggerBypassMode__get_RestValue(this); }
    void Set(int value, float strength) { MixerHandle__Fuse_Triggers_TriggerBypassMode__Set(this, value, strength); }
    void MixOp(int value) { MixerHandle__Fuse_Triggers_TriggerBypassMode__set_MixOp(this, value); }
    void Priority(int value) { MixerHandle__Fuse_Triggers_TriggerBypassMode__set_Priority(this, value); }
    void Unregister() { MixerHandle__Fuse_Triggers_TriggerBypassMode__Unregister(this); }
};
