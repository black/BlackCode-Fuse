...
#ifndef __APP_OUTRACKS_SIMULATOR_RUNTIME_UX_PROPERTY__FUSE_ELEMENTS_SIZE_UNIT_H__
#define __APP_OUTRACKS_SIMULATOR_RUNTIME_UX_PROPERTY__FUSE_ELEMENTS_SIZE_UNIT_H__
...
struct UxProperty__Fuse_Elements_SizeUnit;

struct UxProperty__Fuse_Elements_SizeUnit__uType : ::app::Uno::UX::Property__Fuse_Elements_SizeUnit__uType
{
};
...
struct UxProperty__Fuse_Elements_SizeUnit : ::app::Uno::UX::Property__Fuse_Elements_SizeUnit
{
    ...
    void _ObjInit_1(::uDelegate* setter, ::uDelegate* getter, ::uDelegate* adder, ::uDelegate* remover) { UxProperty__Fuse_Elements_SizeUnit___ObjInit_1(this, setter, getter, adder, remover); }
};
