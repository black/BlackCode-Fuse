...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION__INT__UNO_COLLECTIONS_E2E724C3_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION__INT__UNO_COLLECTIONS_E2E724C3_H__
...
namespace app { namespace Uno { namespace Collections { struct Dictionary2_KeyCollection_Enumerator__int__Uno_Collections_List_Fuse_Input_Pointer_PELHolder_; } } }

namespace app {
namespace Uno {
namespace Collections {

struct Dictionary2_KeyCollection__int__Uno_Collections_List_Fuse_Input_Pointer_PELHolder_;

struct Dictionary2_KeyCollection__int__Uno_Collections_List_Fuse_Input_Pointer_PELHolder___uType : ::uClassType
{
...
struct Dictionary2_KeyCollection__int__Uno_Collections_List_Fuse_Input_Pointer_PELHolder_ : ::uObject
{
    ::uStrong< ::app::Uno::Collections::Dictionary__int__Uno_Collections_List_Fuse_Input_Pointer_PELHolder_*> _source;

    ::uObject* GetEnumerator_boxed() { return Dictionary2_KeyCollection__int__Uno_Collections_List_Fuse_Input_Pointer_PELHolder___GetEnumerator_boxed(this); }
    void _ObjInit(::app::Uno::Collections::Dictionary__int__Uno_Collections_List_Fuse_Input_Pointer_PELHolder_* source) { Dictionary2_KeyCollection__int__Uno_Collections_List_Fuse_Input_Pointer_PELHolder____ObjInit(this, source); }
    int Count() { return Dictionary2_KeyCollection__int__Uno_Collections_List_Fuse_Input_Pointer_PELHolder___get_Count(this); }
    ::app::Uno::Collections::Dictionary2_KeyCollection_Enumerator__int__Uno_Collections_List_Fuse_Input_Pointer_PELHolder_ GetEnumerator();
};
...
inline ::app::Uno::Collections::Dictionary2_KeyCollection_Enumerator__int__Uno_Collections_List_Fuse_Input_Pointer_PELHolder_ Dictionary2_KeyCollection__int__Uno_Collections_List_Fuse_Input_Pointer_PELHolder_::GetEnumerator() { return Dictionary2_KeyCollection__int__Uno_Collections_List_Fuse_Input_Pointer_PELHolder___GetEnumerator(this); }
