...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_NAVIGATION_SNAP_TO_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_NAVIGATION_SNAP_TO_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Navigation_SnapTo; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Navigation_SnapTo;

struct DataBinding__Fuse_Navigation_SnapTo__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Navigation_SnapTo : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Navigation_SnapTo*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Navigation_SnapTo* target, ::uString* key) { DataBinding__Fuse_Navigation_SnapTo___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Navigation_SnapTo__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Navigation_SnapTo* Target() { return DataBinding__Fuse_Navigation_SnapTo__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Navigation_SnapTo* args) { DataBinding__Fuse_Navigation_SnapTo__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Navigation_SnapTo__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Navigation_SnapTo* value) { DataBinding__Fuse_Navigation_SnapTo__set_Target(this, value); }
    void SetValue(int value) { DataBinding__Fuse_Navigation_SnapTo__SetValue(this, value); }
};
