...
#ifndef __APP_EXPERIMENTAL_PHYSICS_ELASTIC_FORCE__FLOAT4_H__
#define __APP_EXPERIMENTAL_PHYSICS_ELASTIC_FORCE__FLOAT4_H__
...
struct ElasticForce__float4;

struct ElasticForce__float4__uType : ::uClassType
{
    ::app::Experimental::Physics::DestinationSimulation__float4 __interface_0;
    ::app::Experimental::Physics::MotionSimulation__float4 __interface_1;
...
struct ElasticForce__float4 : ::uObject
{
    ::uStrong< ::app::Fuse::Internal::Blender__float4*> _blender;
    float _scale;
    ::app::Uno::Float4 _velocity;
    ::app::Uno::Float4 _attractionDestination;
    ...
    double _remainTime;
    bool _IsLocked;
    ::app::Uno::Float4 _Position;

    void _ObjInit(float scale) { ElasticForce__float4___ObjInit(this, scale); }
    ::app::Uno::Float4 Attraction() { return ElasticForce__float4__get_Attraction(this); }
    float AttractionCurve() { return ElasticForce__float4__get_AttractionCurve(this); }
    float AttractionForce() { return ElasticForce__float4__get_AttractionForce(this); }
    float Damping() { return ElasticForce__float4__get_Damping(this); }
    ::app::Uno::Float4 Destination() { return ElasticForce__float4__get_Destination(this); }
    float Energy() { return ElasticForce__float4__get_Energy(this); }
    float EnergyEps() { return ElasticForce__float4__get_EnergyEps(this); }
    bool IsLocked() { return ElasticForce__float4__get_IsLocked(this); }
    bool IsStatic() { return ElasticForce__float4__get_IsStatic(this); }
    float MaxSpeed() { return ElasticForce__float4__get_MaxSpeed(this); }
    ::app::Uno::Float4 Position() { return ElasticForce__float4__get_Position(this); }
    ::app::Uno::Float4 Velocity() { return ElasticForce__float4__get_Velocity(this); }
    void Iterate() { ElasticForce__float4__Iterate(this); }
    void Reset(::app::Uno::Float4 value) { ElasticForce__float4__Reset(this, value); }
    void ResetMaxSpeed() { ElasticForce__float4__ResetMaxSpeed(this); }
    void AttractionCurve(float value) { ElasticForce__float4__set_AttractionCurve(this, value); }
    void AttractionForce(float value) { ElasticForce__float4__set_AttractionForce(this, value); }
    void Damping(float value) { ElasticForce__float4__set_Damping(this, value); }
    void Destination(::app::Uno::Float4 value) { ElasticForce__float4__set_Destination(this, value); }
    void EnergyEps(float value) { ElasticForce__float4__set_EnergyEps(this, value); }
    void IsLocked(bool value) { ElasticForce__float4__set_IsLocked(this, value); }
    void IsStatic(bool value) { ElasticForce__float4__set_IsStatic(this, value); }
    void MaxSpeed(float value) { ElasticForce__float4__set_MaxSpeed(this, value); }
    void Position(::app::Uno::Float4 value) { ElasticForce__float4__set_Position(this, value); }
    void Velocity(::app::Uno::Float4 value) { ElasticForce__float4__set_Velocity(this, value); }
    void Update(double elapsed) { ElasticForce__float4__Update(this, elapsed); }
};
