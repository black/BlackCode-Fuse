...
struct StyleProperty__Fuse_Elements_Element__Fuse_Elements_CachingMode : ::app::Fuse::StyleProperty
{
    ...
    int DefaultValue() { return StyleProperty__Fuse_Elements_Element__Fuse_Elements_CachingMode__get_DefaultValue(this); }
    bool HasValue(::app::Fuse::Elements::Element* owner) { return StyleProperty__Fuse_Elements_Element__Fuse_Elements_CachingMode__HasValue(this, owner); }
    ...
    void SetLocalState(::app::Fuse::Elements::Element* owner) { StyleProperty__Fuse_Elements_Element__Fuse_Elements_CachingMode__SetLocalState(this, owner); }
    bool SetStyle(::app::Fuse::Elements::Element* owner, int value) { return StyleProperty__Fuse_Elements_Element__Fuse_Elements_CachingMode__SetStyle(this, owner, value); }
};
