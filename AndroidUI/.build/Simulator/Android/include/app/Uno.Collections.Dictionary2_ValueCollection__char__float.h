...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_VALUE_COLLECTION__CHAR__FLOAT_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_VALUE_COLLECTION__CHAR__FLOAT_H__

#include <app/Uno.Object.h>
#include <Uno.h>
namespace app { namespace Uno { namespace Collections { struct Dictionary__char__float; } } }
namespace app { namespace Uno { namespace Collections { struct Dictionary2_ValueCollection_Enumerator__char__float; } } }

namespace app {
namespace Uno {
namespace Collections {

struct Dictionary2_ValueCollection__char__float;

struct Dictionary2_ValueCollection__char__float__uType : ::uClassType
{
};
...
struct Dictionary2_ValueCollection__char__float : ::uObject
{
    ::uStrong< ::app::Uno::Collections::Dictionary__char__float*> _source;

    void _ObjInit(::app::Uno::Collections::Dictionary__char__float* source) { Dictionary2_ValueCollection__char__float___ObjInit(this, source); }
    int Count() { return Dictionary2_ValueCollection__char__float__get_Count(this); }
    ::app::Uno::Collections::Dictionary2_ValueCollection_Enumerator__char__float GetEnumerator();
};
...
inline ::app::Uno::Collections::Dictionary2_ValueCollection_Enumerator__char__float Dictionary2_ValueCollection__char__float::GetEnumerator() { return Dictionary2_ValueCollection__char__float__GetEnumerator(this); }
