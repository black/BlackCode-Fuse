...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION__INT__STRING_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION__INT__STRING_H__
...
namespace app { namespace Uno { namespace Collections { struct Dictionary2_KeyCollection_Enumerator__int__string; } } }

namespace app {
namespace Uno {
namespace Collections {

struct Dictionary2_KeyCollection__int__string;

struct Dictionary2_KeyCollection__int__string__uType : ::uClassType
{
...
struct Dictionary2_KeyCollection__int__string : ::uObject
{
    ::uStrong< ::app::Uno::Collections::Dictionary__int__string*> _source;

    ::uObject* GetEnumerator_boxed() { return Dictionary2_KeyCollection__int__string__GetEnumerator_boxed(this); }
    void _ObjInit(::app::Uno::Collections::Dictionary__int__string* source) { Dictionary2_KeyCollection__int__string___ObjInit(this, source); }
    int Count() { return Dictionary2_KeyCollection__int__string__get_Count(this); }
    ::app::Uno::Collections::Dictionary2_KeyCollection_Enumerator__int__string GetEnumerator();
};
...
inline ::app::Uno::Collections::Dictionary2_KeyCollection_Enumerator__int__string Dictionary2_KeyCollection__int__string::GetEnumerator() { return Dictionary2_KeyCollection__int__string__GetEnumerator(this); }
