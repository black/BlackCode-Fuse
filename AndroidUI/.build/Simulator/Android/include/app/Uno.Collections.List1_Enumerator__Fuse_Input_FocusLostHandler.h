...
#ifndef __APP_UNO_COLLECTIONS_LIST1_ENUMERATOR__FUSE_INPUT_FOCUS_LOST_HANDLER_H__
#define __APP_UNO_COLLECTIONS_LIST1_ENUMERATOR__FUSE_INPUT_FOCUS_LOST_HANDLER_H__
...
struct List1_Enumerator__Fuse_Input_FocusLostHandler;

struct List1_Enumerator__Fuse_Input_FocusLostHandler__uType : ::uStructType
{
    ::app::Uno::Collections::IEnumerator__Fuse_Input_FocusLostHandler __interface_0;
...
struct List1_Enumerator__Fuse_Input_FocusLostHandler
{
    ::uStrong< ::app::Uno::Collections::List__Fuse_Input_FocusLostHandler*> _source;
    int _version;
    int _iterator;
    ::uStrong< ::uDelegate*> _current;

    void _ObjInit(::app::Uno::Collections::List__Fuse_Input_FocusLostHandler* source) { List1_Enumerator__Fuse_Input_FocusLostHandler___ObjInit(this, source); }
    void Dispose() { List1_Enumerator__Fuse_Input_FocusLostHandler__Dispose(this); }
    ::uDelegate* Current() { return List1_Enumerator__Fuse_Input_FocusLostHandler__get_Current(this); }
    bool MoveNext() { return List1_Enumerator__Fuse_Input_FocusLostHandler__MoveNext(this); }
};
