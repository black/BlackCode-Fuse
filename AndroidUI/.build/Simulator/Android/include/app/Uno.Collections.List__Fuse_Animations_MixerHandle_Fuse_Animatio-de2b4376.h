...
#ifndef __APP_UNO_COLLECTIONS_LIST__FUSE_ANIMATIONS_MIXER_HANDLE_FUSE_ANIMATIO_DE2B4376_H__
#define __APP_UNO_COLLECTIONS_LIST__FUSE_ANIMATIONS_MIXER_HANDLE_FUSE_ANIMATIO_DE2B4376_H__
...
namespace app { namespace Uno { namespace Collections { struct List1_Enumerator__Fuse_Animations_MixerHandle_Fuse_Animations_Easing_; } } }

namespace app {
namespace Uno {
namespace Collections {

struct List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing_;

struct List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing___uType : ::uClassType
{
    ::app::Uno::Collections::IEnumerable__Fuse_Animations_MixerHandle_Fuse_Animations_Easing_ __interface_0;
};
...
struct List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing_ : ::uObject
{
    ::uStrong< ::uArray*> _data;
    int _used;
    int _version;

    ::uObject* GetEnumerator_boxed() { return List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing___GetEnumerator_boxed(this); }
    void _ObjInit() { List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing____ObjInit(this); }
    void _ObjInit_1(int capacity) { List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing____ObjInit_1(this, capacity); }
    void Add(::app::Fuse::Animations::MixerHandle__Fuse_Animations_Easing* item) { List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing___Add(this, item); }
    void AddRange(::uObject* items) { List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing___AddRange(this, items); }
    void BoundsCheck(int index) { List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing___BoundsCheck(this, index); }
    void Clear() { List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing___Clear(this); }
    bool Contains(::app::Fuse::Animations::MixerHandle__Fuse_Animations_Easing* item) { return List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing___Contains(this, item); }
    void EnsureCapacity() { List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing___EnsureCapacity(this); }
    int Count() { return List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing___get_Count(this); }
    ::app::Fuse::Animations::MixerHandle__Fuse_Animations_Easing* Item(int index) { return List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing___get_Item(this, index); }
    ::app::Uno::Collections::List1_Enumerator__Fuse_Animations_MixerHandle_Fuse_Animations_Easing_ GetEnumerator();
    int IndexOf(::app::Fuse::Animations::MixerHandle__Fuse_Animations_Easing* item) { return List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing___IndexOf(this, item); }
    void Insert(int index, ::app::Fuse::Animations::MixerHandle__Fuse_Animations_Easing* item) { List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing___Insert(this, index, item); }
    bool Remove(::app::Fuse::Animations::MixerHandle__Fuse_Animations_Easing* item) { return List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing___Remove(this, item); }
    void RemoveAt(int index) { List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing___RemoveAt(this, index); }
    void Item(int index, ::app::Fuse::Animations::MixerHandle__Fuse_Animations_Easing* value) { List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing___set_Item(this, index, value); }
    void Sort(::uDelegate* comparer) { List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing___Sort(this, comparer); }
    ::uArray* ToArray() { return List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing___ToArray(this); }
};

}}}

#include <app/Uno.Collections.List1_Enumerator__Fuse_Animations_MixerHandle_F-1b1e03ad.h>

namespace app {
namespace Uno {
namespace Collections {

inline ::app::Uno::Collections::List1_Enumerator__Fuse_Animations_MixerHandle_Fuse_Animations_Easing_ List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing_::GetEnumerator() { return List__Fuse_Animations_MixerHandle_Fuse_Animations_Easing___GetEnumerator(this); }
