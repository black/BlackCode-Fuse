...
#ifndef __APP_FUSE_ANIMATIONS_CONTINUOUS_TRACK_CHANGE_STATE__FUSE_ELEMENTS_TEXT_WRAPPING_H__
#define __APP_FUSE_ANIMATIONS_CONTINUOUS_TRACK_CHANGE_STATE__FUSE_ELEMENTS_TEXT_WRAPPING_H__
...
struct ContinuousTrackChangeState__Fuse_Elements_TextWrapping;

struct ContinuousTrackChangeState__Fuse_Elements_TextWrapping__uType : ::app::Fuse::Animations::TrackAnimatorState__uType
{
};
...
struct ContinuousTrackChangeState__Fuse_Elements_TextWrapping : ::app::Fuse::Animations::TrackAnimatorState
{
    ::uStrong< ::uObject*> mixHandle;
    ::uStrong< ::app::Fuse::Animations::Change__Fuse_Elements_TextWrapping*> Animator_1;

    void _ObjInit_2(::app::Fuse::Animations::Change__Fuse_Elements_TextWrapping* animator, ::app::Fuse::Animations::CreateStateParams* p) { ContinuousTrackChangeState__Fuse_Elements_TextWrapping___ObjInit_2(this, animator, p); }
};
