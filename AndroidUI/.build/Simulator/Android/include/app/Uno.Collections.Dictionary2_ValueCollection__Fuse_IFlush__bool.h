...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_VALUE_COLLECTION__FUSE_I_FLUSH__BOOL_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_VALUE_COLLECTION__FUSE_I_FLUSH__BOOL_H__

#include <app/Uno.Object.h>
#include <Uno.h>
namespace app { namespace Uno { namespace Collections { struct Dictionary__Fuse_IFlush__bool; } } }
namespace app { namespace Uno { namespace Collections { struct Dictionary2_ValueCollection_Enumerator__Fuse_IFlush__bool; } } }

namespace app {
namespace Uno {
namespace Collections {

struct Dictionary2_ValueCollection__Fuse_IFlush__bool;

struct Dictionary2_ValueCollection__Fuse_IFlush__bool__uType : ::uClassType
{
};
...
struct Dictionary2_ValueCollection__Fuse_IFlush__bool : ::uObject
{
    ::uStrong< ::app::Uno::Collections::Dictionary__Fuse_IFlush__bool*> _source;

    void _ObjInit(::app::Uno::Collections::Dictionary__Fuse_IFlush__bool* source) { Dictionary2_ValueCollection__Fuse_IFlush__bool___ObjInit(this, source); }
    int Count() { return Dictionary2_ValueCollection__Fuse_IFlush__bool__get_Count(this); }
    ::app::Uno::Collections::Dictionary2_ValueCollection_Enumerator__Fuse_IFlush__bool GetEnumerator();
};
...
inline ::app::Uno::Collections::Dictionary2_ValueCollection_Enumerator__Fuse_IFlush__bool Dictionary2_ValueCollection__Fuse_IFlush__bool::GetEnumerator() { return Dictionary2_ValueCollection__Fuse_IFlush__bool__GetEnumerator(this); }
