...
#ifndef __APP_FUSE_TRIGGERS_ACTIONS_SET__FUSE_NAVIGATION_SWIPE_DIRECTION_H__
#define __APP_FUSE_TRIGGERS_ACTIONS_SET__FUSE_NAVIGATION_SWIPE_DIRECTION_H__
...
struct Set__Fuse_Navigation_SwipeDirection;

struct Set__Fuse_Navigation_SwipeDirection__uType : ::app::Fuse::Triggers::Actions::TriggerAction__uType
{
};
...
struct Set__Fuse_Navigation_SwipeDirection : ::app::Fuse::Triggers::Actions::TriggerAction
{
    bool _updateRestValue;
    int _increment;
    bool _hasIncrement;
    ::uStrong< ::app::Fuse::Internal::Blender__Fuse_Navigation_SwipeDirection*> _blender;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Navigation_SwipeDirection*> _Target;
    int _Value;
    ::uStrong< ::uDelegate*> _Expression;

    void _ObjInit_1(::app::Uno::UX::Property__Fuse_Navigation_SwipeDirection* target) { Set__Fuse_Navigation_SwipeDirection___ObjInit_1(this, target); }
    ::uDelegate* Expression() { return Set__Fuse_Navigation_SwipeDirection__get_Expression(this); }
    int Increment() { return Set__Fuse_Navigation_SwipeDirection__get_Increment(this); }
    ::app::Uno::UX::Property__Fuse_Navigation_SwipeDirection* Target() { return Set__Fuse_Navigation_SwipeDirection__get_Target(this); }
    bool UpdateRestValue() { return Set__Fuse_Navigation_SwipeDirection__get_UpdateRestValue(this); }
    int Value() { return Set__Fuse_Navigation_SwipeDirection__get_Value(this); }
    void Expression(::uDelegate* value) { Set__Fuse_Navigation_SwipeDirection__set_Expression(this, value); }
    void Increment(int value) { Set__Fuse_Navigation_SwipeDirection__set_Increment(this, value); }
    void Target(::app::Uno::UX::Property__Fuse_Navigation_SwipeDirection* value) { Set__Fuse_Navigation_SwipeDirection__set_Target(this, value); }
    void UpdateRestValue(bool value) { Set__Fuse_Navigation_SwipeDirection__set_UpdateRestValue(this, value); }
    void Value(int value) { Set__Fuse_Navigation_SwipeDirection__set_Value(this, value); }
    void Update(int value) { Set__Fuse_Navigation_SwipeDirection__Update(this, value); }
};
