...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_ENUMERATOR__INT__STRING_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_ENUMERATOR__INT__STRING_H__
...
struct Dictionary2_Enumerator__int__string;

struct Dictionary2_Enumerator__int__string__uType : ::uStructType
{
    ::app::Uno::Collections::IEnumerator__Uno_Collections_KeyValuePair_int_string_ __interface_0;
...
struct Dictionary2_Enumerator__int__string
{
    ...
    ::app::Uno::Collections::KeyValuePair__int__string _current;
    int _iterator;
    int _version;

    void _ObjInit(::app::Uno::Collections::Dictionary__int__string* source) { Dictionary2_Enumerator__int__string___ObjInit(this, source); }
    void Dispose() { Dictionary2_Enumerator__int__string__Dispose(this); }
    ::app::Uno::Collections::KeyValuePair__int__string Current() { return Dictionary2_Enumerator__int__string__get_Current(this); }
    bool MoveNext() { return Dictionary2_Enumerator__int__string__MoveNext(this); }
};
