...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FLOAT2_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FLOAT2_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__float2; } } }
...
struct DataBinding__float2;

struct DataBinding__float2__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__float2 : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__float2*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__float2* target, ::uString* key) { DataBinding__float2___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__float2__Acceptor(this, obj); }
    ::app::Uno::UX::Property__float2* Target() { return DataBinding__float2__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__float2* args) { DataBinding__float2__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__float2__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__float2* value) { DataBinding__float2__set_Target(this, value); }
    void SetValue(::app::Uno::Float2 value);
};
...
inline void DataBinding__float2::SetValue(::app::Uno::Float2 value) { DataBinding__float2__SetValue(this, value); }
