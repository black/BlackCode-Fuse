...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_DRAWING_BRUSH_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_DRAWING_BRUSH_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Drawing_Brush; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Drawing_Brush;

struct DataBinding__Fuse_Drawing_Brush__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Drawing_Brush : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Drawing_Brush*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Drawing_Brush* target, ::uString* key) { DataBinding__Fuse_Drawing_Brush___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Drawing_Brush__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Drawing_Brush* Target() { return DataBinding__Fuse_Drawing_Brush__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Drawing_Brush* args) { DataBinding__Fuse_Drawing_Brush__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Drawing_Brush__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Drawing_Brush* value) { DataBinding__Fuse_Drawing_Brush__set_Target(this, value); }
    void SetValue(::app::Fuse::Drawing::Brush* value) { DataBinding__Fuse_Drawing_Brush__SetValue(this, value); }
};
