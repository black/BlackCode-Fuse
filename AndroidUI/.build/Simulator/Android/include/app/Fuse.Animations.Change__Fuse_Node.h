...
#ifndef __APP_FUSE_ANIMATIONS_CHANGE__FUSE_NODE_H__
#define __APP_FUSE_ANIMATIONS_CHANGE__FUSE_NODE_H__

#include <app/Fuse.Animations.TrackAnimator.h>
#include <Uno.h>
namespace app { namespace Fuse { namespace Animations { struct AnimatorState; } } }
namespace app { namespace Fuse { namespace Animations { struct Converter__Fuse_Node; } } }
...
struct Change__Fuse_Node;

struct Change__Fuse_Node__uType : ::app::Fuse::Animations::TrackAnimator__uType
{
};
...
struct Change__Fuse_Node : ::app::Fuse::Animations::TrackAnimator
{
    ::uStrong< ::app::Fuse::Animations::Converter__Fuse_Node*> ContinuousConverter;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Node*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Node* target) { Change__Fuse_Node___ObjInit_2(this, target); }
    float DegreesX() { return Change__Fuse_Node__get_DegreesX(this); }
    ::app::Uno::Float2 DegreesXY();
    float DegreesY() { return Change__Fuse_Node__get_DegreesY(this); }
    float DegreesZ() { return Change__Fuse_Node__get_DegreesZ(this); }
    bool IsContinuous() { return Change__Fuse_Node__get_IsContinuous(this); }
    ::app::Uno::UX::Property__Fuse_Node* Target() { return Change__Fuse_Node__get_Target(this); }
    ::app::Fuse::Node* Value() { return Change__Fuse_Node__get_Value(this); }
    float X() { return Change__Fuse_Node__get_X(this); }
    ::app::Uno::Float2 XY();
    float Y() { return Change__Fuse_Node__get_Y(this); }
    float Z() { return Change__Fuse_Node__get_Z(this); }
    void DegreesX(float value) { Change__Fuse_Node__set_DegreesX(this, value); }
    void DegreesXY(::app::Uno::Float2 value);
    void DegreesY(float value) { Change__Fuse_Node__set_DegreesY(this, value); }
    void DegreesZ(float value) { Change__Fuse_Node__set_DegreesZ(this, value); }
    void Target(::app::Uno::UX::Property__Fuse_Node* value) { Change__Fuse_Node__set_Target(this, value); }
    void Value(::app::Fuse::Node* value) { Change__Fuse_Node__set_Value(this, value); }
    void X(float value) { Change__Fuse_Node__set_X(this, value); }
    void XY(::app::Uno::Float2 value);
    void Y(float value) { Change__Fuse_Node__set_Y(this, value); }
    void Z(float value) { Change__Fuse_Node__set_Z(this, value); }
};
...
inline ::app::Uno::Float2 Change__Fuse_Node::DegreesXY() { return Change__Fuse_Node__get_DegreesXY(this); }
inline ::app::Uno::Float2 Change__Fuse_Node::XY() { return Change__Fuse_Node__get_XY(this); }
inline void Change__Fuse_Node::DegreesXY(::app::Uno::Float2 value) { Change__Fuse_Node__set_DegreesXY(this, value); }
inline void Change__Fuse_Node::XY(::app::Uno::Float2 value) { Change__Fuse_Node__set_XY(this, value); }
