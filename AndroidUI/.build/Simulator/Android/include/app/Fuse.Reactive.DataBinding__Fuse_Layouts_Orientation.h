...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_LAYOUTS_ORIENTATION_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_LAYOUTS_ORIENTATION_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Layouts_Orientation; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Layouts_Orientation;

struct DataBinding__Fuse_Layouts_Orientation__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Layouts_Orientation : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Layouts_Orientation*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Layouts_Orientation* target, ::uString* key) { DataBinding__Fuse_Layouts_Orientation___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Layouts_Orientation__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Layouts_Orientation* Target() { return DataBinding__Fuse_Layouts_Orientation__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Layouts_Orientation* args) { DataBinding__Fuse_Layouts_Orientation__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Layouts_Orientation__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Layouts_Orientation* value) { DataBinding__Fuse_Layouts_Orientation__set_Target(this, value); }
    void SetValue(int value) { DataBinding__Fuse_Layouts_Orientation__SetValue(this, value); }
};
