...
#ifndef __APP_UNO_COLLECTIONS_SELECT_ENUMERATOR__FUSE_DRAWING_TESSELATION_FACE_6798DEDE_H__
#define __APP_UNO_COLLECTIONS_SELECT_ENUMERATOR__FUSE_DRAWING_TESSELATION_FACE_6798DEDE_H__
...
struct SelectEnumerator__Fuse_Drawing_Tesselation_Face__Fuse_Drawing_Contour : ::uObject
{
    ...
    void Reset() { SelectEnumerator__Fuse_Drawing_Tesselation_Face__Fuse_Drawing_Contour__Reset(this); }
};
