...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION__STRING__OBJECT_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION__STRING__OBJECT_H__
...
namespace app { namespace Uno { namespace Collections { struct Dictionary2_KeyCollection_Enumerator__string__object; } } }

namespace app {
namespace Uno {
namespace Collections {

struct Dictionary2_KeyCollection__string__object;

struct Dictionary2_KeyCollection__string__object__uType : ::uClassType
{
...
struct Dictionary2_KeyCollection__string__object : ::uObject
{
    ::uStrong< ::app::Uno::Collections::Dictionary__string__object*> _source;

    ::uObject* GetEnumerator_boxed() { return Dictionary2_KeyCollection__string__object__GetEnumerator_boxed(this); }
    void _ObjInit(::app::Uno::Collections::Dictionary__string__object* source) { Dictionary2_KeyCollection__string__object___ObjInit(this, source); }
    int Count() { return Dictionary2_KeyCollection__string__object__get_Count(this); }
    ::app::Uno::Collections::Dictionary2_KeyCollection_Enumerator__string__object GetEnumerator();
};
...
inline ::app::Uno::Collections::Dictionary2_KeyCollection_Enumerator__string__object Dictionary2_KeyCollection__string__object::GetEnumerator() { return Dictionary2_KeyCollection__string__object__GetEnumerator(this); }
