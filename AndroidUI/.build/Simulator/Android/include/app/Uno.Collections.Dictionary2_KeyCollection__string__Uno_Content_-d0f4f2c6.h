...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION__STRING__UNO_CONTENT__D0F4F2C6_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_KEY_COLLECTION__STRING__UNO_CONTENT__D0F4F2C6_H__
...
namespace app { namespace Uno { namespace Collections { struct Dictionary2_KeyCollection_Enumerator__string__Uno_Content_Models_VertexAttributeArray; } } }

namespace app {
namespace Uno {
namespace Collections {

struct Dictionary2_KeyCollection__string__Uno_Content_Models_VertexAttributeArray;

struct Dictionary2_KeyCollection__string__Uno_Content_Models_VertexAttributeArray__uType : ::uClassType
{
...
struct Dictionary2_KeyCollection__string__Uno_Content_Models_VertexAttributeArray : ::uObject
{
    ::uStrong< ::app::Uno::Collections::Dictionary__string__Uno_Content_Models_VertexAttributeArray*> _source;

    ::uObject* GetEnumerator_boxed() { return Dictionary2_KeyCollection__string__Uno_Content_Models_VertexAttributeArray__GetEnumerator_boxed(this); }
    void _ObjInit(::app::Uno::Collections::Dictionary__string__Uno_Content_Models_VertexAttributeArray* source) { Dictionary2_KeyCollection__string__Uno_Content_Models_VertexAttributeArray___ObjInit(this, source); }
    int Count() { return Dictionary2_KeyCollection__string__Uno_Content_Models_VertexAttributeArray__get_Count(this); }
    ::app::Uno::Collections::Dictionary2_KeyCollection_Enumerator__string__Uno_Content_Models_VertexAttributeArray GetEnumerator();
};
...
inline ::app::Uno::Collections::Dictionary2_KeyCollection_Enumerator__string__Uno_Content_Models_VertexAttributeArray Dictionary2_KeyCollection__string__Uno_Content_Models_VertexAttributeArray::GetEnumerator() { return Dictionary2_KeyCollection__string__Uno_Content_Models_VertexAttributeArray__GetEnumerator(this); }
