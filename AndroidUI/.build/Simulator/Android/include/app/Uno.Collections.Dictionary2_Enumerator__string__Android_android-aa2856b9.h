...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_ENUMERATOR__STRING__ANDROID_ANDROID_AA2856B9_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_ENUMERATOR__STRING__ANDROID_ANDROID_AA2856B9_H__
...
struct Dictionary2_Enumerator__string__Android_android_graphics_Typeface;

struct Dictionary2_Enumerator__string__Android_android_graphics_Typeface__uType : ::uStructType
{
    ::app::Uno::Collections::IEnumerator__Uno_Collections_KeyValuePair_string_Android_android_graphics_Typeface_ __interface_0;
...
struct Dictionary2_Enumerator__string__Android_android_graphics_Typeface
{
    ...
    ::app::Uno::Collections::KeyValuePair__string__Android_android_graphics_Typeface _current;
    int _iterator;
    int _version;

    void _ObjInit(::app::Uno::Collections::Dictionary__string__Android_android_graphics_Typeface* source) { Dictionary2_Enumerator__string__Android_android_graphics_Typeface___ObjInit(this, source); }
    void Dispose() { Dictionary2_Enumerator__string__Android_android_graphics_Typeface__Dispose(this); }
    ::app::Uno::Collections::KeyValuePair__string__Android_android_graphics_Typeface Current() { return Dictionary2_Enumerator__string__Android_android_graphics_Typeface__get_Current(this); }
    bool MoveNext() { return Dictionary2_Enumerator__string__Android_android_graphics_Typeface__MoveNext(this); }
};
