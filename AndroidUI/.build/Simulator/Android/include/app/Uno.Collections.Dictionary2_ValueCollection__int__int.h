...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_VALUE_COLLECTION__INT__INT_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_VALUE_COLLECTION__INT__INT_H__
...
namespace app { namespace Uno { namespace Collections { struct Dictionary2_ValueCollection_Enumerator__int__int; } } }

namespace app {
namespace Uno {
namespace Collections {

struct Dictionary2_ValueCollection__int__int;

struct Dictionary2_ValueCollection__int__int__uType : ::uClassType
{
...
struct Dictionary2_ValueCollection__int__int : ::uObject
{
    ::uStrong< ::app::Uno::Collections::Dictionary__int__int*> _source;

    ::uObject* GetEnumerator_boxed() { return Dictionary2_ValueCollection__int__int__GetEnumerator_boxed(this); }
    void _ObjInit(::app::Uno::Collections::Dictionary__int__int* source) { Dictionary2_ValueCollection__int__int___ObjInit(this, source); }
    int Count() { return Dictionary2_ValueCollection__int__int__get_Count(this); }
    ::app::Uno::Collections::Dictionary2_ValueCollection_Enumerator__int__int GetEnumerator();
};
...
inline ::app::Uno::Collections::Dictionary2_ValueCollection_Enumerator__int__int Dictionary2_ValueCollection__int__int::GetEnumerator() { return Dictionary2_ValueCollection__int__int__GetEnumerator(this); }
