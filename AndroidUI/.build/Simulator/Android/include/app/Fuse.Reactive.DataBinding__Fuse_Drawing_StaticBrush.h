...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_DRAWING_STATIC_BRUSH_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_DRAWING_STATIC_BRUSH_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Drawing_StaticBrush; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Drawing_StaticBrush;

struct DataBinding__Fuse_Drawing_StaticBrush__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Drawing_StaticBrush : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Drawing_StaticBrush*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Drawing_StaticBrush* target, ::uString* key) { DataBinding__Fuse_Drawing_StaticBrush___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Drawing_StaticBrush__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Drawing_StaticBrush* Target() { return DataBinding__Fuse_Drawing_StaticBrush__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Drawing_StaticBrush* args) { DataBinding__Fuse_Drawing_StaticBrush__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Drawing_StaticBrush__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Drawing_StaticBrush* value) { DataBinding__Fuse_Drawing_StaticBrush__set_Target(this, value); }
    void SetValue(::app::Fuse::Drawing::StaticBrush* value) { DataBinding__Fuse_Drawing_StaticBrush__SetValue(this, value); }
};
