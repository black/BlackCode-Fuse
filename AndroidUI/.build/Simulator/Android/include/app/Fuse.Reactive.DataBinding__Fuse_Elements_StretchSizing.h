...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_ELEMENTS_STRETCH_SIZING_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_ELEMENTS_STRETCH_SIZING_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Elements_StretchSizing; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Elements_StretchSizing;

struct DataBinding__Fuse_Elements_StretchSizing__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Elements_StretchSizing : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Elements_StretchSizing*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Elements_StretchSizing* target, ::uString* key) { DataBinding__Fuse_Elements_StretchSizing___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Elements_StretchSizing__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Elements_StretchSizing* Target() { return DataBinding__Fuse_Elements_StretchSizing__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Elements_StretchSizing* args) { DataBinding__Fuse_Elements_StretchSizing__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Elements_StretchSizing__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Elements_StretchSizing* value) { DataBinding__Fuse_Elements_StretchSizing__set_Target(this, value); }
    void SetValue(int value) { DataBinding__Fuse_Elements_StretchSizing__SetValue(this, value); }
};
