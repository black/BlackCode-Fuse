...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_ELEMENTS_VISIBILITY_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_ELEMENTS_VISIBILITY_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Elements_Visibility; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Elements_Visibility;

struct DataBinding__Fuse_Elements_Visibility__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Elements_Visibility : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Elements_Visibility*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Elements_Visibility* target, ::uString* key) { DataBinding__Fuse_Elements_Visibility___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Elements_Visibility__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Elements_Visibility* Target() { return DataBinding__Fuse_Elements_Visibility__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Elements_Visibility* args) { DataBinding__Fuse_Elements_Visibility__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Elements_Visibility__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Elements_Visibility* value) { DataBinding__Fuse_Elements_Visibility__set_Target(this, value); }
    void SetValue(int value) { DataBinding__Fuse_Elements_Visibility__SetValue(this, value); }
};
