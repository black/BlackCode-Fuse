...
#ifndef __APP_OUTRACKS_SIMULATOR_RUNTIME_UX_PROPERTY__FUSE_DRAWING_BLEND_MODE_H__
#define __APP_OUTRACKS_SIMULATOR_RUNTIME_UX_PROPERTY__FUSE_DRAWING_BLEND_MODE_H__
...
struct UxProperty__Fuse_Drawing_BlendMode;

struct UxProperty__Fuse_Drawing_BlendMode__uType : ::app::Uno::UX::Property__Fuse_Drawing_BlendMode__uType
{
};
...
struct UxProperty__Fuse_Drawing_BlendMode : ::app::Uno::UX::Property__Fuse_Drawing_BlendMode
{
    ...
    void _ObjInit_1(::uDelegate* setter, ::uDelegate* getter, ::uDelegate* adder, ::uDelegate* remover) { UxProperty__Fuse_Drawing_BlendMode___ObjInit_1(this, setter, getter, adder, remover); }
};
