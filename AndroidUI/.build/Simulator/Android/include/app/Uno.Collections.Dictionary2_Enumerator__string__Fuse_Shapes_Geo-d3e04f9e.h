...
#ifndef __APP_UNO_COLLECTIONS_DICTIONARY2_ENUMERATOR__STRING__FUSE_SHAPES_GEO_D3E04F9E_H__
#define __APP_UNO_COLLECTIONS_DICTIONARY2_ENUMERATOR__STRING__FUSE_SHAPES_GEO_D3E04F9E_H__
...
struct Dictionary2_Enumerator__string__Fuse_Shapes_GeometryCacheEntry__uType : ::uStructType
{
    ::app::Uno::Collections::IEnumerator__Uno_Collections_KeyValuePair_string_Fuse_Shapes_GeometryCacheEntry_ __interface_0;
...
struct Dictionary2_Enumerator__string__Fuse_Shapes_GeometryCacheEntry
{
    ...
    ::app::Uno::Collections::KeyValuePair__string__Fuse_Shapes_GeometryCacheEntry Current() { return Dictionary2_Enumerator__string__Fuse_Shapes_GeometryCacheEntry__get_Current(this); }
