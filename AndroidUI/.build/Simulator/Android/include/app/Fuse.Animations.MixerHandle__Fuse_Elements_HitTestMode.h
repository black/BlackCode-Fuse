...
#ifndef __APP_FUSE_ANIMATIONS_MIXER_HANDLE__FUSE_ELEMENTS_HIT_TEST_MODE_H__
#define __APP_FUSE_ANIMATIONS_MIXER_HANDLE__FUSE_ELEMENTS_HIT_TEST_MODE_H__

#include <app/Fuse.Animations.IMixerHandle__Fuse_Elements_HitTestMode.h>
#include <app/Uno.Object.h>
#include <Uno.h>
namespace app { namespace Fuse { namespace Animations { struct MasterBase__Fuse_Elements_HitTestMode; } } }

namespace app {
namespace Fuse {
namespace Animations {

struct MixerHandle__Fuse_Elements_HitTestMode;

struct MixerHandle__Fuse_Elements_HitTestMode__uType : ::uClassType
{
    ::app::Fuse::Animations::IMixerHandle__Fuse_Elements_HitTestMode __interface_0;
};
...
struct MixerHandle__Fuse_Elements_HitTestMode : ::uObject
{
    int Value;
    float Strength;
    bool _hasValue;
    ::uStrong< ::app::Fuse::Animations::MasterBase__Fuse_Elements_HitTestMode*> Master;
    int _MixOp;
    int _Priority;

    void _ObjInit(::app::Fuse::Animations::MasterBase__Fuse_Elements_HitTestMode* master, int mode, int priority) { MixerHandle__Fuse_Elements_HitTestMode___ObjInit(this, master, mode, priority); }
    bool HasValue() { return MixerHandle__Fuse_Elements_HitTestMode__get_HasValue(this); }
    int MixOp() { return MixerHandle__Fuse_Elements_HitTestMode__get_MixOp(this); }
    int Priority() { return MixerHandle__Fuse_Elements_HitTestMode__get_Priority(this); }
    int RestValue() { return MixerHandle__Fuse_Elements_HitTestMode__get_RestValue(this); }
    void Set(int value, float strength) { MixerHandle__Fuse_Elements_HitTestMode__Set(this, value, strength); }
    void MixOp(int value) { MixerHandle__Fuse_Elements_HitTestMode__set_MixOp(this, value); }
    void Priority(int value) { MixerHandle__Fuse_Elements_HitTestMode__set_Priority(this, value); }
    void Unregister() { MixerHandle__Fuse_Elements_HitTestMode__Unregister(this); }
};
