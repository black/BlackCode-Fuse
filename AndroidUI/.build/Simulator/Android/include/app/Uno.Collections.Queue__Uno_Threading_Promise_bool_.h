...
#include <Uno.h>
namespace app { namespace Uno { namespace Collections { struct Queue1_Enumerator__Uno_Threading_Promise_bool_; } } }
...
struct Queue__Uno_Threading_Promise_bool_ : ::uObject
{
    ...
    void _ObjInit() { Queue__Uno_Threading_Promise_bool____ObjInit(this); }
    void _ObjInit_1(int capacity) { Queue__Uno_Threading_Promise_bool____ObjInit_1(this, capacity); }
    void Clear() { Queue__Uno_Threading_Promise_bool___Clear(this); }
    bool Contains(::app::Uno::Threading::Promise__bool* item) { return Queue__Uno_Threading_Promise_bool___Contains(this, item); }
    ...
    ::app::Uno::Collections::Queue1_Enumerator__Uno_Threading_Promise_bool_ GetEnumerator();
    ::app::Uno::Threading::Promise__bool* Peek() { return Queue__Uno_Threading_Promise_bool___Peek(this); }
};
...
inline ::app::Uno::Collections::Queue1_Enumerator__Uno_Threading_Promise_bool_ Queue__Uno_Threading_Promise_bool_::GetEnumerator() { return Queue__Uno_Threading_Promise_bool___GetEnumerator(this); }
