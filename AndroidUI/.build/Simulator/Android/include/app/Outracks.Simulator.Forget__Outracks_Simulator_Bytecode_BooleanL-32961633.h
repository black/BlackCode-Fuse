...
#ifndef __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_BYTECODE_BOOLEAN_L_32961633_H__
#define __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_BYTECODE_BOOLEAN_L_32961633_H__
...
struct Forget__Outracks_Simulator_Bytecode_BooleanLiteral__char;

struct Forget__Outracks_Simulator_Bytecode_BooleanLiteral__char__uType : ::uClassType
{
};
...
struct Forget__Outracks_Simulator_Bytecode_BooleanLiteral__char : ::uObject
{
    ::uChar _result;

    void _ObjInit(::uChar result) { Forget__Outracks_Simulator_Bytecode_BooleanLiteral__char___ObjInit(this, result); }
    ::uChar Execute(::app::Outracks::Simulator::Bytecode::BooleanLiteral* _) { return Forget__Outracks_Simulator_Bytecode_BooleanLiteral__char__Execute(this, _); }
};
