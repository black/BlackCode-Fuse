...
#ifndef __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_BYTECODE_METHOD_GROUP__CHAR_H__
#define __APP_OUTRACKS_SIMULATOR_FORGET__OUTRACKS_SIMULATOR_BYTECODE_METHOD_GROUP__CHAR_H__
...
struct Forget__Outracks_Simulator_Bytecode_MethodGroup__char;

struct Forget__Outracks_Simulator_Bytecode_MethodGroup__char__uType : ::uClassType
{
};
...
struct Forget__Outracks_Simulator_Bytecode_MethodGroup__char : ::uObject
{
    ::uChar _result;

    void _ObjInit(::uChar result) { Forget__Outracks_Simulator_Bytecode_MethodGroup__char___ObjInit(this, result); }
    ::uChar Execute(::app::Outracks::Simulator::Bytecode::MethodGroup* _) { return Forget__Outracks_Simulator_Bytecode_MethodGroup__char__Execute(this, _); }
};
