...
#ifndef __APP_UNO_COLLECTIONS_I_LIST__UNO_U_X_FILE_SOURCE_H__
#define __APP_UNO_COLLECTIONS_I_LIST__UNO_U_X_FILE_SOURCE_H__
...
struct IList__Uno_UX_FileSource
{
};
