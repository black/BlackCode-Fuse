...
#include <Uno.h>
namespace app { namespace Uno { namespace Collections { struct List1_Enumerator__Fuse_Input_TextEnteredHandler; } } }
...
{
    ::app::Uno::Collections::IEnumerable__Fuse_Input_TextEnteredHandler __interface_0;
};
...
struct List__Fuse_Input_TextEnteredHandler : ::uObject
{
    ...
    ::uObject* GetEnumerator_boxed() { return List__Fuse_Input_TextEnteredHandler__GetEnumerator_boxed(this); }
    void _ObjInit() { List__Fuse_Input_TextEnteredHandler___ObjInit(this); }
    void _ObjInit_1(int capacity) { List__Fuse_Input_TextEnteredHandler___ObjInit_1(this, capacity); }
    void Add(::uDelegate* item) { List__Fuse_Input_TextEnteredHandler__Add(this, item); }
    void AddRange(::uObject* items) { List__Fuse_Input_TextEnteredHandler__AddRange(this, items); }
    void BoundsCheck(int index) { List__Fuse_Input_TextEnteredHandler__BoundsCheck(this, index); }
    void Clear() { List__Fuse_Input_TextEnteredHandler__Clear(this); }
    bool Contains(::uDelegate* item) { return List__Fuse_Input_TextEnteredHandler__Contains(this, item); }
    void EnsureCapacity() { List__Fuse_Input_TextEnteredHandler__EnsureCapacity(this); }
    ...
    ::app::Uno::Collections::List1_Enumerator__Fuse_Input_TextEnteredHandler GetEnumerator();
    int IndexOf(::uDelegate* item) { return List__Fuse_Input_TextEnteredHandler__IndexOf(this, item); }
    void Insert(int index, ::uDelegate* item) { List__Fuse_Input_TextEnteredHandler__Insert(this, index, item); }
    bool Remove(::uDelegate* item) { return List__Fuse_Input_TextEnteredHandler__Remove(this, item); }
    void RemoveAt(int index) { List__Fuse_Input_TextEnteredHandler__RemoveAt(this, index); }
    void Item(int index, ::uDelegate* value) { List__Fuse_Input_TextEnteredHandler__set_Item(this, index, value); }
    void Sort(::uDelegate* comparer) { List__Fuse_Input_TextEnteredHandler__Sort(this, comparer); }
    ::uArray* ToArray() { return List__Fuse_Input_TextEnteredHandler__ToArray(this); }
};
...
inline ::app::Uno::Collections::List1_Enumerator__Fuse_Input_TextEnteredHandler List__Fuse_Input_TextEnteredHandler::GetEnumerator() { return List__Fuse_Input_TextEnteredHandler__GetEnumerator(this); }
