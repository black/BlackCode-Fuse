...
#ifndef __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_ANIMATIONS_ANIMATION_VARIANT_H__
#define __APP_FUSE_REACTIVE_DATA_BINDING__FUSE_ANIMATIONS_ANIMATION_VARIANT_H__
...
namespace app { namespace Uno { namespace UX { struct ValueChangedArgs__Fuse_Animations_AnimationVariant; } } }

namespace app {
namespace Fuse {
namespace Reactive {

struct DataBinding__Fuse_Animations_AnimationVariant;

struct DataBinding__Fuse_Animations_AnimationVariant__uType : ::app::Fuse::Reactive::Binding__uType
{
...
struct DataBinding__Fuse_Animations_AnimationVariant : ::app::Fuse::Reactive::Binding
{
    ::uStrong< ::uObject*> _subscription;
    ::uStrong< ::uObject*> _currentValue;
    ::uStrong< ::app::Uno::UX::Property__Fuse_Animations_AnimationVariant*> _Target;

    void _ObjInit_2(::app::Uno::UX::Property__Fuse_Animations_AnimationVariant* target, ::uString* key) { DataBinding__Fuse_Animations_AnimationVariant___ObjInit_2(this, target, key); }
    bool Acceptor(::uObject* obj) { return DataBinding__Fuse_Animations_AnimationVariant__Acceptor(this, obj); }
    ::app::Uno::UX::Property__Fuse_Animations_AnimationVariant* Target() { return DataBinding__Fuse_Animations_AnimationVariant__get_Target(this); }
    void OnValueChanged(::uObject* sender, ::app::Uno::UX::ValueChangedArgs__Fuse_Animations_AnimationVariant* args) { DataBinding__Fuse_Animations_AnimationVariant__OnValueChanged(this, sender, args); }
    void PushValue(::uObject* newValue) { DataBinding__Fuse_Animations_AnimationVariant__PushValue(this, newValue); }
    void Target(::app::Uno::UX::Property__Fuse_Animations_AnimationVariant* value) { DataBinding__Fuse_Animations_AnimationVariant__set_Target(this, value); }
    void SetValue(int value) { DataBinding__Fuse_Animations_AnimationVariant__SetValue(this, value); }
};
