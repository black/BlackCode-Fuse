...
#ifndef __APP_UNO_COLLECTIONS_LIST1_ENUMERATOR__FUSE_INPUT_POINTER_MOVED_HANDLER_H__
#define __APP_UNO_COLLECTIONS_LIST1_ENUMERATOR__FUSE_INPUT_POINTER_MOVED_HANDLER_H__
...
struct List1_Enumerator__Fuse_Input_PointerMovedHandler;

struct List1_Enumerator__Fuse_Input_PointerMovedHandler__uType : ::uStructType
{
    ::app::Uno::Collections::IEnumerator__Fuse_Input_PointerMovedHandler __interface_0;
...
struct List1_Enumerator__Fuse_Input_PointerMovedHandler
{
    ::uStrong< ::app::Uno::Collections::List__Fuse_Input_PointerMovedHandler*> _source;
    int _version;
    int _iterator;
    ::uStrong< ::uDelegate*> _current;

    void _ObjInit(::app::Uno::Collections::List__Fuse_Input_PointerMovedHandler* source) { List1_Enumerator__Fuse_Input_PointerMovedHandler___ObjInit(this, source); }
    void Dispose() { List1_Enumerator__Fuse_Input_PointerMovedHandler__Dispose(this); }
    ::uDelegate* Current() { return List1_Enumerator__Fuse_Input_PointerMovedHandler__get_Current(this); }
    bool MoveNext() { return List1_Enumerator__Fuse_Input_PointerMovedHandler__MoveNext(this); }
};
