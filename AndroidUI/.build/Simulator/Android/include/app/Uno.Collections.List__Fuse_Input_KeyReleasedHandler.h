...
#include <Uno.h>
namespace app { namespace Uno { namespace Collections { struct List1_Enumerator__Fuse_Input_KeyReleasedHandler; } } }
...
{
    ::app::Uno::Collections::IEnumerable__Fuse_Input_KeyReleasedHandler __interface_0;
};
...
struct List__Fuse_Input_KeyReleasedHandler : ::uObject
{
    ...
    ::uObject* GetEnumerator_boxed() { return List__Fuse_Input_KeyReleasedHandler__GetEnumerator_boxed(this); }
    void _ObjInit() { List__Fuse_Input_KeyReleasedHandler___ObjInit(this); }
    void _ObjInit_1(int capacity) { List__Fuse_Input_KeyReleasedHandler___ObjInit_1(this, capacity); }
    void Add(::uDelegate* item) { List__Fuse_Input_KeyReleasedHandler__Add(this, item); }
    void AddRange(::uObject* items) { List__Fuse_Input_KeyReleasedHandler__AddRange(this, items); }
    void BoundsCheck(int index) { List__Fuse_Input_KeyReleasedHandler__BoundsCheck(this, index); }
    void Clear() { List__Fuse_Input_KeyReleasedHandler__Clear(this); }
    bool Contains(::uDelegate* item) { return List__Fuse_Input_KeyReleasedHandler__Contains(this, item); }
    void EnsureCapacity() { List__Fuse_Input_KeyReleasedHandler__EnsureCapacity(this); }
    ...
    ::app::Uno::Collections::List1_Enumerator__Fuse_Input_KeyReleasedHandler GetEnumerator();
    int IndexOf(::uDelegate* item) { return List__Fuse_Input_KeyReleasedHandler__IndexOf(this, item); }
    void Insert(int index, ::uDelegate* item) { List__Fuse_Input_KeyReleasedHandler__Insert(this, index, item); }
    bool Remove(::uDelegate* item) { return List__Fuse_Input_KeyReleasedHandler__Remove(this, item); }
    void RemoveAt(int index) { List__Fuse_Input_KeyReleasedHandler__RemoveAt(this, index); }
    void Item(int index, ::uDelegate* value) { List__Fuse_Input_KeyReleasedHandler__set_Item(this, index, value); }
    void Sort(::uDelegate* comparer) { List__Fuse_Input_KeyReleasedHandler__Sort(this, comparer); }
    ::uArray* ToArray() { return List__Fuse_Input_KeyReleasedHandler__ToArray(this); }
};
...
inline ::app::Uno::Collections::List1_Enumerator__Fuse_Input_KeyReleasedHandler List__Fuse_Input_KeyReleasedHandler::GetEnumerator() { return List__Fuse_Input_KeyReleasedHandler__GetEnumerator(this); }
