...
#ifndef __APP_OUTRACKS_SIMULATOR_APPLY_SECOND__OUTRACKS_SIMULATOR_PROTOCOL_DEB_785759DD_H__
#define __APP_OUTRACKS_SIMULATOR_APPLY_SECOND__OUTRACKS_SIMULATOR_PROTOCOL_DEB_785759DD_H__
...
struct ApplySecond__Outracks_Simulator_Protocol_DebugLog__Uno_IO_BinaryWriter;

struct ApplySecond__Outracks_Simulator_Protocol_DebugLog__Uno_IO_BinaryWriter__uType : ::uClassType
{
};
...
struct ApplySecond__Outracks_Simulator_Protocol_DebugLog__Uno_IO_BinaryWriter : ::uObject
{
    ::uStrong< ::uDelegate*> _action;
    ::uStrong< ::app::Uno::IO::BinaryWriter*> _arg2;

    void _ObjInit(::uDelegate* action, ::app::Uno::IO::BinaryWriter* arg2) { ApplySecond__Outracks_Simulator_Protocol_DebugLog__Uno_IO_BinaryWriter___ObjInit(this, action, arg2); }
    void Execute(::app::Outracks::Simulator::Protocol::DebugLog* arg1) { ApplySecond__Outracks_Simulator_Protocol_DebugLog__Uno_IO_BinaryWriter__Execute(this, arg1); }
};
