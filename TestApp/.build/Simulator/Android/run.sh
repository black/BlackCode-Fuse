...
adb devices | tail -n +2 | cut -sf 1 | xargs -I {} adb -s {} uninstall com.TestApp

echo ""
echo "## Installing new version of APK"
adb devices | tail -n +2 | cut -sf 1 | xargs -I {} adb -s {} install -r bin/TestApp-debug.apk
...
adb devices | tail -n +2 | cut -sf 1 | xargs -I {} adb -s {} shell \
    ...
    com.TestApp/com.TestApp.TestApp
