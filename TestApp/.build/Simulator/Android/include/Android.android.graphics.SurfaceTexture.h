...
struct SurfaceTexture : ::g::Android::java::lang::Object
{
    ...
    static jmethodID getTransformMatrix_7306_ID_;
    static jmethodID& getTransformMatrix_7306_ID() { return getTransformMatrix_7306_ID_; }
    ...
    void getTransformMatrix(::g::Android::Runtime::FloatArray* arg0);
    void release();
    void setOnFrameAvailableListener(uObject* arg0);
    void updateTexImage();
    static void _Init2();
    static void getTransformMatrix_IMPL_7306(bool arg0_, jobject arg1_, uObject* arg2_);
