...
// C:\ProgramData\Uno\Packages\Android\0.19.1\Android\android\test\mock\$.uno(317)
// -------------------------------------------------------------------------------
...
::g::Android::android::content::Context_type* MockContext_typeof()
{
    ...
    type->Reflection.SetFunctions(3,
        new uFunction("_Init", NULL, (void*)MockContext___Init3_fn, 0, true, uVoid_typeof(), 0),
        new uFunction("getResources_IMPL_18557", NULL, (void*)MockContext__getResources_IMPL_18557_fn, 0, true, ::g::Android::Base::Wrappers::IJWrapper_typeof(), 2, ::g::Uno::Bool_typeof(), ::g::Android::Base::Primitives::ujobject_typeof()),
        new uFunction("getSystemService_IMPL_18620", NULL, (void*)MockContext__getSystemService_IMPL_18620_fn, 0, true, ::g::Android::Base::Wrappers::IJWrapper_typeof(), 3, ::g::Uno::Bool_typeof(), ::g::Android::Base::Primitives::ujobject_typeof(), ::g::Android::Base::Wrappers::IJWrapper_typeof()));
    return type;
}
