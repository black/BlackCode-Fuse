...
// C:\ProgramData\Uno\Packages\Android\0.19.1\Android\android\animation\$.uno(11)
// ------------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Android\0.19.1\Android\android\animation\$.uno(976)
// -------------------------------------------------------------------------------

// public sealed extern class LayoutTransition :976
// {
::g::Android::java::lang::Object_type* LayoutTransition_typeof()
{
    static uSStrong< ::g::Android::java::lang::Object_type*> type;
    if (type != NULL) return type;
    ...
    options.FieldCount = 5;
    options.InterfaceCount = 2;
    options.ObjectSize = sizeof(LayoutTransition);
    options.TypeSize = sizeof(::g::Android::java::lang::Object_type);
    type = (::g::Android::java::lang::Object_type*)uClassType::New("Android.android.animation.LayoutTransition", options);
    type->SetBase(::g::Android::java::lang::Object_typeof());
    type->interface1.fp_Dispose = (void(*)(uObject*))::g::Android::Base::Wrappers::JWrapper__Uno_IDisposable_Dispose_fn;
    type->interface0.fp__GetJavaObject = (void(*)(uObject*, jobject*))::g::Android::Base::Wrappers::JWrapper___GetJavaObject_fn;
    type->interface0.fp__IsSubclassed = (void(*)(uObject*, bool*))::g::Android::Base::Wrappers::JWrapper___IsSubclassed_fn;
...
// C:\ProgramData\Uno\Packages\Android\0.19.1\Android\android\animation\$.uno(2257)
// --------------------------------------------------------------------------------
...
::g::Android::java::lang::Object_type* TimeAnimator_typeof()
{
    ...
    type->Reflection.SetFunctions(6,
        new uFunction("_Init", NULL, (void*)TimeAnimator___Init4_fn, 0, true, uVoid_typeof(), 0),
        new uFunction(".ctor", NULL, (void*)TimeAnimator__New7_fn, 0, true, TimeAnimator_typeof(), 0),
        new uFunction("setTimeListener", NULL, (void*)TimeAnimator__setTimeListener_fn, 0, false, uVoid_typeof(), 1, ::g::Android::android::animation::TimeAnimatorDLRTimeListener_typeof()),
        new uFunction("setTimeListener_IMPL_378", NULL, (void*)TimeAnimator__setTimeListener_IMPL_378_fn, 0, true, uVoid_typeof(), 3, ::g::Uno::Bool_typeof(), ::g::Android::Base::Primitives::ujobject_typeof(), ::g::Android::Base::Wrappers::IJWrapper_typeof()),
        new uFunction("start", NULL, (void*)TimeAnimator__start_fn, 0, false, uVoid_typeof(), 0),
        new uFunction("start_IMPL_377", NULL, (void*)TimeAnimator__start_IMPL_377_fn, 0, true, uVoid_typeof(), 2, ::g::Uno::Bool_typeof(), ::g::Android::Base::Primitives::ujobject_typeof()));
    return type;
}
...
// C:\ProgramData\Uno\Packages\Android\0.19.1\Android\android\animation\$.uno(2368)
// --------------------------------------------------------------------------------
...
uInterfaceType* TimeAnimatorDLRTimeListener_typeof()
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction("onTimeUpdate", NULL, NULL, offsetof(TimeAnimatorDLRTimeListener, fp_onTimeUpdate), false, uVoid_typeof(), 3, ::g::Android::android::animation::TimeAnimator_typeof(), ::g::Uno::Long_typeof(), ::g::Uno::Long_typeof()));
    return type;
}
// }

// C:\ProgramData\Uno\Packages\Android\0.19.1\Android\android\animation\$.uno(2384)
// --------------------------------------------------------------------------------
...
uInterfaceType* TimeInterpolator_typeof()
{
    ...
    type = uInterfaceType::New("Android.android.animation.TimeInterpolator", 0, 0);
    type->Reflection.SetFunctions(1,
        new uFunction("getInterpolation", NULL, NULL, offsetof(TimeInterpolator, fp_getInterpolation), false, ::g::Uno::Float_typeof(), 1, ::g::Uno::Float_typeof()));
    return type;
}
// }

// C:\ProgramData\Uno\Packages\Android\0.19.1\Android\android\animation\$.uno(1331)
// --------------------------------------------------------------------------------
...
::g::Android::java::lang::Object_type* ValueAnimator_typeof()
{
    ...
    type->Reflection.SetFunctions(4,
        new uFunction("_Init", NULL, (void*)ValueAnimator___Init3_fn, 0, true, uVoid_typeof(), 0),
        new uFunction("setDuration", NULL, (void*)ValueAnimator__setDuration_fn, 0, false, ::g::Android::android::animation::Animator_typeof(), 1, ::g::Uno::Long_typeof()),
        new uFunction("setDuration_IMPL_46152", NULL, (void*)ValueAnimator__setDuration_IMPL_46152_fn, 0, true, ::g::Android::Base::Wrappers::IJWrapper_typeof(), 3, ::g::Uno::Bool_typeof(), ::g::Android::Base::Primitives::ujobject_typeof(), ::g::Uno::Long_typeof()),
        new uFunction("toString_IMPL_425", NULL, (void*)ValueAnimator__toString_IMPL_425_fn, 0, true, ::g::Android::Base::Wrappers::IJWrapper_typeof(), 2, ::g::Uno::Bool_typeof(), ::g::Android::Base::Primitives::ujobject_typeof()));
    return type;
}
