...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/TestApp/TestApp");
    jclass entryPointsClass = env->FindClass("com/TestApp/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/TestApp/Display");
